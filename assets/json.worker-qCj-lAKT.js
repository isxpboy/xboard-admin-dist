!function () {
    ...
    class w {
        ...
        constructor(e) {
            this._now = !1 === e ? Date.now : v, this._startTime = this._now(), this._stopTime = -1
        }
    ...
    !function (e) {
        ...
        function s(e, t, n = 100, r = !1, i = !1, s, o) {
            let a, l, u, c, h = 0;
            const d = new A({
                leakWarningThreshold: s, onWillAddFirstListener() {
                    a = e(e => {
        ...
        e.None = () => p.None, e.defer = function (e, t) {
            return s(e, () => {
            }, 0, void 0, !0, void 0, t)
        ...
        e.fromObservable = function (e, t) {
            ...
            return (t, n, r) => {
                ...
                return r instanceof g ? r.add(a) : Array.isArray(r) && r.push(a), a
            }
        }
    }(C || (C = {}));
    ...
    class _ {
        ...
        constructor(e) {
            this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${e}_${_._idPool++}`, _.all.add(this)
        }
    ...
    class A {
        constructor(e) {
            this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new L(e?.onListenerError ?? t, this._options?.leakWarningThreshold ?? -1) : void 0, this._perfMon = this._options?._profName ? new _(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
        }
            ...
            return this._event ??= (e, n, r) => {
                if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                    const e = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`,
                        ...
                        r = new x(`${e}. HINT: Stack shows most frequent listener (${n[1]}-times)`, n[0]);
                    return (this._options?.onListenerError || t)(r), p.None
                }
                if (this._disposed) return p.None;
                n && (e = e.bind(n));
                const i = new E(e);
                let s;
                this._leakageMon && this._size >= Math.ceil(.2 * this._leakageMon.threshold) && (i.stack = S.create(), s = this._leakageMon.check(i.stack, this._size + 1)), this._listeners ? this._listeners instanceof E ? (this._deliveryQueue ??= new k, this._listeners = [this._listeners, i]) : this._listeners.push(i) : (this._options?.onWillAddFirstListener?.(this), this._listeners = i, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
                const o = m(() => {
                    s?.(), this._removeListener(i)
                });
                return r instanceof g ? r.add(o) : Array.isArray(r) && r.push(o), o
            }, this._event
        }
        ...
        fire(e) {
            if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof E) this._deliver(this._listeners, e); else {
    ...
    const T = "pseudo" === R() || "undefined" != typeof document && document.location && "string" == typeof document.location.hash && document.location.hash.indexOf("pseudo=true") >= 0;
    ...
    const I = "en";
    let P, F, V, D = !1, q = !1, K = !1, $ = I, B = I;
    const U = globalThis;
    let j;
    void 0 !== U.vscode && void 0 !== U.vscode.process ? j = U.vscode.process : "undefined" != typeof process && "string" == typeof process?.versions?.node && (j = process);
    const W = "string" == typeof j?.versions?.electron && "renderer" === j?.type;
    if ("object" == typeof j) {
        D = "win32" === j.platform, q = "darwin" === j.platform, K = "linux" === j.platform, K && j.env.SNAP && j.env.SNAP_REVISION, j.env.CI || j.env.BUILD_ARTIFACTSTAGINGDIRECTORY || j.env.GITHUB_WORKSPACE, P = I, $ = I;
        const e = j.env.VSCODE_NLS_CONFIG;
        if (e) try {
            const t = JSON.parse(e);
            P = t.userLocale, B = t.osLocale, $ = t.resolvedLanguage || I, F = t.languagePack?.translationsConfigFile
        } catch (Pl) {
        }
    } else "object" != typeof navigator || W || (V = navigator.userAgent, D = V.indexOf("Windows") >= 0, q = V.indexOf("Macintosh") >= 0, (V.indexOf("Macintosh") >= 0 || V.indexOf("iPad") >= 0 || V.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, K = V.indexOf("Linux") >= 0, V?.indexOf("Mobi"), $ = R() || I, P = navigator.language.toLowerCase(), B = P);
    const z = D, H = q, G = V, J = "function" == typeof U.postMessage && !U.importScripts;
    (() => {
        if (J) {
            const e = [];
            ...
            return n => {
                const r = ++t;
                e.push({id: r, callback: n}), U.postMessage({vscodeScheduleAsyncWork: r}, "*")
            }
        }
    })();
    ...
    G && G.indexOf("Firefox"), !X && G && G.indexOf("Safari"), G && G.indexOf("Edg/"), G && G.indexOf("Android");
    ...
    class oe {
        ...
        static {
            this.cache = new Z({getCacheKey: JSON.stringify}, e => {
                ...
                let i, s = e.filter(e => !e.startsWith("_") && Object.hasOwn(r, e));
        ...
        static {
            this._locales = new ee(() => Object.keys(oe.ambiguousCharacterData.value).filter(e => !e.startsWith("_")))
        }
    ...
    class ae {
        ...
        static getData() {
            return this._data || (this._data = new Set([...Object.values(ae.getRawData())].flat())), this._data
        }
    ...
    class me {
        ...
        async sendMessage(e, t, n) {
            ...
            return new Promise((i, s) => {
                this._pendingReplies[r] = {resolve: i, reject: s}, this._send(new ue(this._workerId, r, e, t, n))
            })
        }
        ...
        listen(e, t, n) {
            ...
            const i = new A({
                onWillAddFirstListener: () => {
                    ...
                    this._pendingEmitters.delete(r), this._send(new fe(this._workerId, r)), r = null
                }
            });
            return i.event
        }
        ...
        createProxyToRemoteChannel(e, t) {
            const n = {get: (n, r) => ("string" != typeof r || n[r] || (pe(r) ? n[r] = t => this.listen(e, r, t) : ge(r) ? n[r] = this.listen(e, r, void 0) : 36 === r.charCodeAt(0) && (n[r] = async (...n) => (await (t?.()), this.sendMessage(e, r, n)))), n[r])};
    ...
    class be {
        constructor(e, t) {
            this._localChannels = new Map, this._remoteChannels = new Map, this._protocol = new me({
                sendMessage: (t, n) => {
                    e(t, n)
                },
        ...
        _handleMessage(e, t, n) {
            ...
            const r = e === le ? this.requestHandler : this._localChannels.get(e);
            if (!r) return Promise.reject(new Error(`Missing channel ${e} on worker thread`));
            const i = r[t];
            if ("function" != typeof i) return Promise.reject(new Error(`Missing method ${t} on worker thread channel ${e}`));
            try {
    ...
    class Ee {
        constructor(e, t, n = null) {
            ...
            const [r, i, s] = Ee._getElements(e), [o, a, l] = Ee._getElements(t);
        ...
        ElementsAreStrictEqual(e, t) {
            ...
            return Ee._getStrictElement(this._originalSequence, e) === Ee._getStrictElement(this._modifiedSequence, t)
        }
        ...
        _ComputeDiff(e, t, n, r, i) {
            ...
            return i && (o = this.PrettifyChanges(o)), {quitEarly: s[0], changes: o}
        }
        ...
        ComputeDiffRecursive(e, t, n, r, i) {
            ...
            if (e > t || n > r) {
                let i;
                return n <= r ? (Se.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), i = [new ve(e, 0, n, r - n + 1)]) : e <= t ? (Se.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"), i = [new ve(e, t - e + 1, n, 0)]) : (Se.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), Se.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"), i = []), i
            }
        ...
        WALKTRACE(e, t, n, r, i, s, o, a, l, u, c, h, d, f, m, g, p, b) {
            let y = null, v = null, w = new xe, C = t, _ = n, L = d[0] - g[0] - r, S = -1073741824,
                N = this.m_forwardHistory.length - 1;
            do {
                const t = L + e;
                t === C || t < _ && l[t - 1] < l[t + 1] ? (f = (c = l[t + 1]) - L - r, c < S && w.MarkNextChange(), S = c, w.AddModifiedElement(c + 1, f), L = t + 1 - e) : (f = (c = l[t - 1] + 1) - L - r, c < S && w.MarkNextChange(), S = c - 1, w.AddOriginalElement(c, f + 1), L = t - 1 - e), N >= 0 && (e = (l = this.m_forwardHistory[N])[0], C = 1, _ = l.length - 1)
            } while (--N >= -1);
            if (y = w.getReverseChanges(), b[0]) {
                ...
                w = new xe, C = s, _ = o, L = d[0] - g[0] - a, S = 1073741824, N = p ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                do {
                    const e = L + i;
                    e === C || e < _ && u[e - 1] >= u[e + 1] ? (f = (c = u[e + 1] - 1) - L - a, c > S && w.MarkNextChange(), S = c + 1, w.AddOriginalElement(c + 1, f + 1), L = e + 1 - i) : (f = (c = u[e - 1]) - L - a, c > S && w.MarkNextChange(), S = c, w.AddModifiedElement(c + 1, f + 1), L = e - 1 - i), N >= 0 && (i = (u = this.m_reverseHistory[N])[0], C = 1, _ = u.length - 1)
                } while (--N >= -1);
                v = w.getChanges()
            }
        ...
        ComputeRecursionPoint(e, t, n, r, i, s, o) {
            ...
            const f = t - e + (r - n), m = f + 1, g = new Int32Array(m), p = new Int32Array(m), b = r - n, y = t - e,
                v = e - n, w = t - r, C = (y - b) % 2 == 0;
            g[b] = e, p[y] = t, o[0] = !1;
            for (let _ = 1; _ <= f / 2 + 1; _++) {
                let f = 0, L = 0;
                u = this.ClipDiagonalBound(b - _, _, b, m), c = this.ClipDiagonalBound(b + _, _, b, m);
                for (let e = u; e <= c; e += 2) {
                    a = e === u || e < c && g[e - 1] < g[e + 1] ? g[e + 1] : g[e - 1] + 1, l = a - (e - b) - v;
                    const n = a;
                    for (; a < t && l < r && this.ElementsAreEqual(a + 1, l + 1);) a++, l++;
                    if (g[e] = a, a + l > f + L && (f = a, L = l), !C && Math.abs(e - y) <= _ - 1 && a >= p[e]) return i[0] = a, s[0] = l, n <= p[e] && _ <= 1448 ? this.WALKTRACE(b, u, c, v, y, h, d, w, g, p, a, t, i, l, r, s, C, o) : null
                }
                const S = (f - e + (L - n) - _) / 2;
                if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(f, S)) return o[0] = !0, i[0] = f, s[0] = L, S > 0 && _ <= 1448 ? this.WALKTRACE(b, u, c, v, y, h, d, w, g, p, a, t, i, l, r, s, C, o) : (e++, n++, [new ve(e, t - e + 1, n, r - n + 1)]);
                h = this.ClipDiagonalBound(y - _, _, y, m), d = this.ClipDiagonalBound(y + _, _, y, m);
                for (let m = h; m <= d; m += 2) {
                    a = m === h || m < d && p[m - 1] >= p[m + 1] ? p[m + 1] - 1 : p[m - 1], l = a - (m - y) - w;
                    const f = a;
                    for (; a > e && l > n && this.ElementsAreEqual(a, l);) a--, l--;
                    if (p[m] = a, C && Math.abs(m - b) <= _ && a <= g[m]) return i[0] = a, s[0] = l, f >= g[m] && _ <= 1448 ? this.WALKTRACE(b, u, c, v, y, h, d, w, g, p, a, t, i, l, r, s, C, o) : null
                }
                if (_ <= 1447) {
                    let e = new Int32Array(c - u + 2);
                    e[0] = b - u + 1, Ne.Copy2(g, u, e, 1, c - u + 1), this.m_forwardHistory.push(e), e = new Int32Array(d - h + 2), e[0] = y - h + 1, Ne.Copy2(p, h, e, 1, d - h + 1), this.m_reverseHistory.push(e)
                }
            }
            return this.WALKTRACE(b, u, c, v, y, h, d, w, g, p, a, t, i, l, r, s, C, o)
        }
        ...
        PrettifyChanges(e) {
            for (let t = 0; t < e.length; t++) {
                const n = e[t], r = t < e.length - 1 ? e[t + 1].originalStart : this._originalElementsOrHash.length,
                    ...
                    s = n.originalLength > 0, o = n.modifiedLength > 0;
            ...
            if (this._hasStrings) for (let t = 1, n = e.length; t < n; t++) {
                const n = e[t - 1], r = e[t], i = r.originalStart - n.originalStart - n.originalLength,
                    s = n.originalStart, o = r.originalStart + r.originalLength, a = o - s, l = n.modifiedStart,
                    u = r.modifiedStart + r.modifiedLength, c = u - l;
                if (i < 5 && a < 20 && c < 20) {
        ...
        ConcatenateChanges(e, t) {
            ...
            if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                ...
                return Ne.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = n[0], Ne.Copy(t, 1, r, e.length, t.length - 1), r
            }
            {
                const n = new Array(e.length + t.length);
                return Ne.Copy(e, 0, n, 0, e.length), Ne.Copy(t, 0, n, e.length, t.length), n
            }
        }
    ...
    class Ve {
        ...
        static computeLinks(e, t = function () {
            return null === Pe && (Pe = new Ie([[1, 104, 2], [1, 72, 2], [1, 102, 6], [1, 70, 6], [2, 116, 3], [2, 84, 3], [3, 116, 4], [3, 84, 4], [4, 112, 5], [4, 80, 5], [5, 115, 9], [5, 83, 9], [5, 58, 10], [6, 105, 7], [6, 73, 7], [7, 108, 8], [7, 76, 8], [8, 101, 9], [8, 69, 9], [9, 58, 10], [10, 47, 11], [11, 47, 12]])), Pe
        }()) {
            const n = function () {
                if (null === Fe) {
                    Fe = new Me(0);
                    const e = " \t<>'\"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|";
                    for (let n = 0; n < e.length; n++) Fe.set(e.charCodeAt(n), 1);
                    const t = ".,;:";
                    for (let n = 0; n < t.length; n++) Fe.set(t.charCodeAt(n), 2)
                }
                return Fe
            }(), r = [];
            for (let i = 1, s = e.getLineCount(); i <= s; i++) {
                const s = e.getLineContent(i), o = s.length;
                let a = 0, l = 0, u = 0, c = 1, h = !1, d = !1, f = !1, m = !1;
                for (; a < o;) {
                    let e = !1;
                    ...
                    if (13 === c) {
                        ...
                        1 === t && (r.push(Ve._createLink(n, s, i, l, a)), e = !0)
                    } else if (12 === c) {
                        let t;
                        91 === o ? (d = !0, t = 0) : t = n.get(o), 1 === t ? e = !0 : c = 13
                    } else c = t.nextState(c, o), 0 === c && (e = !0);
                    e && (c = 1, h = !1, d = !1, m = !1, l = a + 1, u = o), a++
                }
    ...
    !function (e) {
        e.isCancellationToken = function (t) {
            return t === e.None || t === e.Cancelled || (t instanceof $e || !(!t || "object" != typeof t) && ("boolean" == typeof t.isCancellationRequested && "function" == typeof t.onCancellationRequested))
        }, e.None = Object.freeze({
            isCancellationRequested: !1,
            onCancellationRequested: C.None
        }), e.Cancelled = Object.freeze({isCancellationRequested: !0, onCancellationRequested: qe})
    }(Ke || (Ke = {}));
    ...
    class $e {
        ...
        get onCancellationRequested() {
            return this._isCancelled ? qe : (this._emitter || (this._emitter = new A), this._emitter.event)
        }
    ...
    class Be {
        ...
        cancel() {
            this._token ? this._token instanceof $e && this._token.cancel() : this._token = Ke.Cancelled
        }

        dispose(e = !1) {
            e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof $e && this._token.dispose() : this._token = Ke.None
        }
    }
    ...
    const je = new Ue, We = new Ue, ze = new Ue, He = new Array(230), Ge = Object.create(null),
    ...
    } else Ze = "undefined" != typeof process && "string" == typeof process?.versions?.node ? {
        get platform() {
    ...
    const et = Ze.cwd, tt = Ze.env, nt = Ze.platform, rt = 46, it = 47, st = 92, ot = 58;
    ...
    function ft(e, t, n, r) {
        ...
        for (let u = 0; u <= e.length; ++u) {
            if (u < e.length) l = e.charCodeAt(u); else {
                if (r(l)) break;
                l = it
            }
            if (r(l)) {
                if (o === u - 1 || 1 === a) ; else if (2 === a) {
                    if (i.length < 2 || 2 !== s || i.charCodeAt(i.length - 1) !== rt || i.charCodeAt(i.length - 2) !== rt) {
                        if (i.length > 2) {
    ...
    function mt(e, t) {
        !function (e, t) {
            if (null === e || "object" != typeof e) throw new at(t, "Object", e)
        }(t, "pathObject");
        const n = t.dir || t.root,
            r = t.base || `${t.name || ""}${i = t.ext, i ? `${"." === i[0] ? "" : "."}${i}` : ""}`;
        var i;
    ...
    const gt = {
        resolve(...e) {
            ...
            for (let i = e.length - 1; i >= -1; i--) {
                let s;
                if (i >= 0) {
                    if (s = e[i], lt(s, `paths[${i}]`), 0 === s.length) continue
                } else 0 === t.length ? s = et() : (s = tt[`=${t}`] || et(), (void 0 === s || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === st) && (s = `${t}\\`));
                const o = s.length;
                let a = 0, l = "", u = !1;
                const c = s.charCodeAt(0);
                if (1 === o) ct(c) && (a = 1, u = !0); else if (ct(c)) if (u = !0, ct(s.charCodeAt(1))) {
                    let e = 2, t = e;
                ...
                } else a = 1; else dt(c) && s.charCodeAt(1) === ot && (l = s.slice(0, 2), a = 2, o > 2 && ct(s.charCodeAt(2)) && (u = !0, a = 3));
            ...
            if (ct(s)) if (i = !0, ct(e.charCodeAt(1))) {
                let i = 2, s = i;
            ...
            } else r = 1; else dt(s) && e.charCodeAt(1) === ot && (n = e.slice(0, 2), r = 2, t > 2 && ct(e.charCodeAt(2)) && (i = !0, r = 3));
            let o = r < t ? ft(e.slice(r), !i, "\\", ct) : "";
            if (0 !== o.length || i || (o = "."), o.length > 0 && ct(e.charCodeAt(t - 1)) && (o += "\\"), !i && void 0 === n && e.includes(":")) {
                if (o.length >= 2 && dt(o.charCodeAt(0)) && o.charCodeAt(1) === ot) return `.\\${o}`;
                let n = e.indexOf(":");
                do {
                    if (n === t - 1 || ct(e.charCodeAt(n + 1))) return `.\\${o}`
            ...
            return ct(n) || t > 2 && dt(n) && e.charCodeAt(1) === ot && ct(e.charCodeAt(2))
        }, join(...e) {
            if (0 === e.length) return ".";
            let t, n;
            for (let s = 0; s < e.length; ++s) {
                const r = e[s];
                lt(r, "path"), r.length > 0 && (void 0 === t ? t = n = r : t += `\\${r}`)
            }
            if (void 0 === t) return ".";
            let r = !0, i = 0;
            if ("string" == typeof n && ct(n.charCodeAt(0))) {
                ++i;
                const e = n.length;
                e > 1 && ct(n.charCodeAt(1)) && (++i, e > 2 && (ct(n.charCodeAt(2)) ? ++i : r = !1))
            }
            if (r) {
            ...
            const n = gt.resolve(e), r = gt.resolve(t);
            if (n === r) return "";
            ...
            if (d !== c) {
                ...
                if (u > c) {
                    if (t.charCodeAt(a + d) === st) return r.slice(a + d + 1);
                    if (2 === d) return r.slice(a + d)
                }
                o > c && (e.charCodeAt(i + d) === st ? h = d : 2 === d && (h = 3)), -1 === h && (h = 0)
            }
            let f = "";
            for (d = i + h + 1; d <= s; ++d) d !== s && e.charCodeAt(d) !== st || (f += 0 === f.length ? ".." : "\\..");
            return a += h, f.length > 0 ? `${f}${r.slice(a, l)}` : (r.charCodeAt(a) === st && ++a, r.slice(a, l))
        }, toNamespacedPath(e) {
            ...
            if (t.charCodeAt(0) === st) {
                if (t.charCodeAt(1) === st) {
                    ...
                    if (63 !== e && e !== rt) return `\\\\?\\UNC\\${t.slice(2)}`
                }
            } else if (dt(t.charCodeAt(0)) && t.charCodeAt(1) === ot && t.charCodeAt(2) === st) return `\\\\?\\${t}`;
            return t
        }, dirname(e) {
            lt(e, "path");
            const t = e.length;
            ...
            } else dt(i) && e.charCodeAt(1) === ot && (n = t > 2 && ct(e.charCodeAt(2)) ? 3 : 2, r = n);
            let s = -1, o = !0;
            for (let a = t - 1; a >= r; --a) if (ct(e.charCodeAt(a))) {
                if (!o) {
                    s = a;
                    break
                }
            ...
            let n, r = 0, i = -1, s = !0;
            if (e.length >= 2 && dt(e.charCodeAt(0)) && e.charCodeAt(1) === ot && (r = 2), void 0 !== t && t.length > 0 && t.length <= e.length) {
                if (t === e) return "";
            ...
            for (n = e.length - 1; n >= r; --n) if (ct(e.charCodeAt(n))) {
                if (!s) {
                    r = n + 1;
                    break
                }
            ...
            e.length >= 2 && e.charCodeAt(1) === ot && dt(e.charCodeAt(0)) && (t = r = 2);
            for (let a = e.length - 1; a >= t; --a) {
                ...
                } else -1 === i && (s = !1, i = a + 1), t === rt ? -1 === n ? n = a : 1 !== o && (o = 1) : -1 !== n && (o = -1)
            }
            return -1 === n || -1 === i || 0 === o || 1 === o && n === i - 1 && n === r + 1 ? "" : e.slice(n, i)
        }, format: mt.bind(null, "\\"), parse(e) {
            lt(e, "path");
            const t = {root: "", dir: "", base: "", ext: "", name: ""};
            if (0 === e.length) return t;
            const n = e.length;
            let r = 0, i = e.charCodeAt(0);
            if (1 === n) return ct(i) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
            if (ct(i)) {
            ...
            for (; u >= r; --u) if (i = e.charCodeAt(u), ct(i)) {
                if (!l) {
                    o = u + 1;
                    break
                }
            } else -1 === a && (l = !1, a = u + 1), i === rt ? -1 === s ? s = u : 1 !== c && (c = 1) : -1 !== s && (c = -1);
        ...
        resolve(...e) {
            ...
            for (let r = e.length - 1; r >= 0 && !n; r--) {
                const i = e[r];
                lt(i, `paths[${r}]`), 0 !== i.length && (t = `${i}/${t}`, n = i.charCodeAt(0) === it)
            }
            if (!n) {
                const e = pt();
                t = `${e}/${t}`, n = e.charCodeAt(0) === it
            }
            return t = ft(t, !n, "/", ht), n ? `/${t}` : t.length > 0 ? t : "."
        }, normalize(e) {
            if (lt(e, "path"), 0 === e.length) return ".";
            const t = e.charCodeAt(0) === it, n = e.charCodeAt(e.length - 1) === it;
            return 0 === (e = ft(e, !t, "/", ht)).length ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e)
        }, isAbsolute: e => (lt(e, "path"), e.length > 0 && e.charCodeAt(0) === it), join(...e) {
            if (0 === e.length) return ".";
            const t = [];
            ...
            if (a === s) if (i > s) {
                if (t.charCodeAt(1 + a) === it) return t.slice(1 + a + 1);
                if (0 === a) return t.slice(1 + a)
            } else r > s && (e.charCodeAt(1 + a) === it ? o = a : 0 === a && (o = 0));
            let l = "";
            for (a = 1 + o + 1; a <= n; ++a) a !== n && e.charCodeAt(a) !== it || (l += 0 === l.length ? ".." : "/..");
            return `${l}${t.slice(1 + o)}`
        }, toNamespacedPath: e => e, dirname(e) {
            if (lt(e, "path"), 0 === e.length) return ".";
            const t = e.charCodeAt(0) === it;
            let n = -1, r = !0;
            for (let i = e.length - 1; i >= 1; --i) if (e.charCodeAt(i) === it) {
                if (!r) {
                    n = i;
                    break
                }
            ...
            for (n = e.length - 1; n >= 0; --n) if (e.charCodeAt(n) === it) {
                if (!s) {
                    r = n + 1;
                    break
                }
            ...
            for (let o = e.length - 1; o >= 0; --o) {
                const a = e[o];
                if ("/" !== a) -1 === r && (i = !1, r = o + 1), "." === a ? -1 === t ? t = o : 1 !== s && (s = 1) : -1 !== t && (s = -1); else if (!i) {
                    n = o + 1;
                    break
                }
            }
            ...
            for (; l >= r; --l) {
                ...
                if (t !== it) -1 === o && (a = !1, o = l + 1), t === rt ? -1 === i ? i = l : 1 !== u && (u = 1) : -1 !== i && (u = -1); else if (!a) {
                    s = l + 1;
                    break
                }
            }
    ...
    bt.win32 = gt.win32 = gt, bt.posix = gt.posix = bt, ut ? gt.normalize : bt.normalize, ut ? gt.resolve : bt.resolve, ut ? gt.relative : bt.relative, ut ? gt.dirname : bt.dirname, ut ? gt.basename : bt.basename, ut ? gt.extname : bt.extname, ut ? gt.sep : bt.sep;
    const yt = /^\w[\w\d+.-]*$/, vt = /^\//, wt = /^\/\//;
    const Ct = "", _t = "/", Lt = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
    let St = class e {
        static isUri(t) {
        ...
        constructor(e, t, n, r, i, s = !1) {
            "object" == typeof e ? (this.scheme = e.scheme || Ct, this.authority = e.authority || Ct, this.path = e.path || Ct, this.query = e.query || Ct, this.fragment = e.fragment || Ct) : (this.scheme = function (e, t) {
                return e || t ? e : "file"
            }(e, s), this.authority = t || Ct, this.path = function (e, t) {
                switch (e) {
                    case"https":
                    case"http":
                    case"file":
                ...
                return t
            }(this.scheme, n || Ct), this.query = r || Ct, this.fragment = i || Ct, function (e, t) {
                ...
                if (e.scheme && !yt.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
                ...
                } else if (wt.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
            }(this, s))
        }
        ...
        with(e) {
            ...
            return void 0 === t ? t = this.scheme : null === t && (t = Ct), void 0 === n ? n = this.authority : null === n && (n = Ct), void 0 === r ? r = this.path : null === r && (r = Ct), void 0 === i ? i = this.query : null === i && (i = Ct), void 0 === s ? s = this.fragment : null === s && (s = Ct), t === this.scheme && n === this.authority && r === this.path && i === this.query && s === this.fragment ? this : new xt(t, n, r, i, s)
        }

        static parse(e, t = !1) {
            const n = Lt.exec(e);
            return n ? new xt(n[2] || Ct, It(n[4] || Ct), It(n[5] || Ct), It(n[7] || Ct), It(n[9] || Ct), t) : new xt(Ct, Ct, Ct, Ct, Ct)
        }
        ...
        static file(e) {
            ...
            if (z && (e = e.replace(/\\/g, _t)), e[0] === _t && e[1] === _t) {
                ...
                -1 === n ? (t = e.substring(2), e = _t) : (t = e.substring(2, n), e = e.substring(n) || _t)
            }
        ...
        static joinPath(t, ...n) {
            ...
            let r;
            return r = z && "file" === t.scheme ? e.file(gt.join(Rt(t, !0), ...n)).path : bt.join(t.path, ...n), t.with({path: r})
        }
        ...
        static revive(t) {
            if (t) {
                ...
                {
                    const e = new xt(t);
                    return e._formatted = t.external ?? null, e._fsPath = t._sep === Nt ? t.fsPath ?? null : null, e
                }
            }
            return t
        }
    ...
    class xt extends St {
        ...
        toString(e = !1) {
            return e ? Tt(this, !0) : (this._formatted || (this._formatted = Tt(this, !1)), this._formatted)
        }

        toJSON() {
            const e = {$mid: 1};
            return this._fsPath && (e.fsPath = this._fsPath, e._sep = Nt), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e
        }
    }
    ...
    function At(e, t, n) {
        ...
        for (let s = 0; s < e.length; s++) {
            ...
            if (o >= 97 && o <= 122 || o >= 65 && o <= 90 || o >= 48 && o <= 57 || 45 === o || 46 === o || 95 === o || 126 === o || t && 47 === o || n && 91 === o || n && 93 === o || n && 58 === o) -1 !== i && (r += encodeURIComponent(e.substring(i, s)), i = -1), void 0 !== r && (r += e.charAt(s)); else {
    ...
    function kt(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const r = e.charCodeAt(n);
            35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), t += Et[r]) : void 0 !== t && (t += e[n])
        }
        return void 0 !== t ? t : e
    }
    ...
    function Tt(e, t) {
        ...
        if (i && (r += i, r += ":"), (s || "file" === i) && (r += _t, r += _t), s) {
            let e = s.indexOf("@");
            if (-1 !== e) {
        ...
        return a && (r += "?", r += n(a, !1, !1)), l && (r += "#", r += t ? l : At(l, !1, !1)), r
    }
    ...
    class Pt extends ke {
        ...
        setEndPosition(e, t) {
            return 0 === this.getDirection() ? new Pt(this.startLineNumber, this.startColumn, e, t) : new Pt(e, t, this.startLineNumber, this.startColumn)
        }
        ...
        getSelectionStart() {
            return new Ae(this.selectionStartLineNumber, this.selectionStartColumn)
        }

        setStartPosition(e, t) {
            return 0 === this.getDirection() ? new Pt(e, t, this.endLineNumber, this.endColumn) : new Pt(this.endLineNumber, this.endColumn, e, t)
        }
        ...
        static fromRange(e, t) {
            return 0 === t ? new Pt(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : new Pt(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn)
        }

        static liftSelection(e) {
            return new Pt(e.selectionStartLineNumber, e.selectionStartColumn, e.positionLineNumber, e.positionColumn)
        }
    ...
    const Dt = {
        ...{
            ...
            debugBreakpointConditionalUnverified: Vt("debug-breakpoint-conditional-unverified", 60070),
            debugBreakpointConditional: Vt("debug-breakpoint-conditional", 60071),
            debugBreakpointConditionalDisabled: Vt("debug-breakpoint-conditional-disabled", 60071),
            debugBreakpointDataUnverified: Vt("debug-breakpoint-data-unverified", 60072),
            debugBreakpointData: Vt("debug-breakpoint-data", 60073),
            debugBreakpointDataDisabled: Vt("debug-breakpoint-data-disabled", 60073),
            debugBreakpointLogUnverified: Vt("debug-breakpoint-log-unverified", 60074),
            debugBreakpointLog: Vt("debug-breakpoint-log", 60075),
            debugBreakpointLogDisabled: Vt("debug-breakpoint-log-disabled", 60075),
            ...
            terminalDecorationIncomplete: Vt("terminal-decoration-incomplete", 60092),
            ...
            debugBreakpointFunctionUnverified: Vt("debug-breakpoint-function-unverified", 60295),
            debugBreakpointFunction: Vt("debug-breakpoint-function", 60296),
            debugBreakpointFunctionDisabled: Vt("debug-breakpoint-function-disabled", 60296),
            ...
            debugBreakpointUnsupported: Vt("debug-breakpoint-unsupported", 60300),
            ...
            gitPullRequestGoToChanges: Vt("git-pull-request-go-to-changes", 60427),
            ...
            treeFilterOnTypeOff: Vt("tree-filter-on-type-off", "list-selection"),
            ...
            scrollbarButtonRight: Vt("scrollbar-button-right", "triangle-right"),
    ...
    var Xt, Qt, Zt, Yt, en, tn, nn, rn, sn, on, an, ln, un, cn, hn, dn, fn, mn, gn, pn, bn, yn, vn, wn, Cn, _n, Ln, Sn,
        Nn, xn, En, An, kn, Rn, Tn, Mn, On, In, Pn, Fn, Vn, Dn, qn, Kn, $n, Bn, Un, jn, Wn, zn, Hn, Gn, Jn, Xn, Qn, Zn,
        Yn;
    !function (e) {
        ...
        constructor() {
            this._tokenizationSupports = new Map, this._factories = new Map, this._onDidChange = new A, this.onDidChange = this._onDidChange.event, this._colorMap = null
        }
    ...
    class tr {
        constructor() {
            this[Jn] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
        }
        ...
        set(e, t, n = 0) {
            ...
            if (r) r.value = t, 0 !== n && this.touch(r, n); else {
        ...
        next(e) {
            ...
            do {
                ...
                if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
                    if (0 === i) {
                        re(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
                        continue
                    }
                    return null
                }
                if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || ir(this._wordSeparators, e, t, r, i)) return n
            } while (n);
            return null
        }
    }
    ...
    function ur(e, t, n, r, i) {
        if (t = ar(t), i || (i = h.first(lr)), n.length > i.maxLen) {
            let s = e - i.maxLen / 2;
            return s < 0 ? s = 0 : r += s, ur(e, t, n = n.substring(s, e + i.maxLen / 2), r, i)
        }
    ...
    class hr {
        static computeUnicodeHighlights(e, t, n) {
            const r = n ? n.startLineNumber : 1, i = n ? n.endLineNumber : e.getLineCount(), s = new dr(t),
            ...
            switch (n.shouldHighlightNonBasicASCII(e, null)) {
                ...
                case 3: {
                    const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r),
                        s = oe.getLocales().filter(e => !oe.getInstance(new Set([...t.allowedLocales, e])).isAmbiguous(r));
    ...
    class dr {
        ...
        getCandidateCodePoints() {
            ...
            const e = new Set;
            if (this.options.invisibleCharacters) for (const t of ae.codePoints) fr(String.fromCodePoint(t)) || e.add(t);
        ...
        shouldHighlightNonBasicASCII(e, t) {
            ...
            if (t) for (const s of t) {
                const e = s.codePointAt(0), t = se(s);
                r = r || t, t || this.ambiguousCharacters.isAmbiguous(e) || ae.isInvisibleCharacter(e) || (i = !0)
            }
            return !r && i ? 0 : this.options.invisibleCharacters && !fr(e) && ae.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0
        }
    }
    ...
    class vr {
        ...
        findLastMaxBy(e) {
            let t, n = !0;
            return this.iterate(r => ((n || pr.isGreaterThan(e(r, t))) && (n = !1, t = r), !0)), t
        }
    }
    ...
    class wr {
        ...
        static addRange(e, t) {
            ...
            if (n === r) t.splice(n, 0, e); else {
                const i = Math.min(e.start, t[n].start), s = Math.max(e.endExclusive, t[r - 1].endExclusive);
        ...
        join(e) {
            return new wr(Math.min(this.start, e.start), Math.max(this.endExclusive, e.endExclusive))
        }
        ...
        joinRightTouching(e) {
            if (this.endExclusive !== e.start) throw new o(`Invalid join: ${this.toString()} and ${e.toString()}`);
    ...
    class Nr {
        ...
        static joinMany(e) {
            ...
            for (let n = 1; n < e.length; n++) t = t.getUnion(new xr(e[n].slice()));
            return t.ranges
        }
        ...
        static join(e) {
            ...
            for (let r = 1; r < e.length; r++) t = Math.min(t, e[r].startLineNumber), n = Math.max(n, e[r].endLineNumberExclusive);
            return new Nr(t, n)
        }
        ...
        delta(e) {
            return new Nr(this.startLineNumber + e, this.endLineNumberExclusive + e)
        }

        deltaLength(e) {
            return new Nr(this.startLineNumber, this.endLineNumberExclusive + e)
        }
        ...
        join(e) {
            return new Nr(Math.min(this.startLineNumber, e.startLineNumber), Math.max(this.endLineNumberExclusive, e.endLineNumberExclusive))
        }
        ...
        toInclusiveRange() {
            return this.isEmpty ? null : new ke(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
        }
        ...
        toOffsetRange() {
            return new wr(this.startLineNumber - 1, this.endLineNumberExclusive - 1)
        }

        addMargin(e, t) {
            return new Nr(this.startLineNumber - e, this.endLineNumberExclusive + t)
        }
    }
    ...
    class xr {
        ...
        addRange(e) {
            if (0 === e.length) return;
            const t = Lr(this._normalizedRanges, t => t.endLineNumberExclusive >= e.startLineNumber),
                n = _r(this._normalizedRanges, t => t.startLineNumber <= e.endLineNumberExclusive) + 1;
        ...
        intersects(e) {
            const t = Cr(this._normalizedRanges, t => t.startLineNumber < e.endLineNumberExclusive);
        ...
        getUnion(e) {
            ...
            const t = [];
            let n = 0, r = 0, i = null;
            for (; n < this._normalizedRanges.length || r < e._normalizedRanges.length;) {
                let s = null;
                if (n < this._normalizedRanges.length && r < e._normalizedRanges.length) {
                    const t = this._normalizedRanges[n], i = e._normalizedRanges[r];
                    t.startLineNumber < i.startLineNumber ? (s = t, n++) : (s = i, r++)
                } else n < this._normalizedRanges.length ? (s = this._normalizedRanges[n], n++) : (s = e._normalizedRanges[r], r++);
                null === i ? i = s : i.endLineNumberExclusive >= s.startLineNumber ? i = new Nr(i.startLineNumber, Math.max(i.endLineNumberExclusive, s.endLineNumberExclusive)) : (t.push(i), i = s)
            }
        ...
        subtractFrom(e) {
            ...
            for (let s = t; s < n; s++) {
                ...
                e.startLineNumber > i && r.push(new Nr(i, e.startLineNumber)), i = e.endLineNumberExclusive
            }
            return i < e.endLineNumberExclusive && r.push(new Nr(i, e.endLineNumberExclusive)), new xr(r)
        }
        ...
        getIntersection(e) {
            ...
            let n = 0, r = 0;
            for (; n < this._normalizedRanges.length && r < e._normalizedRanges.length;) {
                const i = this._normalizedRanges[n], s = e._normalizedRanges[r], o = i.intersect(s);
                o && !o.isEmpty && t.push(o), i.endLineNumberExclusive < s.endLineNumberExclusive ? n++ : r++
            }
            return new xr(t)
        }
    ...
    class Er {
        ...
        static betweenPositions(e, t) {
            return e.lineNumber === t.lineNumber ? new Er(0, t.column - e.column) : new Er(t.lineNumber - e.lineNumber, t.column - 1)
        }
        ...
        static ofRange(e) {
            return Er.betweenPositions(e.getStartPosition(), e.getEndPosition())
        }
        ...
        add(e) {
            return 0 === e.lineCount ? new Er(this.lineCount, this.columnCount + e.columnCount) : new Er(this.lineCount + e.lineCount, e.columnCount)
        }

        createRange(e) {
            return 0 === this.lineCount ? new ke(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount) : new ke(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1)
        }
        ...
        addToPosition(e) {
            return 0 === this.lineCount ? new Ae(e.lineNumber, e.column + this.columnCount) : new Ae(e.lineNumber + this.lineCount, this.columnCount + 1)
        }
    ...
    class Ar {
        getOffsetRange(e) {
            return new wr(this.getOffset(e.getStartPosition()), this.getOffset(e.getEndPosition()))
        }

        getRange(e) {
            return ke.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive))
        }

        getStringReplacement(e) {
            return new kr.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
        }

        getTextReplacement(e) {
            return new kr.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
        }
    ...
    class Rr extends Ar {
        ...
        getPosition(e) {
            const t = _r(this.lineStartOffsetByLineIdx, t => t <= e), n = t + 1,
        ...
        get textLength() {
            ...
            return new kr.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
        }
    ...
    class Tr {
        ...
        getLineLength(e) {
            return this.getValueOfRange(new ke(e, 1, e, Number.MAX_SAFE_INTEGER)).length
        }

        getTransformer() {
            return this._transformer || (this._transformer = new Rr(this.getValue())), this._transformer
        }

        getLineAt(e) {
            return this.getValueOfRange(new ke(e, 1, e, Number.MAX_SAFE_INTEGER))
        }
    }
    ...
    class Ir {
        static joinReplacements(e, t) {
            ...
            const n = e[0].range.getStartPosition(), r = e[e.length - 1].range.getEndPosition();
            let i = "";
            for (let s = 0; s < e.length; s++) {
                const n = e[s];
                if (i += n.text, s < e.length - 1) {
                    const r = e[s + 1], o = ke.fromPositions(n.range.getEndPosition(), r.range.getStartPosition());
        ...
        static fromStringReplacement(e, t) {
            return new Ir(t.getTransformer().getRange(e.replaceRange), e.newText)
        }
        ...
        removeCommonPrefix(e) {
            const t = e.getValueOfRange(this.range).replaceAll("\r\n", "\n"), n = this.text.replaceAll("\r\n", "\n"),
                r = function (e, t) {
                    ...
                    return n
                }(t, n), i = Er.ofText(t.substring(0, r)).addToPosition(this.range.getStartPosition()),
                s = n.substring(r), o = ke.fromPositions(i, this.range.getEndPosition());
            return new Ir(o, s)
        }
        ...
        removeCommonSuffix(e) {
            const t = e.getValueOfRange(this.range).replaceAll("\r\n", "\n"), n = this.text.replaceAll("\r\n", "\n"),
                r = function (e, t) {
                    ...
                    return n
                }(t, n), i = Er.ofText(t.substring(0, t.length - r)).addToPosition(this.range.getStartPosition()),
                s = n.substring(0, n.length - r), o = ke.fromPositions(this.range.getStartPosition(), i);
            return new Ir(o, s)
        }
    ...
    class Pr {
        static inverse(e, t, n) {
            ...
            let i = 1, s = 1;
            for (const a of e) {
                const e = new Pr(new Nr(i, a.original.startLineNumber), new Nr(s, a.modified.startLineNumber));
                e.modified.isEmpty || r.push(e), i = a.original.endLineNumberExclusive, s = a.modified.endLineNumberExclusive
            }
        ...
        static clip(e, t, n) {
            const r = [];
            for (const i of e) {
                const e = i.original.intersect(t), s = i.modified.intersect(n);
        ...
        join(e) {
            return new Pr(this.original.join(e.original), this.modified.join(e.modified))
        }
        ...
        toRangeMapping() {
            ...
            if (1 === this.original.startLineNumber || 1 === this.modified.startLineNumber) {
                ...
                return new qr(new ke(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new ke(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1))
            }
            return new qr(new ke(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new ke(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER))
        }

        toRangeMapping2(e, t) {
            if (Vr(this.original.endLineNumberExclusive, e) && Vr(this.modified.endLineNumberExclusive, t)) return new qr(new ke(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new ke(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
            if (!this.original.isEmpty && !this.modified.isEmpty) return new qr(ke.fromPositions(new Ae(this.original.startLineNumber, 1), Fr(new Ae(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), ke.fromPositions(new Ae(this.modified.startLineNumber, 1), Fr(new Ae(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
            if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new qr(ke.fromPositions(Fr(new Ae(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), Fr(new Ae(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), ke.fromPositions(Fr(new Ae(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Fr(new Ae(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
            throw new o
        }
    }
    ...
    function Fr(e, t) {
        if (e.lineNumber < 1) return new Ae(1, 1);
        if (e.lineNumber > t.length) return new Ae(t.length, t[t.length - 1].length + 1);
    ...
    class Dr extends Pr {
        static fromRangeMappings(e) {
            const t = Nr.join(e.map(e => Nr.fromRangeInclusive(e.originalRange))),
                n = Nr.join(e.map(e => Nr.fromRangeInclusive(e.modifiedRange)));
            return new Dr(t, n, e)
        }
        ...
        flip() {
            return new Dr(this.modified, this.original, this.innerChanges?.map(e => e.flip()))
        }

        withInnerChangesFromLineRanges() {
            return new Dr(this.original, this.modified, [this.toRangeMapping()])
        }
    }
    ...
    function Kr(e, t, n, r = !1) {
        ...
        for (const s of function* (e, t) {
            ...
            const s = new Nr(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i),
                o = new Nr(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i);
            return new Dr(s, o, [e])
        }(e, t, n)), (e, t) => e.original.intersectsOrTouches(t.original) || e.modified.intersectsOrTouches(t.modified))) {
            const e = s[0], t = s[s.length - 1];
            i.push(new Dr(e.original.join(t.original), e.modified.join(t.modified), s.map(e => e.innerChanges[0])))
        }
        return l(() => {
            if (!r && i.length > 0) {
    ...
    class $r {
        computeDiff(e, t, n) {
            ...
            for (const o of r.changes) {
                let e, t;
                e = 0 === o.originalEndLineNumber ? new Nr(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : new Nr(o.originalStartLineNumber, o.originalEndLineNumber + 1), t = 0 === o.modifiedEndLineNumber ? new Nr(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : new Nr(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
                let n = new Dr(e, t, o.charChanges?.map(e => new qr(new ke(e.originalStartLineNumber, e.originalStartColumn, e.originalEndLineNumber, e.originalEndColumn), new ke(e.modifiedStartLineNumber, e.modifiedStartColumn, e.modifiedEndLineNumber, e.modifiedEndColumn))));
                s && (s.modified.endLineNumberExclusive !== n.modified.startLineNumber && s.original.endLineNumberExclusive !== n.original.startLineNumber || (n = new Dr(s.original.join(n.original), s.modified.join(n.modified), s.innerChanges && n.innerChanges ? s.innerChanges.concat(n.innerChanges) : void 0), i.pop())), i.push(n), s = n
            }
            return l(() => u(i, (e, t) => t.original.startLineNumber - e.original.endLineNumberExclusive === t.modified.startLineNumber - e.modified.endLineNumberExclusive && e.original.endLineNumberExclusive < t.original.startLineNumber && e.modified.endLineNumberExclusive < t.modified.startLineNumber)), new mr(i, [], r.quitEarly)
        }
    }
    ...
    let Ur = class {
        constructor(e) {
            const t = [], n = [];
            for (let r = 0, i = e.length; r < i; r++) t[r] = Gr(e[r], 1), n[r] = Jr(e[r], 1);
    ...
    class Wr {
        ...
        static createFromDiffChange(e, t, n) {
            const r = t.getStartLineNumber(e.originalStart), i = t.getStartColumn(e.originalStart),
                s = t.getEndLineNumber(e.originalStart + e.originalLength - 1),
                o = t.getEndColumn(e.originalStart + e.originalLength - 1), a = n.getStartLineNumber(e.modifiedStart),
                l = n.getStartColumn(e.modifiedStart), u = n.getEndLineNumber(e.modifiedStart + e.modifiedLength - 1),
    ...
    class zr {
        ...
        static createFromDiffResult(e, t, n, r, i, s, o) {
            let a, l, u, c, h;
            if (0 === t.originalLength ? (a = n.getStartLineNumber(t.originalStart) - 1, l = 0) : (a = n.getStartLineNumber(t.originalStart), l = n.getEndLineNumber(t.originalStart + t.originalLength - 1)), 0 === t.modifiedLength ? (u = r.getStartLineNumber(t.modifiedStart) - 1, c = 0) : (u = r.getStartLineNumber(t.modifiedStart), c = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1)), s && t.originalLength > 0 && t.originalLength < 20 && t.modifiedLength > 0 && t.modifiedLength < 20 && i()) {
                ...
                if (s.getElements().length > 0 && a.getElements().length > 0) {
                    ...
                    o && (e = function (e) {
                        ...
                        for (let r = 1, i = e.length; r < i; r++) {
                            const i = e[r], s = i.originalStart - (n.originalStart + n.originalLength),
                    ...
                    for (let t = 0, n = e.length; t < n; t++) h.push(Wr.createFromDiffChange(e[t], s, a))
                }
            }
    ...
    class Hr {
        constructor(e, t, n) {
            this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new Ur(e), this.modified = new Ur(t), this.continueLineDiff = Xr(n.maxComputationTime), this.continueCharDiff = Xr(0 === n.maxComputationTime ? 0 : Math.min(n.maxComputationTime, 5e3))
        }
        ...
        computeDiff() {
            ...
            const e = Br(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), t = e.changes,
                n = e.quitEarly;
            if (this.shouldIgnoreTrimWhitespace) {
                const e = [];
                for (let n = 0, r = t.length; n < r; n++) e.push(zr.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[n], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
                return {quitEarly: n, changes: e}
            }
            const r = [];
            let i = 0, s = 0;
            for (let o = -1, a = t.length; o < a; o++) {
                const e = o + 1 < a ? t[o + 1] : null, n = e ? e.originalStart : this.originalLines.length,
                    l = e ? e.modifiedStart : this.modifiedLines.length;
                for (; i < n && s < l;) {
                    const e = this.originalLines[i], t = this.modifiedLines[s];
                    if (e !== t) {
                        {
                            let n = Gr(e, 1), o = Gr(t, 1);
                            for (; n > 1 && o > 1;) {
                ...
                e && (r.push(zr.createFromDiffResult(this.shouldIgnoreTrimWhitespace, e, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += e.originalLength, s += e.modifiedLength)
            }
        ...
        _pushTrimWhitespaceCharChange(e, t, n, r, i, s, o) {
            ...
            let a;
            this.shouldComputeCharChanges && (a = [new Wr(t, n, t, r, i, s, i, o)]), e.push(new zr(t, t, i, i, a))
        }
        ...
        _mergeTrimWhitespaceCharChange(e, t, n, r, i, s, o) {
            ...
            if (0 === a) return !1;
            const l = e[a - 1];
            return 0 !== l.originalEndLineNumber && 0 !== l.modifiedEndLineNumber && (l.originalEndLineNumber === t && l.modifiedEndLineNumber === i ? (this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Wr(t, n, t, r, i, s, i, o)), !0) : l.originalEndLineNumber + 1 === t && l.modifiedEndLineNumber + 1 === i && (l.originalEndLineNumber = t, l.modifiedEndLineNumber = i, this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Wr(t, n, t, r, i, s, i, o)), !0))
        }
    }
    ...
    class Qr {
        static trivial(e, t) {
            return new Qr([new Zr(wr.ofLength(e.length), wr.ofLength(t.length))], !1)
        }

        static trivialTimedOut(e, t) {
            return new Qr([new Zr(wr.ofLength(e.length), wr.ofLength(t.length))], !0)
        }
    ...
    class Zr {
        static invert(e, t) {
            ...
            return function (e, t) {
                ...
                n.push(Zr.fromOffsetPairs(e ? e.getEndExclusives() : Yr.zero, r ? r.getStarts() : new Yr(t, (e ? e.seq2Range.endExclusive - e.seq1Range.endExclusive : 0) + t)))
            }), n
        }

        static fromOffsetPairs(e, t) {
            return new Zr(new wr(e.offset1, t.offset1), new wr(e.offset2, t.offset2))
        }
        ...
        join(e) {
            return new Zr(this.seq1Range.join(e.seq1Range), this.seq2Range.join(e.seq2Range))
        }

        delta(e) {
            return 0 === e ? this : new Zr(this.seq1Range.delta(e), this.seq2Range.delta(e))
        }

        deltaStart(e) {
            return 0 === e ? this : new Zr(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e))
        }

        deltaEnd(e) {
            return 0 === e ? this : new Zr(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e))
        }
    ...
    class si {
        compute(e, t, n = ei.instance, r) {
            ...
            const i = new ni(e.length, t.length), s = new ni(e.length, t.length), o = new ni(e.length, t.length);
            ...
            function c(e, t) {
                e + 1 === l && t + 1 === u || a.push(new Zr(new wr(e + 1, l), new wr(t + 1, u))), l = e, u = t
            }
    ...
    class oi {
        compute(e, t, n = ei.instance) {
            ...
            e:for (; ;) {
                ...
                for (u = e; u <= t; u += 2) {
                    const n = u === t ? -1 : a.get(u + 1), o = u === e ? -1 : a.get(u - 1) + 1,
                        c = Math.min(Math.max(n, o), r.length), h = c - u;
                    if (c > r.length || h > i.length) continue;
                    const d = s(c, h);
                    a.set(u, d);
                    const f = c === n ? l.get(u + 1) : l.get(u - 1);
                    if (l.set(u, d !== c ? new ai(f, c, h, d - c) : f), a.get(u) === r.length && a.get(u) - u === i.length) break e
                }
            }
            let c = l.get(u);
            const h = [];
            ...
            for (; ;) {
                ...
                if (e === d && t === f || h.push(new Zr(new wr(e, d), new wr(t, f))), !c) break;
    ...
    class ci {
        ...
        getBoundaryScore(e) {
            const t = gi(e > 0 ? this.elements[e - 1] : -1), n = gi(e < this.elements.length ? this.elements[e] : -1);
            if (7 === t && 8 === n) return 0;
            if (8 === t) return 150;
            let r = 0;
            return t !== n && (r += 10, 0 === t && 1 === n && (r += 1)), r += mi(t), r += mi(n), r
        }

        translateOffset(e, t = "right") {
            const n = _r(this.firstElementOffsetByLineIdx, t => t <= e), r = e - this.firstElementOffsetByLineIdx[n];
            return new Ae(this.range.startLineNumber + n, 1 + this.lineStartOffsets[n] + r + (0 === r && "left" === t ? 0 : this.trimmedWsLengthsByLineIdx[n]))
        }

        translateRange(e) {
            const t = this.translateOffset(e.start, "right"), n = this.translateOffset(e.endExclusive, "left");
            return n.isBefore(t) ? ke.fromPositions(n, n) : ke.fromPositions(t, n)
        }
        ...
        findSubWordContaining(e) {
            ...
            if (!hi(this.elements[e])) return;
            let t = e;
            for (; t > 0 && hi(this.elements[t - 1]) && !di(this.elements[t]);) t--;
            let n = e;
            for (; n < this.elements.length && hi(this.elements[n]) && !di(this.elements[n]);) n++;
            return new wr(t, n)
        }
        ...
        extendToFullLines(e) {
            const t = Cr(this.firstElementOffsetByLineIdx, t => t <= e.start) ?? 0, n = function (e, t) {
                const n = Lr(e, t);
    ...
    function gi(e) {
        return 10 === e ? 8 : 13 === e ? 7 : ri(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : -1 === e ? 3 : 44 === e || 59 === e ? 5 : 4
    }

    function pi(e, t, n, r, i, s) {
        let {moves: o, excludedChanges: a} = function (e, t, n, r) {
            const i = [],
                s = e.filter(e => e.modified.isEmpty && e.original.length >= 3).map(e => new ii(e.original, t, e)),
                o = new Set(e.filter(e => e.original.isEmpty && e.modified.length >= 3).map(e => new ii(e.modified, n, e))),
                a = new Set;
            for (const l of s) {
                let e, t = -1;
                for (const n of o) {
                ...
                if (t > .9 && e && (o.delete(e), i.push(new Pr(l.range, e.range)), a.add(l.source), a.add(e.source)), !r.isValid()) return {
                    moves: i,
                    excludedChanges: a
                }
            }
        ...
        const l = function (e, t, n, r, i, s) {
            ...
            for (const f of e) {
                ...
                for (let t = f.modified.startLineNumber; t < f.modified.endLineNumberExclusive - 2; t++) {
                    const r = `${n[t - 1]}:${n[t + 1 - 1]}:${n[t + 2 - 1]}`, i = new Nr(t, t + 3), s = [];
                    a.forEach(r, ({range: t}) => {
                        for (const r of e) if (r.originalLineRange.endLineNumberExclusive + 1 === t.endLineNumberExclusive && r.modifiedLineRange.endLineNumberExclusive + 1 === i.endLineNumberExclusive) return r.originalLineRange = new Nr(r.originalLineRange.startLineNumber, t.endLineNumberExclusive), r.modifiedLineRange = new Nr(r.modifiedLineRange.startLineNumber, i.endLineNumberExclusive), void s.push(r);
            ...
            l.sort((u = br(e => e.modifiedLineRange.length, yr), (e, t) => -u(e, t)));
            var u;
            const c = new xr, h = new xr;
            for (const f of l) {
                const e = f.modifiedLineRange.startLineNumber - f.originalLineRange.startLineNumber,
                    t = c.subtractFrom(f.modifiedLineRange), n = h.subtractFrom(f.originalLineRange).getWithDelta(e),
            ...
            for (let f = 0; f < o.length; f++) {
                const t = o[f], n = d.findLastMonotonous(e => e.original.startLineNumber <= t.original.startLineNumber),
                    a = Cr(e, e => e.modified.startLineNumber <= t.modified.startLineNumber),
                    l = Math.max(t.original.startLineNumber - n.original.startLineNumber, t.modified.startLineNumber - a.modified.startLineNumber),
                    u = d.findLastMonotonous(e => e.original.startLineNumber < t.original.endLineNumberExclusive),
                    m = Cr(e, e => e.modified.startLineNumber < t.modified.endLineNumberExclusive),
                    g = Math.max(u.original.endLineNumberExclusive - t.original.endLineNumberExclusive, m.modified.endLineNumberExclusive - t.modified.endLineNumberExclusive);
                let p, b;
                for (p = 0; p < l; p++) {
                ...
                for (p > 0 && (h.addRange(new Nr(t.original.startLineNumber - p, t.original.startLineNumber)), c.addRange(new Nr(t.modified.startLineNumber - p, t.modified.startLineNumber))), b = 0; b < g; b++) {
                    const e = t.original.endLineNumberExclusive + b, n = t.modified.endLineNumberExclusive + b;
                    if (e > r.length || n > i.length) break;
                    if (c.contains(n) || h.contains(e)) break;
                    if (!bi(r[e - 1], i[n - 1], s)) break
                }
                b > 0 && (h.addRange(new Nr(t.original.endLineNumberExclusive, t.original.endLineNumberExclusive + b)), c.addRange(new Nr(t.modified.endLineNumberExclusive, t.modified.endLineNumberExclusive + b))), (p > 0 || b > 0) && (o[f] = new Pr(new Nr(t.original.startLineNumber - p, t.original.endLineNumberExclusive + b), new Nr(t.modified.startLineNumber - p, t.modified.endLineNumberExclusive + b)))
            }
            return o
        ...
        return function (e, t) {
            ...
            for (let n = 1; n < e.length; n++) {
                const r = t[t.length - 1], i = e[n], s = i.original.startLineNumber - r.original.endLineNumberExclusive,
            ...
            const n = new Sr(e);
            return t = t.filter(t => (n.findLastMonotonous(e => e.original.startLineNumber < t.original.endLineNumberExclusive) || new Pr(new Nr(1, 1), new Nr(1, 1))) !== Cr(e, e => e.modified.startLineNumber < t.modified.endLineNumberExclusive)), t
        }(e, o), o
    }
    ...
    function bi(e, t, n) {
        ...
        const r = (new oi).compute(new ci([e], new ke(1, 1, 1, e.length), !1), new ci([t], new ke(1, 1, 1, t.length), !1), n);
        let i = 0;
    ...
    function yi(e, t, n) {
        let r = n;
        return r = vi(e, t, r), r = vi(e, t, r), r = function (e, t, n) {
            if (!e.getBoundaryScore || !t.getBoundaryScore) return n;
            for (let r = 0; r < n.length; r++) {
                const i = r > 0 ? n[r - 1] : void 0, s = n[r], o = r + 1 < n.length ? n[r + 1] : void 0,
                    a = new wr(i ? i.seq1Range.endExclusive + 1 : 0, o ? o.seq1Range.start - 1 : e.length),
                    l = new wr(i ? i.seq2Range.endExclusive + 1 : 0, o ? o.seq2Range.start - 1 : t.length);
                s.seq1Range.isEmpty ? n[r] = wi(s, e, t, a, l) : s.seq2Range.isEmpty && (n[r] = wi(s.swap(), t, e, l, a).swap())
            }
            return n
        }(e, t, r), r
    }
    ...
    function vi(e, t, n) {
        ...
        for (let s = 1; s < n.length; s++) {
            ...
            if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
                ...
                if (s--, s === n) {
                    r[r.length - 1] = new Zr(new wr(i.seq1Range.start, o.seq1Range.endExclusive - n), new wr(i.seq2Range.start, o.seq2Range.endExclusive - n));
                    continue
                }
                o = o.delta(-s)
            }
        ...
        for (let s = 0; s < r.length - 1; s++) {
            ...
            if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
                ...
                if (a === i) {
                    r[s + 1] = new Zr(new wr(o.seq1Range.start + i, n.seq1Range.endExclusive), new wr(o.seq2Range.start + i, n.seq2Range.endExclusive));
                    continue
                }
                a > 0 && (o = o.delta(a))
            }
    ...
    function wi(e, t, n, r, i) {
        ...
        let a = 0, l = -1;
        for (let u = -s; u <= o; u++) {
            const r = e.seq2Range.start + u, i = e.seq2Range.endExclusive + u, s = e.seq1Range.start + u,
                o = t.getBoundaryScore(s) + n.getBoundaryScore(r) + n.getBoundaryScore(i);
            o > l && (l = o, a = u)
        }
        return e.delta(a)
    }
    ...
    function Ci(e, t, n, r, i = !1) {
        const s = Zr.invert(n, e.length), o = [];
        let a = new Yr(0, 0);
        ...
        function l(n, l) {
            ...
            for (; s.length > 0;) {
                ...
                const i = r(e, n.seq1Range.start), o = r(t, n.seq2Range.start), a = new Zr(i, o), l = a.intersect(n);
                if (f += l.seq1Range.length, m += l.seq2Range.length, h = h.join(a), !(h.seq1Range.endExclusive >= n.seq1Range.endExclusive)) break;
                s.shift()
            }
    ...
    class _i {
        ...
        getBoundaryScore(e) {
            return 1e3 - ((0 === e ? 0 : Li(this.lines[e - 1])) + (e === this.lines.length ? 0 : Li(this.lines[e])))
        }
    ...
    class Si {
        constructor() {
            this.dynamicProgrammingDiffing = new si, this.myersDiffingAlgorithm = new oi
        }
        ...
        computeDiff(e, t, n) {
            if (e.length <= 1 && function (e, t, n = (e, t) => e === t) {
                ...
                return !0
            }(e, t, (e, t) => e === t)) return new mr([], [], !1);
            if (1 === e.length && 0 === e[0].length || 1 === t.length && 0 === t[0].length) return new mr([new Dr(new Nr(1, e.length + 1), new Nr(1, t.length + 1), [new qr(new ke(1, 1, e.length, e[e.length - 1].length + 1), new ke(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
            const r = 0 === n.maxComputationTimeMs ? ei.instance : new ti(n.maxComputationTimeMs),
                i = !n.ignoreTrimWhitespace, s = new Map;
            ...
            const a = e.map(e => o(e.trim())), u = t.map(e => o(e.trim())), c = new _i(a, e), h = new _i(u, t),
                d = (() => c.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, h, r, (n, r) => e[n] === t[r] ? 0 === t[r].length ? .1 : 1 + Math.log(1 + t[r].length) : .99) : this.myersDiffingAlgorithm.compute(c, h, r))();
            let f = d.diffs, m = d.hitTimeout;
            f = yi(c, h, f), f = function (e, t, n) {
                let r = n;
                ...
                do {
                    ...
                    for (let a = 1; a < r.length; a++) {
                        ...
                        function c(t, n) {
                            const r = new wr(u.seq1Range.endExclusive, l.seq1Range.start);
            ...
            const g = [], p = s => {
                if (i) for (let o = 0; o < s; o++) {
                    const s = b + o, a = y + o;
                    if (e[s] !== t[a]) {
                        const o = this.refineDiff(e, t, new Zr(new wr(s, s + 1), new wr(a, a + 1)), r, i, n);
            ...
            for (const L of f) {
                ...
                p(L.seq1Range.start - b), b = L.seq1Range.endExclusive, y = L.seq2Range.endExclusive;
                const s = this.refineDiff(e, t, L, r, i, n);
                s.hitTimeout && (m = !0);
                for (const e of s.mappings) g.push(e)
            }
            p(e.length - b);
            const v = new Or(e), w = new Or(t), C = Kr(g, v, w);
            let _ = [];
            return n.computeMoves && (_ = this.computeMoves(C, e, t, a, u, r, i, n)), l(() => {
                function n(e, t) {
                ...
                for (const i of C) {
                    ...
                    for (const r of i.innerChanges) {
                        if (!(n(r.modifiedRange.getStartPosition(), t) && n(r.modifiedRange.getEndPosition(), t) && n(r.originalRange.getStartPosition(), e) && n(r.originalRange.getEndPosition(), e))) return !1
                    }
        ...
        computeMoves(e, t, n, r, i, s, o, a) {
            return pi(e, t, n, r, i, s).map(e => {
                const r = Kr(this.refineDiff(t, n, new Zr(e.original.toOffsetRange(), e.modified.toOffsetRange()), s, o, a).mappings, new Or(t), new Or(n), !0);
                return new gr(e, r)
            })
        }
        ...
        refineDiff(e, t, n, r, i, s) {
            var o;
            const a = new Pr(new Nr((o = n).seq1Range.start + 1, o.seq1Range.endExclusive + 1), new Nr(o.seq2Range.start + 1, o.seq2Range.endExclusive + 1)).toRangeMapping2(e, t),
                l = new ci(e, a.originalRange, i), u = new ci(t, a.modifiedRange, i),
                c = l.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(l, u, r) : this.myersDiffingAlgorithm.compute(l, u, r);
            let h = c.diffs;
            h = yi(l, u, h), h = Ci(l, u, h, (e, t) => e.findWordContaining(t)), s.extendToSubwords && (h = Ci(l, u, h, (e, t) => e.findSubWordContaining(t), !0)), h = function (e, t, n) {
                const r = [];
                for (const i of n) {
                    const e = r[r.length - 1];
                    e && (i.seq1Range.start - e.seq1Range.endExclusive <= 2 || i.seq2Range.start - e.seq2Range.endExclusive <= 2) ? r[r.length - 1] = new Zr(e.seq1Range.join(i.seq1Range), e.seq2Range.join(i.seq2Range)) : r.push(i)
                }
                return r
                ...
                do {
                    ...
                    for (let l = 1; l < r.length; l++) {
                        ...
                        function h(n, r) {
                            const i = new wr(c.seq1Range.endExclusive, u.seq1Range.start);
                            if (e.countLinesIn(i) > 5 || i.length > 500) return !1;
                            const s = e.getText(i).trim();
                            if (s.length > 20 || s.split(/\r\n|\r|\n/).length > 1) return !1;
                            const o = e.countLinesIn(n.seq1Range), a = n.seq1Range.length,
                                l = t.countLinesIn(n.seq2Range), h = n.seq2Range.length,
                                d = e.countLinesIn(r.seq1Range), f = r.seq1Range.length,
                                m = t.countLinesIn(r.seq2Range), g = r.seq2Range.length;
                ...
                return function (e, t) {
                    ...
                    const a = e.extendToFullLines(n.seq1Range), l = e.getText(new wr(a.start, n.seq1Range.start));
                    s(l) && (i = i.deltaStart(-l.length));
                    const u = e.getText(new wr(n.seq1Range.endExclusive, a.endExclusive));
                    s(u) && (i = i.deltaEnd(u.length));
                    const c = Zr.fromOffsetPairs(t ? t.getEndExclusives() : Yr.zero, r ? r.getStarts() : Yr.max),
                        h = i.intersect(c);
    ...
    class ki {
        ...
        static fromRGBA(e) {
            const t = e.r / 255, n = e.g / 255, r = e.b / 255, i = e.a, s = Math.max(t, n, r), o = Math.min(t, n, r);
            let a = 0, l = 0;
            const u = (o + s) / 2, c = s - o;
            if (c > 0) {
                switch (l = Math.min(u <= .5 ? c / (2 * u) : c / (2 - 2 * u), 1), s) {
                    case t:
                        a = (n - r) / c + (n < r ? 6 : 0);
                        break;
                    case n:
        ...
        static toRGBA(e) {
            const t = e.h / 360, {s: n, l: r, a: i} = e;
            let s, o, a;
            if (0 === n) s = o = a = r; else {
                const e = r < .5 ? r * (1 + n) : r + n - r * n, i = 2 * r - e;
                s = ki._hue2rgb(i, e, t + 1 / 3), o = ki._hue2rgb(i, e, t), a = ki._hue2rgb(i, e, t - 1 / 3)
            }
            return new Ai(Math.round(255 * s), Math.round(255 * o), Math.round(255 * a), i)
        }
    }
    ...
    class Ri {
        ...
        static fromRGBA(e) {
            const t = e.r / 255, n = e.g / 255, r = e.b / 255, i = Math.max(t, n, r), s = i - Math.min(t, n, r),
                o = 0 === i ? 0 : s / i;
            let a;
            return a = 0 === s ? 0 : i === t ? ((n - r) / s % 6 + 6) % 6 : i === n ? (r - t) / s + 2 : (t - n) / s + 4, new Ri(Math.round(60 * a), o, i, e.a)
        }
    ...
    let Ti = class e {
        ...
        constructor(e) {
            ...
            if (e instanceof Ai) this.rgba = e; else if (e instanceof ki) this._hsla = e, this.rgba = ki.toRGBA(e); else {
        ...
        mix(t, n = .5) {
            const r = Math.min(Math.max(n, 0), 1), i = this.rgba, s = t.rgba, o = i.r + (s.r - i.r) * r,
                a = i.g + (s.g - i.g) * r, l = i.b + (s.b - i.b) * r, u = i.a + (s.a - i.a) * r;
    ...
    function Pi(e, t) {
        ...
        return n ? {range: e, color: Oi(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)} : void 0
    }
    ...
    function qi(e) {
        return e && "function" == typeof e.getValue && "function" == typeof e.positionAt ? function (e) {
            const t = [],
                n = Di(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|^(#)([A-Fa-f0-9]{3})\b|^(#)([A-Fa-f0-9]{4})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b|(?<=['"\s])(#)([A-Fa-f0-9]{3})\b|(?<=['"\s])(#)([A-Fa-f0-9]{4})\b|(?<=['"\s])(#)([A-Fa-f0-9]{6})\b|(?<=['"\s])(#)([A-Fa-f0-9]{8})\b/gm);
        ...
        (function (t) {
            ...
            t.formatRGB = function (t) {
                ...
                if (t.startsWith("rgba(")) {
                    ...
                    const r = parseInt(n.groups?.r ?? "0"), i = parseInt(n.groups?.g ?? "0"),
                        s = parseInt(n.groups?.b ?? "0"), o = parseFloat(n.groups?.a ?? "0");
                ...
                for (let i = 1; i <= r; i++) {
                    ...
                    if (s) {
                        ...
                        if (e.endColumn > e.startColumn) {
                            const t = {range: e, ...Ui(r.substring(s[0].length)), shouldBeInComments: !1};
    ...
    class Gi {
        constructor(e, t) {
            this._onReturn = t, this._producerConsumer = new Hi, this._iterator = {
    ...
    class Ji {
        ...
        setValue(e, t) {
            return e = Te(e), t = Te(t), this.values[e] !== t && (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0)
        }
        ...
        getIndexOf(e) {
            ...
            for (; t <= n;) if (r = t + (n - t) / 2 | 0, i = this.prefixSum[r], s = i - this.values[r], e < s) n = r - 1; else {
                if (!(e >= i)) break;
                t = r + 1
            }
            return new Xi(r, e - s)
    ...
    class Qi {
        ...
        onEvents(e) {
            ...
            const t = e.changes;
            for (const n of t) this._acceptDeleteRange(n.range), this._acceptInsertText(new Ae(n.range.startLineNumber, n.range.startColumn), n.text);
    ...
    class Zi {
        ...
        $acceptNewModel(e) {
            this._models[e.url] = new Yi(St.parse(e.url), e.lines, e.EOL, e.versionId)
        }
    ...
    class Yi extends Qi {
        ...
        findMatches(e) {
            ...
            for (let n = 0; n < this._lines.length; n++) {
                const r = this._lines[n], i = this.offsetAt(new Ae(n + 1, 1)), s = r.matchAll(e);
    ...
    class es {
        constructor(e = null) {
            this._foreignModule = e, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new Zi
        }
        ...
        async $computeUnicodeHighlights(e, t, n) {
            ...
            return r ? hr.computeUnicodeHighlights(r, t, n) : {
                ranges: [],
                hasMore: !1,
        ...
        static computeDiff(e, t, n, r) {
            const i = "advanced" === r ? xi() : Ni(), s = e.getLinesContent(), o = t.getLinesContent(),
        ...
        async $computeMoreMinimalEdits(e, t, n) {
            ...
            let o = 0;
            for (let a = 1; a < t.length; a++) ke.getEndPosition(t[o].range).equals(ke.getStartPosition(t[a].range)) ? (t[o].range = ke.fromPositions(ke.getStartPosition(t[o].range), ke.getEndPosition(t[a].range)), t[o].text += t[a].text) : (o++, t[o] = t[a]);
            t.length = o + 1;
            for (let {range: a, text: l, eol: u} of t) {
                if ("number" == typeof u && (s = u), ke.isEmpty(a) && !l) continue;
                ...
                const t = Le(e, l, n), o = r.offsetAt(ke.lift(a).getStartPosition());
                for (const n of t) {
                    const e = r.positionAt(o + n.originalStart),
                        t = r.positionAt(o + n.originalStart + n.originalLength), s = {
        ...
        async $computeLinks(e) {
            ...
            return t ? function (e) {
                return e && "function" == typeof e.getLineCount && "function" == typeof e.getLineContent ? Ve.computeLinks(e) : []
            }(t) : null
        }
        ...
        async $textualSuggest(e, t, n, r) {
            const i = new w, s = new RegExp(n, r), o = new Set;
            e:for (const a of e) {
                const e = this._getModel(a);
                if (e) for (const n of e.words(s)) if (n !== t && isNaN(Number(n)) && (o.add(n), o.size > es._suggestionsLimit)) break e
            }
    ...
    function ns(e) {
        ...
        const n = function (e) {
            ...
            const i = ts.getChannel(r), s = new Proxy({}, {
                get(e, t, n) {
                    if ("then" !== t) {
            ...
            return t = e({host: s, getMirrorModels: () => n.requestHandler.getModels()}), new es(t)
        });
        return t
    }
    ...
    function rs(e, t = !1) {
        ...
        function d(t, n) {
            ...
            for (; i < t;) {
                ...
                if (t >= 48 && t <= 57) s = 16 * s + t - 48; else if (t >= 65 && t <= 70) s = 16 * s + t - 65 + 10; else {
                    if (!(t >= 97 && t <= 102)) break;
                    s = 16 * s + t - 97 + 10
                }
                r++, i++
        ...
        function f() {
            ...
            if (ss(t)) return r++, i += String.fromCharCode(t), 13 === t && 10 === e.charCodeAt(r) && (r++, i += "\n"), a++, u = r, o = 14;
            switch (t) {
                case 123:
                    return r++, o = 1;
                case 125:
                ...
                case 47:
                    ...
                    if (42 === e.charCodeAt(r + 1)) {
                        ...
                        for (; r < t;) {
                            ...
                            r++, ss(t) && (13 === t && 10 === e.charCodeAt(r) && r++, a++, u = r)
                        }
                        return s || (r++, h = 1), i = e.substring(l, r), o = 13
                    }
                    return i += String.fromCharCode(t), r++, o = 16;
                case 45:
                    if (i += String.fromCharCode(t), r++, r === n || !os(e.charCodeAt(r))) return o = 16;
                case 48:
                case 49:
                case 50:
                case 51:
                ...
                case 57:
                    return i += function () {
                        let t = r;
                        if (48 === e.charCodeAt(r)) r++; else for (r++; r < e.length && os(e.charCodeAt(r));) r++;
                        if (r < e.length && 46 === e.charCodeAt(r)) {
                            if (r++, !(r < e.length && os(e.charCodeAt(r)))) return h = 3, e.substring(t, r);
                            for (r++; r < e.length && os(e.charCodeAt(r));) r++
                        }
                        let n = r;
                        if (r < e.length && (69 === e.charCodeAt(r) || 101 === e.charCodeAt(r))) if (r++, (r < e.length && 43 === e.charCodeAt(r) || 45 === e.charCodeAt(r)) && r++, r < e.length && os(e.charCodeAt(r))) {
                            for (r++; r < e.length && os(e.charCodeAt(r));) r++;
                            n = r
                        } else h = 3;
    ...
    const as = new Array(20).fill(0).map((e, t) => " ".repeat(t)), ls = 200, us = {
        " ": {
    ...
    function hs(e, t, n) {
        let r, i, s, o, a;
        if (t) {
            for (o = t.offset, a = o + t.length, s = o; s > 0 && !fs(e, s - 1);) s--;
            let l = a;
        ...
        let c, h = 0, d = 0;
        c = n.insertSpaces ? as[n.tabSize || 4] ?? ds(as[1], n.tabSize || 4) : "\t";
        const f = "\t" === c ? "\t" : " ";
        let m = rs(i, !1), g = !1;
        ...
        function p() {
            ...
            return !u || e > us[f][l].length ? l + ds(c, r + d) : e <= 0 ? l : us[f][l][e]
        }
        ...
        function v(n, r, i) {
            g || t && !(r < a && i > o) || e.substring(r, i) === n || y.push({offset: r, length: i - r, content: n})
        }

        let w = b();
        if (n.keepLines && h > 0 && v(ds(l, h), 0, 0), 17 !== w) {
            let e = m.getTokenOffset() + s;
            v(c.length * r < 20 && n.insertSpaces ? as[c.length * r] : ds(c, r), s, e)
        }
        for (; 17 !== w;) {
            let e = m.getTokenOffset() + m.getTokenLength() + s, t = b(), r = "", i = !1;
            for (; 0 === h && (12 === t || 13 === t);) {
                let n = m.getTokenOffset() + s;
                v(as[1], e, n), e = m.getTokenOffset() + m.getTokenLength() + s, i = 12 === t, r = i ? p() : "", t = b()
            }
            if (2 === t) 1 !== w && d--, n.keepLines && h > 0 || !n.keepLines && 1 !== w ? r = p() : n.keepLines && (r = as[1]); else if (4 === t) 3 !== w && d--, n.keepLines && h > 0 || !n.keepLines && 3 !== w ? r = p() : n.keepLines && (r = as[1]); else {
                switch (w) {
                    case 3:
                    case 1:
                        d++, r = n.keepLines && h > 0 || !n.keepLines ? p() : as[1];
                        break;
                    case 5:
                        r = n.keepLines && h > 0 || !n.keepLines ? p() : as[1];
                        break;
                    case 12:
                        r = p();
                        break;
                    ...
                    case 2:
                    case 4:
                        n.keepLines && h > 0 ? r = p() : 12 !== t && 13 !== t || i ? 5 !== t && 17 !== t && (g = !0) : r = as[1];
                        break;
                    case 16:
                        g = !0
                }
    ...
    const ys = function (e, t = [], n = ms.DEFAULT) {
        ...
        return function (e, t, n = ms.DEFAULT) {
            const r = rs(e, !1), i = [];
            ...
            const u = o(t.onObjectBegin), c = l(t.onObjectProperty), h = s(t.onObjectEnd), d = o(t.onArrayBegin),
                f = s(t.onArrayEnd), m = l(t.onLiteralValue), g = a(t.onSeparator), p = s(t.onComment),
                b = a(t.onError), y = n && n.disallowComments, v = n && n.allowTrailingComma;
            ...
            function S() {
                return 10 !== r.getToken() ? (C(3, [], [2, 5]), !1) : (_(!1), 6 === r.getToken() ? (g(":"), w(), E() || C(4, [], [2, 5])) : C(5, [], [2, 5]), i.pop(), !0)
            }
            ...
            function N() {
                ...
                for (; 2 !== r.getToken() && 17 !== r.getToken();) {
                    if (5 === r.getToken()) {
                        if (e || C(4, [], []), g(","), w(), 2 === r.getToken() && v) break
                    } else e && C(6, [], []);
                    S() || C(4, [], [2, 5]), e = !0
                }
                return h(), 2 !== r.getToken() ? C(7, [2], []) : w(), !0
            }
            ...
            function x() {
                ...
                for (; 4 !== r.getToken() && 17 !== r.getToken();) {
                    if (5 === r.getToken()) {
                        if (t || C(4, [], []), g(","), w(), 4 === r.getToken() && v) break
                    } else t && C(6, [], []);
                    e ? (i.push(0), e = !1) : i[i.length - 1]++, E() || C(4, [], [4, 5]), t = !0
                }
                return f(), e || i.pop(), 4 !== r.getToken() ? C(8, [4], []) : w(), !0
            }
            ...
            if (w(), 17 === r.getToken()) return !!n.allowEmptyContent || (C(4, [], []), !1);
            if (!E()) return C(4, [], []), !1;
            17 !== r.getToken() && C(9, [], [])
        }(e, {
            onObjectBegin: () => {
                ...
                i = s.pop()
            }, onLiteralValue: o, onError: (e, n, r) => {
    ...
    var _s, Ls, Ss, Ns, xs, Es, As, ks, Rs, Ts, Ms, Os, Is, Ps, Fs, Vs, Ds, qs, Ks, $s, Bs, Us, js, Ws, zs, Hs, Gs, Js,
        Xs, Qs, Zs, Ys, eo, to, no, ro, io, so, oo, ao, lo, uo, co, ho, fo, mo, go, po, bo, yo, vo, wo, Co, _o, Lo, So,
        No, xo, Eo, Ao, ko, Ro, To, Mo, Oo, Io, Po, Fo, Vo, Do, qo, Ko, $o, Bo, Uo, jo, Wo, zo, Ho, Go;
    ...
    !function (e) {
        ...
        e.create = function (e, t) {
            return e === Number.MAX_VALUE && (e = xs.MAX_VALUE), t === Number.MAX_VALUE && (t = xs.MAX_VALUE), {
                line: e,
                character: t
            }
        }, e.is = function (e) {
            let t = e;
            return sa.objectLiteral(t) && sa.uinteger(t.line) && sa.uinteger(t.character)
        }
    }(Es || (Es = {})), function (e) {
        e.create = function (e, t, n, r) {
            if (sa.uinteger(e) && sa.uinteger(t) && sa.uinteger(n) && sa.uinteger(r)) return {
                start: Es.create(e, t),
                end: Es.create(n, r)
            };
            ...
            let t = e;
            return sa.objectLiteral(t) && Es.is(t.start) && Es.is(t.end)
        }
    }(As || (As = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return sa.objectLiteral(t) && As.is(t.range) && (sa.string(t.uri) || sa.undefined(t.uri))
        }
    }(ks || (ks = {})), function (e) {
        e.create = function (e, t, n, r) {
            ...
            let t = e;
            return sa.objectLiteral(t) && As.is(t.targetRange) && sa.string(t.targetUri) && As.is(t.targetSelectionRange) && (As.is(t.originSelectionRange) || sa.undefined(t.originSelectionRange))
        }
    }(Rs || (Rs = {})), function (e) {
        e.create = function (e, t, n, r) {
            ...
            const t = e;
            return sa.objectLiteral(t) && sa.numberRange(t.red, 0, 1) && sa.numberRange(t.green, 0, 1) && sa.numberRange(t.blue, 0, 1) && sa.numberRange(t.alpha, 0, 1)
        }
    }(Ts || (Ts = {})), function (e) {
        e.create = function (e, t) {
            ...
            const t = e;
            return sa.objectLiteral(t) && As.is(t.range) && Ts.is(t.color)
        }
    }(Ms || (Ms = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            const t = e;
            return sa.objectLiteral(t) && sa.string(t.label) && (sa.undefined(t.textEdit) || Bs.is(t)) && (sa.undefined(t.additionalTextEdits) || sa.typedArray(t.additionalTextEdits, Bs.is))
        }
    }(Os || (Os = {})), function (e) {
        ...
        e.create = function (e, t, n, r, i, s) {
            ...
            return sa.defined(n) && (o.startCharacter = n), sa.defined(r) && (o.endCharacter = r), sa.defined(i) && (o.kind = i), sa.defined(s) && (o.collapsedText = s), o
        }, e.is = function (e) {
            const t = e;
            return sa.objectLiteral(t) && sa.uinteger(t.startLine) && sa.uinteger(t.startLine) && (sa.undefined(t.startCharacter) || sa.uinteger(t.startCharacter)) && (sa.undefined(t.endCharacter) || sa.uinteger(t.endCharacter)) && (sa.undefined(t.kind) || sa.string(t.kind))
        }
    }(Ps || (Ps = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return sa.defined(t) && ks.is(t.location) && sa.string(t.message)
        }
    }(Fs || (Fs = {})), function (e) {
        ...
        e.create = function (e, t, n, r, i, s) {
            ...
            return sa.defined(n) && (o.severity = n), sa.defined(r) && (o.code = r), sa.defined(i) && (o.source = i), sa.defined(s) && (o.relatedInformation = s), o
        }, e.is = function (e) {
            var t;
            let n = e;
            return sa.defined(n) && As.is(n.range) && sa.string(n.message) && (sa.number(n.severity) || sa.undefined(n.severity)) && (sa.integer(n.code) || sa.string(n.code) || sa.undefined(n.code)) && (sa.undefined(n.codeDescription) || sa.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) && (sa.string(n.source) || sa.undefined(n.source)) && (sa.undefined(n.relatedInformation) || sa.typedArray(n.relatedInformation, Fs.is))
        }
    }(Ks || (Ks = {})), function (e) {
        e.create = function (e, t, ...n) {
            ...
            let t = e;
            return sa.defined(t) && sa.string(t.title) && sa.string(t.command)
        }
    }($s || ($s = {})), function (e) {
        e.replace = function (e, t) {
            ...
            const t = e;
            return sa.objectLiteral(t) && sa.string(t.newText) && As.is(t.range)
        }
    }(Bs || (Bs = {})), function (e) {
        e.create = function (e, t, n) {
            const r = {label: e};
            ...
            const t = e;
            return sa.objectLiteral(t) && sa.string(t.label) && (sa.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) && (sa.string(t.description) || void 0 === t.description)
        }
    }(Us || (Us = {})), function (e) {
        e.is = function (e) {
            const t = e;
        ...
        e.replace = function (e, t, n) {
            ...
            const t = e;
            return Bs.is(t) && (Us.is(t.annotationId) || js.is(t.annotationId))
        }
    }(Ws || (Ws = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return sa.defined(t) && Ys.is(t.textDocument) && Array.isArray(t.edits)
        }
    }(zs || (zs = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            let t = e;
            return t && "create" === t.kind && sa.string(t.uri) && (void 0 === t.options || (void 0 === t.options.overwrite || sa.boolean(t.options.overwrite)) && (void 0 === t.options.ignoreIfExists || sa.boolean(t.options.ignoreIfExists))) && (void 0 === t.annotationId || js.is(t.annotationId))
        }
    }(Hs || (Hs = {})), function (e) {
        e.create = function (e, t, n, r) {
            ...
            let t = e;
            return t && "rename" === t.kind && sa.string(t.oldUri) && sa.string(t.newUri) && (void 0 === t.options || (void 0 === t.options.overwrite || sa.boolean(t.options.overwrite)) && (void 0 === t.options.ignoreIfExists || sa.boolean(t.options.ignoreIfExists))) && (void 0 === t.annotationId || js.is(t.annotationId))
        }
    }(Gs || (Gs = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            let t = e;
            return t && "delete" === t.kind && sa.string(t.uri) && (void 0 === t.options || (void 0 === t.options.recursive || sa.boolean(t.options.recursive)) && (void 0 === t.options.ignoreIfNotExists || sa.boolean(t.options.ignoreIfNotExists))) && (void 0 === t.annotationId || js.is(t.annotationId))
        }
    }(Js || (Js = {})), function (e) {
        e.is = function (e) {
            let t = e;
            return t && (void 0 !== t.changes || void 0 !== t.documentChanges) && (void 0 === t.documentChanges || t.documentChanges.every(e => sa.string(e.kind) ? Hs.is(e) || Gs.is(e) || Js.is(e) : zs.is(e)))
        }
    }(Xs || (Xs = {})), function (e) {
        e.create = function (e) {
            return {uri: e}
        ...
        e.create = function (e, t) {
            ...
            let t = e;
            return sa.defined(t) && sa.string(t.uri) && sa.integer(t.version)
        }
    }(Zs || (Zs = {})), function (e) {
        e.create = function (e, t) {
            return {uri: e, version: t}
            ...
            let t = e;
            return sa.defined(t) && sa.string(t.uri) && (null === t.version || sa.integer(t.version))
        }
    }(Ys || (Ys = {})), function (e) {
        e.create = function (e, t, n, r) {
            ...
            let t = e;
            return sa.defined(t) && sa.string(t.uri) && sa.string(t.languageId) && sa.integer(t.version) && sa.string(t.text)
        }
    }(eo || (eo = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return sa.objectLiteral(e) && to.is(t.kind) && sa.string(t.value)
        }
    }(no || (no = {})), function (e) {
        ...
        e.create = function (e, t, n) {
            ...
            const t = e;
            return t && sa.string(t.newText) && As.is(t.insert) && As.is(t.replace)
        }
    }(oo || (oo = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return t && (sa.string(t.detail) || void 0 === t.detail) && (sa.string(t.description) || void 0 === t.description)
        }
    }(lo || (lo = {})), function (e) {
        e.create = function (e) {
            return {label: e}
        ...
        e.fromPlainText = function (e) {
            ...
            const t = e;
            return sa.string(t) || sa.objectLiteral(t) && sa.string(t.language) && sa.string(t.value)
        }
    }(ho || (ho = {})), function (e) {
        e.is = function (e) {
            let t = e;
            return !!t && sa.objectLiteral(t) && (no.is(t.contents) || ho.is(t.contents) || sa.typedArray(t.contents, ho.is)) && (void 0 === e.range || As.is(e.range))
        }
    }(fo || (fo = {})), function (e) {
        e.create = function (e, t) {
        ...
        e.create = function (e, t, ...n) {
            let r = {label: e};
            return sa.defined(t) && (r.documentation = t), sa.defined(n) ? r.parameters = n : r.parameters = [], r
        }
    }(go || (go = {})), function (e) {
        ...
        e.create = function (e, t, n, r) {
            return void 0 !== r ? {name: e, kind: t, location: {uri: n, range: r}} : {
                name: e,
                kind: t,
                location: {uri: n}
            }
        ...
        e.create = function (e, t, n, r, i, s) {
            ...
            let t = e;
            return t && sa.string(t.name) && sa.number(t.kind) && As.is(t.range) && As.is(t.selectionRange) && (void 0 === t.detail || sa.string(t.detail)) && (void 0 === t.deprecated || sa.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children)) && (void 0 === t.tags || Array.isArray(t.tags))
        }
    }(_o || (_o = {})), function (e) {
        ...
        e.create = function (e, t, n) {
            ...
            let t = e;
            return sa.defined(t) && sa.typedArray(t.diagnostics, Ks.is) && (void 0 === t.only || sa.typedArray(t.only, sa.string)) && (void 0 === t.triggerKind || t.triggerKind === So.Invoked || t.triggerKind === So.Automatic)
        }
    }(No || (No = {})), function (e) {
        e.create = function (e, t, n) {
            let r = {title: e}, i = !0;
            return "string" == typeof t ? (i = !1, r.kind = t) : $s.is(t) ? r.command = t : r.edit = t, i && void 0 !== n && (r.kind = n), r
        }, e.is = function (e) {
            let t = e;
            return t && sa.string(t.title) && (void 0 === t.diagnostics || sa.typedArray(t.diagnostics, Ks.is)) && (void 0 === t.kind || sa.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || $s.is(t.command)) && (void 0 === t.isPreferred || sa.boolean(t.isPreferred)) && (void 0 === t.edit || Xs.is(t.edit))
        }
    }(xo || (xo = {})), function (e) {
        e.create = function (e, t) {
            let n = {range: e};
            ...
            let t = e;
            return sa.defined(t) && As.is(t.range) && (sa.undefined(t.command) || $s.is(t.command))
        }
    }(Eo || (Eo = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return sa.defined(t) && sa.uinteger(t.tabSize) && sa.boolean(t.insertSpaces)
        }
    }(Ao || (Ao = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            let t = e;
            return sa.defined(t) && As.is(t.range) && (sa.undefined(t.target) || sa.string(t.target))
        }
    }(ko || (ko = {})), function (e) {
        e.create = function (e, t) {
            ...
            let n = t;
            return sa.objectLiteral(n) && As.is(n.range) && (void 0 === n.parent || e.is(n.parent))
        }
    }(Ro || (Ro = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return sa.objectLiteral(t) && (void 0 === t.resultId || "string" == typeof t.resultId) && Array.isArray(t.data) && (0 === t.data.length || "number" == typeof t.data[0])
        }
    }(Oo || (Oo = {})), function (e) {
        e.create = function (e, t) {
        ...
        e.create = function (e, t, n) {
            ...
            const t = e;
            return null != t && As.is(t.range) && sa.boolean(t.caseSensitiveLookup) && (sa.string(t.variableName) || void 0 === t.variableName)
        }
    }(Po || (Po = {})), function (e) {
        e.create = function (e, t) {
            ...
            const t = e;
            return null != t && As.is(t.range) && (sa.string(t.expression) || void 0 === t.expression)
        }
    }(Fo || (Fo = {})), function (e) {
        e.create = function (e, t) {
        ...
        e.create = function (e) {
            ...
            const t = e;
            return sa.objectLiteral(t) && (void 0 === t.tooltip || sa.string(t.tooltip) || no.is(t.tooltip)) && (void 0 === t.location || ks.is(t.location)) && (void 0 === t.command || $s.is(t.command))
        }
    }(qo || (qo = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            const t = e;
            return sa.objectLiteral(t) && Es.is(t.position) && (sa.string(t.label) || sa.typedArray(t.label, qo.is)) && (void 0 === t.kind || Do.is(t.kind)) && void 0 === t.textEdits || sa.typedArray(t.textEdits, Bs.is) && (void 0 === t.tooltip || sa.string(t.tooltip) || no.is(t.tooltip)) && (void 0 === t.paddingLeft || sa.boolean(t.paddingLeft)) && (void 0 === t.paddingRight || sa.boolean(t.paddingRight))
        }
    }(Ko || (Ko = {})), function (e) {
        ...
        e.create = function (e, t, n, r) {
            ...
            let t = e;
            return !!(sa.defined(t) && sa.string(t.uri) && (sa.undefined(t.languageId) || sa.string(t.languageId)) && sa.uinteger(t.lineCount) && sa.func(t.getText) && sa.func(t.positionAt) && sa.func(t.offsetAt))
    ...
    class ca {
        ...
        update(e, t) {
            for (let n of e) if (ca.isIncremental(n)) {
                const e = fa(n.range), t = this.offsetAt(e.start), r = this.offsetAt(e.end);
                ...
                if (s - i === a.length) for (let n = 0, u = a.length; n < u; n++) o[n + i + 1] = a[n]; else a.length < 1e4 ? o.splice(i + 1, s - i, ...a) : this._lineOffsets = o = o.slice(0, i + 1).concat(a, o.slice(s + 1));
                const l = n.text.length - (r - t);
                if (0 !== l) for (let n = i + 1 + a.length, u = o.length; n < u; n++) o[n] = o[n] + l
            } else {
                if (!ca.isFull(n)) throw new Error("Unknown change event received");
        ...
        getLineOffsets() {
            return void 0 === this._lineOffsets && (this._lineOffsets = da(this._content, !0)), this._lineOffsets
        }
    ...
    function ga(...e) {
        const t = e[0];
        let n, r, i;
        if ("string" == typeof t) n = t, r = t, e.splice(0, 1), i = e && "object" == typeof e[0] ? e[0] : e; else {
    ...
    !function (e) {
        e.create = function (e, t, n, r) {
            ...
            let n = e.getText(), r = ha(t.map(ma), (e, t) => {
                let n = e.range.start.line - t.range.start.line;
                return 0 === n ? e.range.start.character - t.range.start.character : n
            }), i = 0;
            const s = [];
    ...
    const ba = {
        "color-hex": {
            errorMessage: ga("Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA."),
    ...
    class Ra {
        ...
        include(e) {
            return (-1 === this.focusOffset || Pa(e, this.focusOffset)) && e !== this.exclude
        }
    ...
    class Ma {
        ...
        mergeEnumValues(e) {
            if (!this.enumValueMatch && !e.enumValueMatch && this.enumValues && e.enumValues) {
                ...
                for (const e of this.problems) e.code === aa.EnumValueMismatch && (e.message = ga("Value is not accepted. Valid values: {0}.", this.enumValues.map(e => JSON.stringify(e)).join(", ")))
            }
        }
    ...
    class Fa {
        ...
        validate(e, t, n = Vs.Warning, r) {
            if (this.root && t) {
                const i = new Ma;
                return Da(this.root, t, i, Ta.instance, new ka(r ?? Va(t))), i.problems.map(t => {
                    const r = As.create(e.positionAt(t.location.offset), e.positionAt(t.location.offset + t.location.length));
        ...
        getMatchingSchemas(e, t = -1, n) {
            if (this.root && e) {
                const r = new Ra(t, n), i = Va(e), s = new ka(i);
    ...
    function Da(e, t, n, r, i) {
        ...
        switch (function () {
            ...
            Array.isArray(t.type) ? t.type.some(e) || n.problems.push({
                ...
                message: t.errorMessage || ga("Incorrect type. Expected one of {0}.", t.type.join(", "))
            }) : t.type && (e(t.type) || n.problems.push({
                location: {offset: s.offset, length: s.length},
                message: t.errorMessage || ga('Incorrect type. Expected "{0}".', t.type)
            }));
            if (Array.isArray(t.allOf)) for (const h of t.allOf) {
                const e = new Ma, t = r.newSub();
                Da(s, xa(h), e, t, i), n.merge(e), r.merge(t)
            }
            const o = xa(t.not);
            if (o) {
                const e = new Ma, a = r.newSub();
                Da(s, o, e, a, i), e.hasProblems() || n.problems.push({
                    location: {offset: s.offset, length: s.length},
                    message: t.errorMessage || ga("Matches a schema that is not allowed.")
                });
            ...
            const a = (e, t) => {
                ...
                let a;
                for (const n of e) {
                    const e = xa(n), l = new Ma, u = r.newSub();
                    if (Da(s, e, l, u, i), l.hasProblems() || o.push(e), a) if (t || l.hasProblems() || a.validationResult.hasProblems()) {
                    ...
                    } else a.matchingSchemas.merge(u), a.validationResult.propertiesMatches += l.propertiesMatches, a.validationResult.propertiesValueMatches += l.propertiesValueMatches, a.validationResult.mergeProcessedProperties(l); else a = {
                        schema: e,
                        validationResult: l,
                        matchingSchemas: u
                    }
                ...
                return o.length > 1 && t && n.problems.push({
                    ...
                    message: ga("Matches multiple schemas when only one must validate.")
            ...
            const l = e => {
                const t = new Ma, o = r.newSub();
                Da(s, xa(e), t, o, i), n.merge(t), r.merge(o)
            }, u = xa(t.if);
            u && ((e, t, o) => {
                const a = xa(e), u = new Ma, c = r.newSub();
                Da(s, a, u, c, i), r.merge(c), n.mergeProcessedProperties(u), u.hasProblems() ? o && l(o) : t && l(t)
            })(u, xa(t.then), xa(t.else));
            if (Array.isArray(t.enum)) {
                const e = Oa(s);
                let r = !1;
                for (const n of t.enum) if (Jo(e, n)) {
                    r = !0;
                    break
                }
                n.enumValues = t.enum, n.enumValueMatch = r, r || n.problems.push({
                    ...
                    message: t.errorMessage || ga("Value is not accepted. Valid values: {0}.", t.enum.map(e => JSON.stringify(e)).join(", "))
                })
            }
            if (Qo(t.const)) {
                Jo(Oa(s), t.const) ? n.enumValueMatch = !0 : (n.problems.push({
                    location: {
                        offset: s.offset,
                        length: s.length
                    },
                    code: aa.EnumValueMismatch,
                    message: t.errorMessage || ga("Value must be {0}.", JSON.stringify(t.const))
            ...
            case"object":
                !function (e) {
                    const s = Object.create(null), o = new Set;
                    for (const t of e.properties) {
                        const e = t.keyNode.value;
                        s[e] = t.valueNode, o.add(e)
                    }
                    if (Array.isArray(t.required)) for (const r of t.required) if (!s[r]) {
                        const t = e.parent && "property" === e.parent.type && e.parent.keyNode,
                            i = t ? {offset: t.offset, length: t.length} : {offset: e.offset, length: 1};
                        n.problems.push({location: i, message: ga('Missing property "{0}".', r)})
                    }
                    const a = e => {
                    ...
                    if (t.properties) for (const d of Object.keys(t.properties)) {
                        ...
                        if (o) if (Zo(e)) if (e) n.propertiesMatches++, n.propertiesValueMatches++; else {
                            const e = o.parent;
                            n.problems.push({
                                location: {offset: e.keyNode.offset, length: e.keyNode.length},
                                message: t.errorMessage || ga("Property {0} is not allowed.", d)
                            })
                        } else {
                            const t = new Ma;
                            Da(o, e, t, r, i), n.mergePropertyMatch(t)
                        }
                    }
                        ...
                        if (e) {
                            ...
                            for (const a of o) if (e.test(a)) {
                                ...
                                if (e) {
                                    ...
                                    if (Zo(s)) if (s) n.propertiesMatches++, n.propertiesValueMatches++; else {
                                        const r = e.parent;
                                        n.problems.push({
                                            location: {offset: r.keyNode.offset, length: r.keyNode.length},
                                            message: t.errorMessage || ga("Property {0} is not allowed.", a)
                                        })
                                    } else {
                                        const t = new Ma;
                                        Da(e, s, t, r, i), n.mergePropertyMatch(t)
                                    }
                                }
                            }
                            l.forEach(a)
                    ...
                    if (void 0 !== l) for (const d of o) {
                        ...
                        if (e) if (!1 === l) {
                            ...
                            const t = new Ma;
                            Da(e, l, t, r, i), n.mergePropertyMatch(t)
                        }
                    }
                    ...
                    if (void 0 !== u) {
                        ...
                        for (const a of o) if (!n.processedProperties.has(a)) {
                            ...
                            if (o) if (!1 === u) {
                                ...
                                const e = new Ma;
                                Da(o, u, e, r, i), n.mergePropertyMatch(e)
                            }
                        }
                        e.forEach(a)
                    }
                    Xo(t.maxProperties) && e.properties.length > t.maxProperties && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("Object has more properties than limit of {0}.", t.maxProperties)
                    });
                    Xo(t.minProperties) && e.properties.length < t.minProperties && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("Object has fewer properties than the required number of {0}", t.minProperties)
                    });
                    ...
                    if (t.dependencies) for (const n in t.dependencies) {
                    ...
                    function h(t, o) {
                        if (Array.isArray(o)) for (const r of o) s[r] ? n.propertiesValueMatches++ : n.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            }, message: ga("Object is missing property {0} required by property {1}.", r, t)
                        }); else {
                            const t = xa(o);
                            if (t) {
                                const s = new Ma;
            ...
            case"array":
                !function (e) {
                    let s, o;
                    i.schemaDraft >= la.v2020_12 ? (s = t.prefixItems, o = Array.isArray(t.items) ? void 0 : t.items) : (s = Array.isArray(t.items) ? t.items : void 0, o = Array.isArray(t.items) ? t.additionalItems : t.items);
                    let a = 0;
                    if (void 0 !== s) {
                        const c = Math.min(s.length, e.items.length);
                        for (; a < c; a++) {
                            const h = xa(s[a]), d = new Ma, f = e.items[a];
                            f && (Da(f, h, d, r, i), n.mergePropertyMatch(d)), n.processedProperties.add(String(a))
                        }
                    }
                    if (void 0 !== o && a < e.items.length) if ("boolean" == typeof o) for (!1 === o && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("Array has too many items according to schema. Expected {0} or fewer.", a)
                    }); a < e.items.length; a++) n.processedProperties.add(String(a)), n.propertiesValueMatches++; else for (; a < e.items.length; a++) {
                        const m = new Ma;
                        Da(e.items[a], o, m, r, i), n.mergePropertyMatch(m), n.processedProperties.add(String(a))
                    }
                    const l = xa(t.contains);
                    if (l) {
                        let g = 0;
                        for (let p = 0; p < e.items.length; p++) {
                            const b = e.items[p], y = new Ma;
                            Da(b, l, y, Ta.instance, i), y.hasProblems() || (g++, i.schemaDraft >= la.v2020_12 && n.processedProperties.add(String(p)))
                        }
                        0 !== g || Xo(t.minContains) || n.problems.push({
                            location: {offset: e.offset, length: e.length},
                            message: t.errorMessage || ga("Array does not contain required item.")
                        }), Xo(t.minContains) && g < t.minContains && n.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            message: t.errorMessage || ga("Array has too few items that match the contains contraint. Expected {0} or more.", t.minContains)
                        }), Xo(t.maxContains) && g > t.maxContains && n.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            message: t.errorMessage || ga("Array has too many items that match the contains contraint. Expected {0} or less.", t.maxContains)
                        })
                    }
                    const u = t.unevaluatedItems;
                    if (void 0 !== u) for (let v = 0; v < e.items.length; v++) {
                        if (!n.processedProperties.has(String(v))) if (!1 === u) n.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            }, message: ga("Item does not match any validation rule from the array.")
                        }); else {
                            const w = new Ma;
                            Da(e.items[v], t.unevaluatedItems, w, r, i), n.mergePropertyMatch(w)
                        }
                        n.processedProperties.add(String(v)), n.propertiesValueMatches++
                    }
                    Xo(t.minItems) && e.items.length < t.minItems && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("Array has too few items. Expected {0} or more.", t.minItems)
                    });
                    Xo(t.maxItems) && e.items.length > t.maxItems && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("Array has too many items. Expected {0} or fewer.", t.maxItems)
                    });
                    if (!0 === t.uniqueItems) {
                        const C = Oa(e);
                        ...
                        function _() {
                            for (let e = 0; e < C.length - 1; e++) {
                                const t = C[e];
                                for (let n = e + 1; n < C.length; n++) if (Jo(t, C[n])) return !0
                            }
                            return !1
                        }
            ...
            case"string":
                !function (e) {
                    Xo(t.minLength) && ra(e.value) < t.minLength && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("String is shorter than the minimum length of {0}.", t.minLength)
                    });
                    Xo(t.maxLength) && ra(e.value) > t.maxLength && n.problems.push({
                        location: {
                            offset: e.offset,
                            length: e.length
                        }, message: ga("String is longer than the maximum length of {0}.", t.maxLength)
                    });
                    if (Yo(t.pattern)) {
                        const r = na(t.pattern);
                        r?.test(e.value) || n.problems.push({
                            location: {offset: e.offset, length: e.length},
                            message: t.patternErrorMessage || t.errorMessage || ga('String does not match the pattern of "{0}".', t.pattern)
                        })
                    }
                    if (t.format) switch (t.format) {
                        ...
                        case"uri-reference": {
                            ...
                            if (e.value) {
                                ...
                                n ? n[2] || "uri" !== t.format || (r = ga("URI with a scheme is expected.")) : r = ga("URI is expected.")
                            } else r = ga("URI expected.");
                            r && n.problems.push({
                                location: {offset: e.offset, length: e.length},
                                message: t.patternErrorMessage || t.errorMessage || ga("String is not a URI: {0}", r)
                            })
                        }
                            break;
                        case"color-hex":
            ...
            case"number":
                !function (e) {
                    ...
                    if (Xo(t.multipleOf)) {
                        let s = -1;
                        if (Number.isInteger(t.multipleOf)) s = r % t.multipleOf; else {
                        ...
                        0 !== s && n.problems.push({
                            location: {offset: e.offset, length: e.length},
                            message: ga("Value is not divisible by {0}.", t.multipleOf)
                        })
                    }
                    ...
                    Xo(a) && r <= a && n.problems.push({
                        location: {offset: e.offset, length: e.length},
                        message: ga("Value is below the exclusive minimum of {0}.", a)
                    });
                    const l = s(t.maximum, t.exclusiveMaximum);
                    Xo(l) && r >= l && n.problems.push({
                        location: {offset: e.offset, length: e.length},
                        message: ga("Value is above the exclusive maximum of {0}.", l)
                    });
                    const u = o(t.minimum, t.exclusiveMinimum);
                    Xo(u) && r < u && n.problems.push({
                        location: {offset: e.offset, length: e.length},
                        message: ga("Value is below the minimum of {0}.", u)
                    });
                    const c = o(t.maximum, t.exclusiveMaximum);
                    Xo(c) && r > c && n.problems.push({
                        location: {offset: e.offset, length: e.length},
                        message: ga("Value is above the maximum of {0}.", c)
                    })
                }(s)
        }
    ...
    function qa(e, t) {
        const n = [];
        let r = -1;
        const i = e.getText(), s = gs(i, !1), o = t && t.collectComments ? [] : void 0;
        ...
        function a() {
            for (; ;) {
                ...
                switch (c(), t) {
                    case 12:
                    case 13:
                        Array.isArray(o) && o.push(As.create(e.positionAt(s.getTokenOffset()), e.positionAt(s.getTokenOffset() + s.getTokenLength())));
                        break;
                    case 15:
                    case 14:
                        break;
        ...
        function c() {
            switch (s.getTokenError()) {
                case 4:
                    return u(ga("Invalid unicode sequence in string."), aa.InvalidUnicode), !0;
                case 5:
                    return u(ga("Invalid escape character in string."), aa.InvalidEscapeCharacter), !0;
                case 3:
                    return u(ga("Unexpected end of number."), aa.UnexpectedEndOfNumber), !0;
                case 1:
                    return u(ga("Unexpected end of comment."), aa.UnexpectedEndOfComment), !0;
                case 2:
                    return u(ga("Unexpected end of string."), aa.UnexpectedEndOfString), !0;
                case 6:
                    return u(ga("Invalid characters in string. Control characters must be escaped."), aa.InvalidCharacter), !0
            }
            return !1
        }
        ...
        function f(t, n) {
            ...
            if (!i) {
                ...
                {
                    u(ga("Property keys must be doublequoted"), aa.PropertyKeysMustBeDoublequoted);
            ...
            if (r.keyNode = i, "//" !== i.value) {
                const e = n[i.value];
                e ? (l(ga("Duplicate object key"), aa.DuplicateKey, r.keyNode.offset, r.keyNode.offset + r.keyNode.length, Vs.Warning), ea(e) && l(ga("Duplicate object key"), aa.DuplicateKey, e.keyNode.offset, e.keyNode.offset + e.keyNode.length, Vs.Warning), n[i.value] = !0) : n[i.value] = r
            }
            if (6 === s.getToken()) r.colonOffset = s.getTokenOffset(), a(); else if (u(ga("Colon expected"), aa.ColonExpected), 10 === s.getToken() && e.positionAt(i.offset + i.length).line < e.positionAt(s.getTokenOffset()).line) return r.length = i.length, r;
            const o = g(r);
            return o ? (r.valueNode = o, r.length = o.offset + o.length - r.offset, r) : u(ga("Value expected"), aa.ValueExpected, r, [], [2, 5])
        }
            ...
            return function (e) {
                ...
                for (; 4 !== s.getToken() && 17 !== s.getToken();) {
                    if (5 === s.getToken()) {
                        ...
                        if (a(), 4 === s.getToken()) {
                            n && l(ga("Trailing comma"), aa.TrailingComma, e, e + 1);
                            continue
                        }
                    } else n && u(ga("Expected comma"), aa.CommaExpected);
                    const e = g(t);
                    e ? t.items.push(e) : u(ga("Value expected"), aa.ValueExpected, void 0, [], [4, 5]), n = !0
                }
                return 4 !== s.getToken() ? u(ga("Expected comma or closing bracket"), aa.CommaOrCloseBacketExpected, t) : h(t, !0)
            }(e) || function (e) {
                if (1 !== s.getToken()) return;
                const t = new Na(e, s.getTokenOffset()), n = Object.create(null);
                a();
                let r = !1;
                for (; 2 !== s.getToken() && 17 !== s.getToken();) {
                    if (5 === s.getToken()) {
                        r || u(ga("Property expected"), aa.PropertyExpected);
                        const e = s.getTokenOffset();
                        if (a(), 2 === s.getToken()) {
                            r && l(ga("Trailing comma"), aa.TrailingComma, e, e + 1);
                            continue
                        }
                    } else r && u(ga("Expected comma"), aa.CommaExpected);
                    const e = f(t, n);
                    e ? t.properties.push(e) : u(ga("Property expected"), aa.PropertyExpected, void 0, [], [2, 5]), r = !0
                }
                return 2 !== s.getToken() ? u(ga("Expected comma or closing brace"), aa.CommaOrCloseBraceExpected, t) : h(t, !0)
            }(e) || m(e) || function (e) {
                ...
                if (0 === s.getTokenError()) {
                    ...
                    try {
                        ...
                        if (!Xo(n)) return u(ga("Invalid number format."), aa.Undefined, t);
                        t.value = n
                    } catch (Pl) {
                        return u(ga("Invalid number format."), aa.Undefined, t)
                    }
        ...
        let p;
        return 17 !== a() && (p = g(p), p ? 17 !== s.getToken() && u(ga("End of file expected."), aa.Undefined) : u(ga("Expected a JSON object, array or literal."), aa.Undefined)), new Fa(p, n, o)
    }
    ...
    function Ka(e, t, n) {
        if (null !== e && "object" == typeof e) {
            ...
            if (Array.isArray(e)) {
                if (0 === e.length) return "[]";
                let i = "[\n";
                for (let t = 0; t < e.length; t++) i += r + Ka(e[t], r, n), t < e.length - 1 && (i += ","), i += "\n";
                return i += t + "]", i
            }
            {
                ...
                for (let t = 0; t < i.length; t++) {
                    const o = i[t];
                    s += r + JSON.stringify(o) + ": " + Ka(e[o], r, n), t < i.length - 1 && (s += ","), s += "\n"
                }
                return s += t + "}", s
            }
        }
    ...
    class $a {
        ...
        doComplete(e, t, n) {
            const r = {items: [], isIncomplete: !1}, i = e.getText(), s = e.offsetAt(t);
            ...
            if (!o || "string" !== o.type && "number" !== o.type && "boolean" !== o.type && "null" !== o.type) {
                let n = s - a.length;
                n > 0 && '"' === i[n - 1] && n--, l = As.create(e.positionAt(n), t)
            } else l = As.create(e.positionAt(o.offset), e.positionAt(o.offset + o.length));
            const u = new Map, c = {
                add: e => {
                    let t = e.label;
                    const n = u.get(t);
                    if (n) n.documentation || (n.documentation = e.documentation), n.detail || (n.detail = e.detail), n.labelDetails || (n.labelDetails = e.labelDetails); else {
                        if (t = t.replace(/[\n]/g, "↵"), t.length > 60) {
                            const e = t.substr(0, 57).trim() + "...";
                            u.has(e) || (t = e)
                        }
                        e.textEdit = Bs.replace(l, e.insertText), e.label = t, u.set(t, e), r.items.push(e)
                    }
                }, setAsIncomplete: () => {
                    r.isIncomplete = !0
                }, error: e => {
            ...
            return this.schemaService.getSchemaForResource(e.uri, n).then(t => {
                ...
                if (o && "object" === o.type) {
                    ...
                    o.properties.forEach(e => {
                        d && d === e || u.set(e.keyNode.value, uo.create("__"))
                    });
                    let g = "";
                ...
                if (e.node === n && !e.inverted) {
                    ...
                    t && Object.keys(t).forEach(e => {
                        ...
                        if ("object" == typeof n && !n.deprecationMessage && !n.doNotSuggest) {
                            ...
                            void 0 !== n.suggestSortText && (t.sortText = n.suggestSortText), t.insertText && ta(t.insertText, `$1${i}`) && (t.command = {
                                title: "Suggest",
                    ...
                    if ("object" == typeof n && !n.deprecationMessage && !n.doNotSuggest) {
                        const e = (e, t = void 0) => {
                            ...
                            void 0 !== n.suggestSortText && (o.sortText = n.suggestSortText), o.insertText && ta(o.insertText, `$1${i}`) && (o.command = {
                                title: "Suggest",
                                command: "editor.action.triggerSuggest"
                            }), s.add(o)
                        };
        ...
        getSchemaLessValueCompletions(e, t, n, r, i) {
            ...
            const o = this.evaluateSeparatorAfter(r, s), a = e => {
                e.parent && !Pa(e.parent, n, !0) && i.add({
                ...
                if (n && (void 0 !== a || "array" === n.type)) {
                    ...
                    for (const e of h) if (e.node === n && !e.inverted && e.schema) {
                        if ("array" === n.type && e.schema.items) {
                            ...
                            if (e.schema.uniqueItems) {
                                ...
                                n.children.forEach(t => {
                                    "array" !== t.type && "object" !== t.type && e.add(this.getLabelForValue(Oa(t)))
                                }), t = {
                                    ...s, add(t) {
                        ...
                        if (void 0 !== a) {
                            ...
                            if (e.schema.patternProperties && !t) for (const n of Object.keys(e.schema.patternProperties)) {
                                const r = na(n);
                                if (r?.test(a)) {
                                    t = !0;
        ...
        addDefaultValueCompletions(e, t, n, r = 0) {
            ...
            if (Qo(e.default)) {
                ...
                this.doesSupportsLabelDetails() ? a.labelDetails = {description: ga("Default value")} : a.detail = ga("Default value"), n.add(a), i = !0
            }
        ...
        getInsertTextForSnippetValue(e, t) {
            return Ka(e, "", e => "string" == typeof e && "^" === e[0] ? e.substr(1) : JSON.stringify(e)) + t
        }
        ...
        findItemAtOffset(e, t, n) {
            const r = gs(t.getText(), !0), i = e.items;
            for (let s = i.length - 1; s >= 0; s--) {
                const e = i[s];
                if (n > e.offset + e.length) {
                    r.setPosition(e.offset + e.length);
                    return 5 === r.scan() && n >= r.getTokenOffset() + r.getTokenLength() ? s + 1 : s
                }
        ...
        fromMarkup(e) {
            if (e && this.doesSupportMarkdown()) return {kind: to.Markdown, value: e}
        }

        doesSupportMarkdown() {
            if (!Qo(this.supportsMarkdown)) {
                const e = this.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;
                this.supportsMarkdown = Array.isArray(e) && -1 !== e.indexOf(to.Markdown)
            }
            return this.supportsMarkdown
        }

        doesSupportsCommitCharacters() {
            return Qo(this.supportsCommitCharacters) || (this.labelDetailsSupport = this.clientCapabilities.textDocument?.completion?.completionItem?.commitCharactersSupport), this.supportsCommitCharacters
        }

        doesSupportsLabelDetails() {
            return Qo(this.labelDetailsSupport) || (this.labelDetailsSupport = this.clientCapabilities.textDocument?.completion?.completionItem?.labelDetailsSupport), this.labelDetailsSupport
        }
    }
    ...
    class Ba {
        ...
        doHover(e, t, n) {
            ...
            const o = As.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)),
                a = e => ({contents: e, range: o}), l = Ia(i);
            ...
            return this.schemaService.getSchemaForResource(e.uri, n).then(e => {
                if (e && i) {
                    ...
                    n.getMatchingSchemas(e.schema, i.offset).every(e => {
                        if (e.node === i && !e.inverted && e.schema && (t = t || e.schema.title, r = r || e.schema.markdownDescription || Ua(e.schema.description), e.schema.enum)) {
                            const t = e.schema.enum.indexOf(Oa(i));
                            e.schema.markdownEnumDescriptions ? s = e.schema.markdownEnumDescriptions[t] : e.schema.enumDescriptions && (s = Ua(e.schema.enumDescriptions[t])), s && (o = e.schema.enum[t], "string" != typeof o && (o = JSON.stringify(o)))
                        }
                        return !0
                    });
                    let l = "";
                    return t && (l = Ua(t)), r && (l.length > 0 && (l += "\n\n"), l += r), s && (l.length > 0 && (l += "\n\n"), l += `\`${function (e) {
    ...
    class ja {
        ...
        configure(e) {
            e && (this.validationEnabled = !1 !== e.validate, this.commentSeverity = e.allowComments ? void 0 : Vs.Error)
        }
        ...
        doValidation(e, t, n, r) {
            ...
            const i = [], s = {}, o = e => {
                ...
                let s = n?.trailingCommas ? Ga(n.trailingCommas) : Vs.Error,
                    ...
                    l = n?.schemaValidation ? Ga(n.schemaValidation) : Vs.Warning,
                        ...
                        if (t.root && u) {
                            ...
                            if (s && "$schema" === s.keyNode.value) {
                                const t = s.valueNode || s,
                                    i = As.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length));
                                o(Ks.create(i, n, u, r))
                            } else {
                                const t = As.create(e.positionAt(i.offset), e.positionAt(i.offset + 1));
                                o(Ks.create(t, n, u, r))
                            }
                        }
                    };
                    if (r.errors.length) i(r.errors[0], aa.SchemaResolveError); else if (l) {
                        for (const e of r.warnings) i(e, aa.SchemaUnsupportedFeature);
                        const s = t.validate(e, r.schema, l, n?.schemaDraft);
                        s && s.forEach(o)
                    }
                    za(r.schema) && (a = void 0), Ha(r.schema) && (s = void 0)
                }
    ...
    class Qa {
        ...
        findDocumentSymbols(e, t, n = {resultLimit: Number.MAX_VALUE}) {
            ...
            const s = e.uri;
            if (("vscode://defaultsettings/keybindings.json" === s || ta(s.toLowerCase(), "/user/keybindings.json")) && "array" === r.type) {
                const t = [];
                for (const o of r.items) if ("object" === o.type) for (const r of o.properties) if ("key" === r.keyNode.value && r.valueNode) {
            ...
            const u = [], c = (t, n) => {
                "array" === t.type ? t.items.forEach(e => {
                    ...
                    if (r) if (i > 0) {
                        i--;
                        const s = ks.create(e.uri, Za(e, t)), a = n ? n + "." + t.keyNode.value : t.keyNode.value;
                        u.push({
                            name: this.getKeyLabel(t),
                            kind: this.getSymbolKind(r.type),
                            location: s,
                            containerName: n
                        }), o.push({node: r, containerName: a})
                    } else l = !0
                })
            };
            for (; a < o.length;) {
        ...
        findDocumentSymbols2(e, t, n = {resultLimit: Number.MAX_VALUE}) {
            ...
            if (("vscode://defaultsettings/keybindings.json" === s || ta(s.toLowerCase(), "/user/keybindings.json")) && "array" === r.type) {
                const t = [];
                for (const o of r.items) if ("object" === o.type) for (const r of o.properties) if ("key" === r.keyNode.value && r.valueNode) {
                    const a = Za(e, o), l = Za(e, r.keyNode);
                    if (t.push({
                        name: Ya(r.valueNode),
                        kind: yo.Function,
                        range: a,
            ...
            const o = [], a = [{node: r, result: o}];
            let l = 0, u = !1;
            const c = (t, n) => {
                "array" === t.type ? t.items.forEach((t, r) => {
                    if (t) if (i > 0) {
                        i--;
                        const s = Za(e, t), o = s, l = {
                            name: String(r),
                        ...
                        n.push(l), a.push({result: l.children, node: t})
                    } else u = !0
                }) : "object" === t.type && t.properties.forEach(t => {
                    const r = t.valueNode;
                    if (r) if (i > 0) {
                        i--;
                        const s = Za(e, t), o = Za(e, t.keyNode), l = [], u = {
                            name: this.getKeyLabel(t),
                            kind: this.getSymbolKind(r.type),
                            range: s,
                            selectionRange: o,
    ...
    function Za(e, t) {
        return As.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length))
    }
    ...
    const el = {
        ...
        description: ga("A long description of the element. Used in hover menus and suggestions."),
        default: ga("A default value. Used by suggestions."),
        multipleOf: ga("A number that should cleanly divide the current value (i.e. have no remainder)."),
        ...
        pattern: ga("A regular expression to match the string against. It is not implicitly anchored."),
        additionalItems: ga("For arrays, only when items is set as an array. If it is a schema, then this schema validates items after the ones specified by the items array. If it is false, then additional items will cause validation to fail."),
        items: ga("For arrays. Can either be a schema to validate every element against or an array of schemas to validate each item against in order (the first schema will validate the first element, the second schema will validate the second element, and so on."),
        maxItems: ga("The maximum number of items that can be inside an array. Inclusive."),
        minItems: ga("The minimum number of items that can be inside an array. Inclusive."),
        uniqueItems: ga("If all of the items in the array must be unique. Defaults to false."),
        maxProperties: ga("The maximum number of properties an object can have. Inclusive."),
        minProperties: ga("The minimum number of properties an object can have. Inclusive."),
        required: ga("An array of strings that lists the names of all properties required on this object."),
        additionalProperties: ga("Either a schema or a boolean. If a schema, then used to validate all properties not matched by 'properties' or 'patternProperties'. If false, then any properties not matched by either will cause this schema to fail."),
        definitions: ga("Not used for validation. Place subschemas here that you wish to reference inline with $ref."),
        properties: ga("A map of property names to schemas for each property."),
        patternProperties: ga("A map of regular expressions on property names to schemas for matching properties."),
        dependencies: ga("A map of property names to either an array of property names or a schema. An array of property names means the property named in the key depends on the properties in the array being present in the object in order to be valid. If the value is a schema, then the schema is only applied to the object if the property in the key exists on the object."),
        enum: ga("The set of literal values that are valid."),
        type: ga("Either a string of one of the basic schema types (number, integer, null, array, object, boolean, string) or an array of strings specifying a subset of those types."),
        ...
        $comment: ga("Comments from schema authors to readers or maintainers of the schema."),
        readOnly: ga("Indicates that the value of the instance is managed exclusively by the owning authority."),
        examples: ga("Sample JSON values associated with a particular schema, for the purpose of illustrating usage."),
        contains: ga('An array instance is valid against "contains" if at least one of its elements is valid against the given schema.'),
        propertyNames: ga("If the instance is an object, this keyword validates if every property name in the instance validates against the provided schema."),
        const: ga("An instance validates successfully against this keyword if its value is equal to the value of the keyword."),
        contentMediaType: ga("Describes the media type of a string property."),
        contentEncoding: ga("Describes the content encoding of a string property."),
        if: ga('The validation outcome of the "if" subschema controls which of the "then" or "else" keywords are evaluated.'),
        then: ga('The "if" subschema is used for validation when the "if" subschema succeeds.'),
        else: ga('The "else" subschema is used for validation when the "if" subschema fails.')
    };
                ...
                var r = {
                    resolve: function () {
                        ...
                        for (var n = -1, r = 0, i = -1, s = !0, o = 0, a = e.length - 1; a >= 0; --a) {
                            ...
                            if (47 !== l) -1 === i && (s = !1, i = a + 1), 46 === l ? -1 === n ? n = a : 1 !== o && (o = 1) : -1 !== n && (o = -1); else if (!s) {
                                r = a + 1;
                                break
                            }
                        }
                        ...
                        s ? (n.root = "/", r = 1) : r = 0;
                        for (var o = -1, a = 0, l = -1, u = !0, c = e.length - 1, h = 0; c >= r; --c) if (47 !== (i = e.charCodeAt(c))) -1 === l && (u = !1, l = c + 1), 46 === i ? -1 === o ? o = c : 1 !== h && (h = 1) : -1 !== o && (h = -1); else if (!u) {
                            a = c + 1;
                            break
                        }
        ...
        (() => {
            ...
            !function (e) {
                e.joinPath = function (e, ...t) {
                    ...
                    n[0] !== L && (n = L + n, r = !0);
                    let i = _.resolve(n, ...t);
                    return r && i[0] === L && !e.authority && (i = i.substring(1)), e.with({path: i})
    ...
    function sl(e, t) {
        ...
        for (let u = 0, c = n.length; u < c; u++) switch (l = n[u], l) {
            ...
            case"*":
                ...
                const a = n[u + 1];
                if (s) {
                    t > 1 && ("/" === e || void 0 === e || "{" === e || "," === e) && ("/" === a || void 0 === a || "," === a || "}" === a) ? ("/" === a ? u++ : "/" === e && r.endsWith("\\/") && (r = r.substr(0, r.length - 2)), r += "((?:[^/]*(?:/|$))*)") : r += "([^/]*)"
                } else r += ".*";
                break;
            default:
                r += l
    ...
    class ol {
        constructor(e, t, n) {
            ...
            try {
                ...
                t && ((t = fl(t)).endsWith("/") || (t += "/"), this.folderUri = t)
            } catch (Pl) {
    ...
    class al {
        constructor(e, t, n) {
            this.service = e, this.uri = t, this.dependencies = new Set, this.anchors = void 0, n && (this.unresolvedSchema = this.service.promise.resolve(new ll(n)))
        }
    ...
    class ul {
        ...
        getSectionRecursive(e, t) {
            ...
            if (t.patternProperties) for (const r of Object.keys(t.patternProperties)) {
                const i = na(r);
                if (i?.test(n)) return this.getSectionRecursive(e, t.patternProperties[r])
            } else {
    ...
    class cl {
        ...
        onResourceChange(e) {
            ...
            let t = !1;
            const n = [e = dl(e)], r = Object.keys(this.schemasById).map(e => this.schemasById[e]);
            for (; n.length;) {
                const e = n.pop();
        ...
        setSchemaContributions(e) {
            ...
            if (Array.isArray(e.schemaAssociations)) {
                ...
                for (let e of t) {
                    const t = e.uris.map(dl), n = this.addFilePatternAssociation(e.pattern, e.folderUri, t);
        ...
        getResolvedSchema(e) {
            const t = dl(e), n = this.schemasById[t];
            return n ? n.getResolvedSchema() : this.promise.resolve(void 0)
        }

        loadSchema(e) {
            if (!this.requestService) {
                const t = ga("Unable to load schema from '{0}'. No schema request service available", ml(e));
            ...
            return e.startsWith("http://json-schema.org/") && (e = "https" + e.substring(4)), this.requestService(e).then(t => {
                if (!t) {
                    const t = ga("Unable to load schema from '{0}': No content.", ml(e));
                    return new ll({}, [t])
                }
                const n = [];
                65279 === t.charCodeAt(0) && (n.push(ga("Problem reading content from '{0}': UTF-8 with BOM detected, only UTF 8 is allowed.", ml(e))), t = t.trimStart());
                let r = {};
                const i = [];
                return r = ys(t, i), i.length && n.push(ga("Unable to parse content from '{0}': Parse error at offset {1}.", ml(e), i[0].offset)), new ll(r, n)
            }, t => {
                let n = t.toString();
                const r = t.toString().split("Error: ");
                return r.length > 1 && (n = r[1]), ta(n, ".") && (n = n.substr(0, n.length - 1)), new ll({}, [ga("Unable to load schema from '{0}': {1}.", ml(e), n)])
            })
        }
        ...
        resolveSchemaContent(e, t) {
            ...
            if ("http://json-schema.org/draft-03/schema" === i) return this.promise.resolve(new ul({}, [ga("Draft-03 schemas are not supported.")], [], i));
            let s = new Set;
            const o = this.contextService, a = (e, t, r, i) => {
                ...
                })(e, s) : n.push(ga("$ref '{0}' in '{1}' can not be resolved.", i || "", r.uri))
            }, l = (e, t, r, i) => {
                o && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(t) && (t = o.resolveRelativePath(t, i.uri)), t = dl(t);
                const s = this.getOrAddSchemaHandle(t);
                return s.getUnresolvedSchema().then(o => {
                    if (i.dependencies.add(t), o.errors.length) {
                        const e = r ? t + "#" + r : t;
                        n.push(ga("Problems loading reference '{0}': {1}", e, o.errors[0]))
                    }
                ...
                const t = new Map;
                return this.traverseNodes(e, e => {
                    const r = e.$id || e.id, i = Yo(r) && "#" === r.charAt(0) ? r.substring(1) : e.$anchor;
                    i && (t.has(i) ? n.push(ga("Duplicate anchor declaration: '{0}'", i)) : t.set(i, e)), e.$recursiveAnchor && s.add("$recursiveAnchor"), e.$dynamicAnchor && s.add("$dynamicAnchor")
                }), t
            };
            return u(r, r, t).then(e => {
                let t = [];
                return s.size && t.push(ga("The schema uses meta-schema features ({0}) that are not yet supported by the validator.", Array.from(s.keys()).join(", "))), new ul(r, n, t, i)
            })
        }
        ...
        traverseNodes(e, t) {
            ...
            const n = new Set, r = (...e) => {
                ...
                for (const t of e) if (ea(t)) for (const e in t) {
                    const n = t[e];
                    ea(n) && a.push(n)
                }
            }, s = (...e) => {
                for (const t of e) if (Array.isArray(t)) for (const e of t) ea(e) && a.push(e)
            }, o = e => {
                if (Array.isArray(e)) for (const t of e) ea(t) && a.push(t); else ea(e) && a.push(e)
            }, a = [e];
            let l = a.pop();
        ...
        getSchemaFromProperty(e, t) {
            if ("object" === t.root?.type) for (const n of t.root.properties) if ("$schema" === n.keyNode.value && "string" === n.valueNode?.type) {
        ...
        getAssociatedSchemas(e) {
            const t = Object.create(null), n = [], r = fl(e);
        ...
        getSchemaForResource(e, t) {
            ...
            const n = this.getAssociatedSchemas(e),
                r = n.length > 0 ? this.createCombinedSchema(e, n).getResolvedSchema() : this.promise.resolve(void 0);
        ...
        getMatchingSchemas(e, t, n) {
            if (n) {
                const e = n.id || "schemaservice://untitled/matchingSchemas/" + hl++;
    ...
    function fl(e) {
        try {
            return rl.parse(e).with({fragment: null, query: null}).toString(!0)
        } catch (Pl) {
            return e
        }
    }
            ...
            switch (a) {
                ...
                case 3: {
                    const t = e.positionAt(o.getTokenOffset()).line,
                        n = {startLine: t, endLine: t, kind: 1 === a ? "object" : "array"};
                    i.push(n);
                    break
                }
                case 2:
                ...
                case 13: {
                    const t = e.positionAt(o.getTokenOffset()).line,
                        n = e.positionAt(o.getTokenOffset() + o.getTokenLength()).line;
                    1 === o.getTokenError() && t + 1 < e.lineCount ? o.setPosition(e.offsetAt(Es.create(t + 1, 0))) : t < n && (l({
                        startLine: t,
                        endLine: n,
                        kind: Is.Comment
                    }), s = t);
                ...
                case 12: {
                    ...
                    if (t) {
                        ...
                        if (t[1]) {
                            const e = {startLine: n, endLine: n, kind: Is.Region};
                            i.push(e)
                        } else {
                            let e = i.length - 1;
    ...
    function bl(e, t, n) {
        ...
        return function (e, t, n) {
            return hs(e, t, n)
        }(e.getText(), r, i).map(t => Bs.replace(As.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length)), t.content))
    }
        ...
        addChildProperty(e) {
            if (e.parent = this, this.childrenProperties.length > 0) {
                ...
                t = e.noKeyName ? this.childrenProperties.length : function (e, t, n) {
                    const r = t.propertyName.toLowerCase(), i = e[0].propertyName.toLowerCase(),
                    ...
                    return -o - 1
                }(this.childrenProperties, e, wl), t < 0 && (t = -1 * t - 1), this.childrenProperties.splice(t, 0, e)
    ...
    function Cl(e, t) {
        const n = {...t, keepLines: !1}, r = oa.applyEdits(e, bl(e, n, void 0)),
            i = oa.create("test://test.json", "json", 0, r), s = function (e, t) {
                if (0 === t.childrenProperties.length) return e;
                const n = oa.create("test://test.json", "json", 0, e.getText()), r = [];
                ...
                for (; r.length > 0;) {
                    ...
                    for (let o = 0; o < i.length; o++) {
                        const t = i[o],
                            a = As.create(Es.create(t.beginningLineNumber, 0), Es.create(t.endLineNumber + 1, 0)),
                            l = e.getText(a), u = oa.create("test://test.json", "json", 0, l);
                        if (!0 === t.lastProperty && o !== i.length - 1) {
                            const e = t.lineWhereToAddComma - t.beginningLineNumber, n = t.indexWhereToAddComa,
                                r = {range: As.create(Es.create(e, n), Es.create(e, n)), text: ","};
                            oa.update(u, [r], 1)
                        } else if (!1 === t.lastProperty && o === i.length - 1) {
                            const e = t.commaIndex, n = t.commaLine - t.beginningLineNumber,
                                r = {range: As.create(Es.create(n, e), Es.create(n, e + 1)), text: ""};
                            oa.update(u, [r], 1)
                        }
                        const c = t.endLineNumber - t.beginningLineNumber + 1,
                            h = {range: As.create(Es.create(s, 0), Es.create(s + c, 0)), text: u.getText()};
                        oa.update(n, [h], 1), _l(r, t, s), s += c
                    }
                }
                return n
            }(i, function (e) {
                const t = e.getText(), n = gs(t, !1);
                let r, i, s, o = new vl, a = o, l = o, u = o, c = 0, h = 0, d = -1, f = -1, m = 0, g = 0, p = [], b = !1,
                    y = !1;
                for (; 17 !== (r = n.scan());) {
                    if (!0 === b && 14 !== r && 15 !== r && 12 !== r && 13 !== r && void 0 === l.endLineNumber) {
                        let e = n.getTokenStartLine();
                        2 === s || 4 === s ? u.endLineNumber = e - 1 : l.endLineNumber = e - 1, m = e, b = !1
                    }
                    if (!0 === y && 14 !== r && 15 !== r && 12 !== r && 13 !== r && (m = n.getTokenStartLine(), y = !1), n.getTokenStartLine() !== c) {
                        for (let t = c; t < n.getTokenStartLine(); t++) {
                            h += e.getText(As.create(Es.create(t, 0), Es.create(t + 1, 0))).length
                        }
                        c = n.getTokenStartLine()
                    }
                    switch (r) {
                        case 10:
                            if (void 0 === i || 1 === i || 5 === i && p[p.length - 1] === yl.Object) {
                                const e = new vl(n.getTokenValue(), m);
                                u = l, l = a.addChildProperty(e)
                            }
                            break;
                        case 3:
                            if (void 0 === o.beginningLineNumber && (o.beginningLineNumber = n.getTokenStartLine()), p[p.length - 1] === yl.Object) a = l; else if (p[p.length - 1] === yl.Array) {
                                const e = new vl(n.getTokenValue(), m);
                                e.noKeyName = !0, u = l, l = a.addChildProperty(e), a = l
                            }
                            p.push(yl.Array), l.type = yl.Array, m = n.getTokenStartLine(), m++;
                            break;
                        case 1:
                            if (void 0 === o.beginningLineNumber) o.beginningLineNumber = n.getTokenStartLine(); else if (p[p.length - 1] === yl.Array) {
                                const e = new vl(n.getTokenValue(), m);
                                e.noKeyName = !0, u = l, l = a.addChildProperty(e)
                            }
                            l.type = yl.Object, p.push(yl.Object), a = l, m = n.getTokenStartLine(), m++;
                            break;
                        case 4:
                            g = n.getTokenStartLine(), p.pop(), void 0 !== l.endLineNumber || 2 !== i && 4 !== i || (l.endLineNumber = g - 1, l.lastProperty = !0, l.lineWhereToAddComma = d, l.indexWhereToAddComa = f, u = l, l = l ? l.parent : void 0, a = l), o.endLineNumber = g, m = g + 1;
                            break;
                        case 2:
                            g = n.getTokenStartLine(), p.pop(), 1 !== i && (void 0 === l.endLineNumber && (l.endLineNumber = g - 1, l.lastProperty = !0, l.lineWhereToAddComma = d, l.indexWhereToAddComa = f), u = l, l = l ? l.parent : void 0, a = l), o.endLineNumber = n.getTokenStartLine(), m = g + 1;
                            break;
                        case 5:
                            g = n.getTokenStartLine(), void 0 !== l.endLineNumber || p[p.length - 1] !== yl.Object && (p[p.length - 1] !== yl.Array || 2 !== i && 4 !== i) || (l.endLineNumber = g, l.commaIndex = n.getTokenOffset() - h, l.commaLine = g), 2 !== i && 4 !== i || (u = l, l = l ? l.parent : void 0, a = l), m = g + 1;
                            break;
                        case 13:
                            5 !== i || d !== n.getTokenStartLine() || (p[p.length - 1] !== yl.Array || 2 !== s && 4 !== s) && p[p.length - 1] !== yl.Object || (p[p.length - 1] !== yl.Array || 2 !== s && 4 !== s) && p[p.length - 1] !== yl.Object || (l.endLineNumber = void 0, b = !0), 1 !== i && 3 !== i || d !== n.getTokenStartLine() || (y = !0)
                    }
                    14 !== r && 13 !== r && 12 !== r && 15 !== r && (s = i, i = r, d = n.getTokenStartLine(), f = n.getTokenOffset() + n.getTokenLength() - h)
                }
                return o
            }(i)), o = bl(s, n, void 0), a = oa.applyEdits(s, o);
        return [Bs.replace(As.create(Es.create(0, 0), e.positionAt(e.getText().length)), a)]
    }

    function _l(e, t, n) {
        if (0 !== t.childrenProperties.length) if (t.type === yl.Object) {
            let r = 1 / 0;
            for (const e of t.childrenProperties) e.beginningLineNumber < r && (r = e.beginningLineNumber);
            n += r - t.beginningLineNumber, e.push(new Sl(n, t.childrenProperties))
    ...
    function Ll(e, t, n) {
        for (const r of t.childrenProperties) {
            if (r.type === yl.Object) {
                ...
                e.push(new Sl(n + r.beginningLineNumber - t.beginningLineNumber + s, r.childrenProperties))
            }
            r.type === yl.Array && Ll(e, r, n + r.beginningLineNumber - t.beginningLineNumber)
        }
    }
    ...
    function Nl(e, t) {
        ...
        return t.visit(r => {
            if ("property" === r.type && "$ref" === r.keyNode.value && "string" === r.valueNode?.type) {
                const i = r.valueNode.value, s = function (e, t) {
                    const n = function (e) {
                        if ("#" === e) return [];
                ...
                if (s) {
                    ...
                    n.push({target: `${e.uri}#${t.line + 1},${t.character + 1}`, range: xl(e, r.valueNode)})
                }
            }
            return !0
        }), Promise.resolve(n)
    ...
    function xl(e, t) {
        return As.create(e.positionAt(t.offset + 1), e.positionAt(t.offset + t.length - 1))
    }
    ...
    function kl(e) {
        const t = e.promiseConstructor || Promise, n = new cl(e.schemaRequestService, e.workspaceContext, t);
        n.setSchemaContributions(el);
        const r = new $a(n, e.contributions, t, e.clientCapabilities), i = new Ba(n, e.contributions, t), s = new Qa(n),
            o = new ja(n, t);
        return {
            configure: e => {
    ...
    let Rl;
    "undefined" != typeof fetch && (Rl = function (e) {
        return fetch(e).then(e => e.text())
    });

    class Tl {
        constructor(e, t) {
            this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = kl({
                workspaceContext: {
                    resolveRelativePath: (e, t) => function (e, t) {
                        if (function (e) {
                            return e.charCodeAt(0) === Ml
                        }(t)) {
                            const n = rl.parse(e), r = t.split("/");
                            return n.with({path: Il(r)}).toString()
                        }
                        return function (e, ...t) {
                            const n = rl.parse(e), r = n.path.split("/");
                            for (let i of t) r.push(...i.split("/"));
                            return n.with({path: Il(r)}).toString()
                        }(e, t)
                    }(t.substr(0, t.lastIndexOf("/") + 1), e)
                }, schemaRequestService: t.enableSchemaRequest ? Rl : void 0, clientCapabilities: ua.LATEST
        ...
        _getTextDocument(e) {
            ...
            for (let n of t) if (n.uri.toString() === e) return oa.create(e, this._languageId, n.version, n.getValue());
            return null
        }
    }

    const Ml = "/".charCodeAt(0), Ol = ".".charCodeAt(0);

    function Il(e) {
        const t = [];
        for (const r of e) 0 === r.length || 1 === r.length && r.charCodeAt(0) === Ol || (2 === r.length && r.charCodeAt(0) === Ol && r.charCodeAt(1) === Ol ? t.pop() : t.push(r));
    ...
    self.onmessage = () => {
        var e;
        e = (e, t) => new Tl(e, t), self.onmessage = t => {
            ns(n => e(n, t.data))
        }
    }
}();
