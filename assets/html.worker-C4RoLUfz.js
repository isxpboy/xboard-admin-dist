!function () {
    ...
    class a extends Error {
        constructor(e) {
            super(e || "An unexpected bug occurred."), Object.setPrototypeOf(this, a.prototype)
        }
    }
    ...
    !function (e) {
        ...
        e.fromObservable = function (e, t) {
            ...
            return (t, n, i) => {
                ...
                return i instanceof g ? i.add(s) : Array.isArray(i) && i.push(s), s
            }
        }
    }(y || (y = {}));
    ...
    class k {
        ...
        constructor(e, t, n = (k._idPool++).toString(16).padStart(3, "0")) {
        ...
        check(e, t) {
            ...
            if (this._stacks.set(e.value, i + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
                ...
                const [e, i] = this.getMostFrequentStack(),
                    r = `[${this.name}] potential listener LEAK detected, having ${t} listeners already. MOST frequent listener (${i}):`,
                    o = new L(r, e);
    ...
    class E {
        constructor(e) {
            this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new k(e?.onListenerError ?? t, this._options?.leakWarningThreshold ?? -1) : void 0, this._perfMon = this._options?._profName ? new T(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
        }
            ...
            return this._event ??= (e, n, i) => {
                if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                    const e = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`,
                        n = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
                        i = new x(`${e}. HINT: Stack shows most frequent listener (${n[1]}-times)`, n[0]);
                    return (this._options?.onListenerError || t)(i), f.None
                }
                if (this._disposed) return f.None;
                n && (e = e.bind(n));
                const r = new C(e);
                let o;
                this._leakageMon && this._size >= Math.ceil(.2 * this._leakageMon.threshold) && (r.stack = S.create(), o = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof C ? (this._deliveryQueue ??= new A, this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
                const a = p(() => {
                    o?.(), this._removeListener(r)
                });
                return i instanceof g ? i.add(a) : Array.isArray(i) && i.push(a), a
            }, this._event
        }
        ...
        fire(e) {
            if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof C) this._deliver(this._listeners, e); else {
    ...
    const M = "pseudo" === R() || "undefined" != typeof document && document.location && "string" == typeof document.location.hash && document.location.hash.indexOf("pseudo=true") >= 0;
    ...
    function N(e, t) {
        ...
        return n = 0 === t.length ? e : e.replace(/\{(\d+)\}/g, (e, n) => {
            const i = n[0], r = t[i];
            let o = e;
            return "string" == typeof r ? o = r : "number" != typeof r && "boolean" != typeof r && null != r || (o = String(r)), o
        }), M && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n
    }

    function I(e, t, ...n) {
        return N("number" == typeof e ? function (e, t) {
    ...
    const z = "en";
    let O, H, U, D = !1, W = !1, P = !1, q = z, F = z;
    const V = globalThis;
    let B;
    void 0 !== V.vscode && void 0 !== V.vscode.process ? B = V.vscode.process : "undefined" != typeof process && "string" == typeof process?.versions?.node && (B = process);
    const K = "string" == typeof B?.versions?.electron && "renderer" === B?.type;
    if ("object" == typeof B) {
        D = "win32" === B.platform, W = "darwin" === B.platform, P = "linux" === B.platform, P && B.env.SNAP && B.env.SNAP_REVISION, B.env.CI || B.env.BUILD_ARTIFACTSTAGINGDIRECTORY || B.env.GITHUB_WORKSPACE, O = z, q = z;
        const e = B.env.VSCODE_NLS_CONFIG;
        if (e) try {
            const t = JSON.parse(e);
            O = t.userLocale, F = t.osLocale, q = t.resolvedLanguage || z, H = t.languagePack?.translationsConfigFile
        } catch (gl) {
        }
    } else "object" != typeof navigator || K || (U = navigator.userAgent, D = U.indexOf("Windows") >= 0, W = U.indexOf("Macintosh") >= 0, (U.indexOf("Macintosh") >= 0 || U.indexOf("iPad") >= 0 || U.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, P = U.indexOf("Linux") >= 0, U?.indexOf("Mobi"), q = R() || z, O = navigator.language.toLowerCase(), F = O);
    const j = D, G = W, $ = U, X = "function" == typeof V.postMessage && !V.importScripts;
    (() => {
        if (X) {
            const e = [];
            ...
            return n => {
                const i = ++t;
                e.push({id: i, callback: n}), V.postMessage({vscodeScheduleAsyncWork: i}, "*")
            }
        }
    })();
    const J = !!($ && $.indexOf("Chrome") >= 0);

    function Y(e) {
        return e
    }

    $ && $.indexOf("Firefox"), !J && $ && $.indexOf("Safari"), $ && $.indexOf("Edg/"), $ && $.indexOf("Android");

    class Q {
        constructor(e, t) {
            this.lastCache = void 0, this.lastArgKey = void 0, "function" == typeof e ? (this._fn = e, this._computeKey = Y) : (this._fn = t, this._computeKey = e.getCacheKey)
        }
    ...
    function ie(e, t, n) {
        ...
        if (ne(i) && n + 1 < t) {
            ...
            }(t)) return t - 56320 + (i - 55296 << 10) + 65536
        }
        return i
    }
    ...
    class ae {
        ...
        static {
            this.cache = new Q({getCacheKey: JSON.stringify}, e => {
                ...
                let r, o = e.filter(e => !e.startsWith("_") && Object.hasOwn(i, e));
        ...
        static getInstance(e) {
            return ae.cache.get(Array.from(e))
        }

        static {
            this._locales = new ee(() => Object.keys(ae.ambiguousCharacterData.value).filter(e => !e.startsWith("_")))
        }
    ...
    class se {
        ...
        static getData() {
            return this._data || (this._data = new Set([...Object.values(se.getRawData())].flat())), this._data
        }

        static isInvisibleCharacter(e) {
            return se.getData().has(e)
        }
    ...
    class pe {
        ...
        async sendMessage(e, t, n) {
            ...
            return new Promise((r, o) => {
                this._pendingReplies[i] = {resolve: r, reject: o}, this._send(new ce(this._workerId, i, e, t, n))
            })
        }
        ...
        listen(e, t, n) {
            ...
            const r = new E({
                onWillAddFirstListener: () => {
                    i = String(++this._lastSentReq), this._pendingEmitters.set(i, r), this._send(new de(this._workerId, i, e, t, n))
                }, onDidRemoveLastListener: () => {
                    this._pendingEmitters.delete(i), this._send(new me(this._workerId, i)), i = null
                }
            });
            return r.event
        }
        ...
        createProxyToRemoteChannel(e, t) {
            const n = {get: (n, i) => ("string" != typeof i || n[i] || (fe(i) ? n[i] = t => this.listen(e, i, t) : ge(i) ? n[i] = this.listen(e, i, void 0) : 36 === i.charCodeAt(0) && (n[i] = async (...n) => (await (t?.()), this.sendMessage(e, i, n)))), n[i])};
        ...
        _handleRequestMessage(e) {
            ...
            this._handler.handleMessage(e.channel, e.method, e.args).then(e => {
                this._send(new he(this._workerId, t, e, void 0))
            }, e => {
                e.detail instanceof Error && (e.detail = n(e.detail)), this._send(new he(this._workerId, t, void 0, n(e)))
            })
        }

        _handleSubscribeEventMessage(e) {
            const t = e.req, n = this._handler.handleEvent(e.channel, e.eventName, e.arg)(e => {
                this._send(new ue(this._workerId, t, e))
            });
    ...
    class be {
        constructor(e, t) {
            this._localChannels = new Map, this._remoteChannels = new Map, this._protocol = new pe({
                sendMessage: (t, n) => {
                    e(t, n)
                },
        ...
        _handleMessage(e, t, n) {
            ...
            const i = e === le ? this.requestHandler : this._localChannels.get(e);
            if (!i) return Promise.reject(new Error(`Missing channel ${e} on worker thread`));
            const r = i[t];
            if ("function" != typeof r) return Promise.reject(new Error(`Missing method ${t} on worker thread channel ${e}`));
            try {
    ...
    function ye(e, t) {
        t = ve(149417, t);
        for (let n = 0, i = e.length; n < i; n++) t = ve(e.charCodeAt(n), t);
        return t
    }
    ...
    function ke(e, t, n) {
        return new Ce(new Te(e), new Te(t)).ComputeDiff(n).changes
    }
    ...
    class Ce {
        constructor(e, t, n = null) {
            ...
            const [i, r, o] = Ce._getElements(e), [a, s, l] = Ce._getElements(t);
            this._hasStrings = o && l, this._originalStringElements = i, this._originalElementsOrHash = r, this._modifiedStringElements = a, this._modifiedElementsOrHash = s, this.m_forwardHistory = [], this.m_reverseHistory = []
        }
        ...
        static _getElements(e) {
            ...
            if (Ce._isStringArray(t)) {
                const e = new Int32Array(t.length);
                for (let n = 0, i = t.length; n < i; n++) e[n] = ye(t[n], 0);
                return [t, e, !0]
            }
        ...
        ElementsAreStrictEqual(e, t) {
            ...
            return Ce._getStrictElement(this._originalSequence, e) === Ce._getStrictElement(this._modifiedSequence, t)
        }
        ...
        ComputeDiffRecursive(e, t, n, i, r) {
            ...
            if (e > t || n > i) {
                let r;
                return n <= i ? (Se.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), r = [new we(e, 0, n, i - n + 1)]) : e <= t ? (Se.Assert(n === i + 1, "modifiedStart should only be one more than modifiedEnd"), r = [new we(e, t - e + 1, n, 0)]) : (Se.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), Se.Assert(n === i + 1, "modifiedStart should only be one more than modifiedEnd"), r = []), r
            }
            ...
            if (!r[0]) {
                ...
                let a = [];
                return a = r[0] ? [new we(l + 1, t - (l + 1) + 1, c + 1, i - (c + 1) + 1)] : this.ComputeDiffRecursive(l + 1, t, c + 1, i, r), this.ConcatenateChanges(o, a)
            }
            return [new we(e, t - e + 1, n, i - n + 1)]
        }

        WALKTRACE(e, t, n, i, r, o, a, s, l, c, h, d, u, m, p, g, f, b) {
            let _ = null, w = null, v = new xe, y = t, T = n, k = u[0] - g[0] - i, S = -1073741824,
            ...
            if (_ = v.getReverseChanges(), b[0]) {
                ...
                w = [new we(e, d - e + 1, t, p - t + 1)]
            } else {
                v = new xe, y = o, T = a, k = u[0] - g[0] - s, S = 1073741824, L = f ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                do {
                    const e = k + r;
        ...
        ComputeRecursionPoint(e, t, n, i, r, o, a) {
            ...
            const m = t - e + (i - n), p = m + 1, g = new Int32Array(p), f = new Int32Array(p), b = i - n, _ = t - e,
                w = e - n, v = t - i, y = (_ - b) % 2 == 0;
            g[b] = e, f[_] = t, a[0] = !1;
            for (let T = 1; T <= m / 2 + 1; T++) {
                ...
                const S = (m - e + (k - n) - T) / 2;
                if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(m, S)) return a[0] = !0, r[0] = m, o[0] = k, S > 0 && T <= 1448 ? this.WALKTRACE(b, c, h, w, _, d, u, v, g, f, s, t, r, l, i, o, y, a) : (e++, n++, [new we(e, t - e + 1, n, i - n + 1)]);
                ...
                if (T <= 1447) {
                    ...
                    e[0] = b - c + 1, Le.Copy2(g, c, e, 1, h - c + 1), this.m_forwardHistory.push(e), e = new Int32Array(u - d + 2), e[0] = _ - d + 1, Le.Copy2(f, d, e, 1, u - d + 1), this.m_reverseHistory.push(e)
                }
            }
        ...
        PrettifyChanges(e) {
            for (let t = 0; t < e.length; t++) {
                const n = e[t], i = t < e.length - 1 ? e[t + 1].originalStart : this._originalElementsOrHash.length,
            ...
            if (this._hasStrings) for (let t = 1, n = e.length; t < n; t++) {
                const n = e[t - 1], i = e[t], r = i.originalStart - n.originalStart - n.originalLength,
                    o = n.originalStart, a = i.originalStart + i.originalLength, s = a - o, l = n.modifiedStart,
                    c = i.modifiedStart + i.modifiedLength, h = c - l;
                if (r < 5 && s < 20 && h < 20) {
        ...
        ConcatenateChanges(e, t) {
            ...
            if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                ...
                return Le.Copy(e, 0, i, 0, e.length - 1), i[e.length - 1] = n[0], Le.Copy(t, 1, i, e.length, t.length - 1), i
            }
            {
                const n = new Array(e.length + t.length);
                return Le.Copy(e, 0, n, 0, e.length), Le.Copy(t, 0, n, e.length, t.length), n
            }
        }

        ChangesOverlap(e, t, n) {
            if (Se.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"), Se.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= t.originalStart || e.modifiedStart + e.modifiedLength >= t.modifiedStart) {
                const i = e.originalStart;
                let r = e.originalLength;
                const o = e.modifiedStart;
                let a = e.modifiedLength;
                return e.originalStart + e.originalLength >= t.originalStart && (r = t.originalStart + t.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= t.modifiedStart && (a = t.modifiedStart + t.modifiedLength - e.modifiedStart), n[0] = new we(i, r, o, a), !0
            }
            return n[0] = null, !1
        }
    ...
    let Ee = class e {
        ...
        static getEndPosition(e) {
            return new Ee(e.endLineNumber, e.endColumn)
        }
        ...
        static getStartPosition(e) {
            return new Ee(e.startLineNumber, e.startColumn)
        }
    ...
    class Ne {
        constructor(e) {
            const t = Re(e);
            this._defaultValue = t, this._asciiMap = Ne._createAsciiMap(t), this._map = new Map
        }
    ...
    class Ue {
        ...
        static computeLinks(e, t = function () {
            return null === Oe && (Oe = new ze([[1, 104, 2], [1, 72, 2], [1, 102, 6], [1, 70, 6], [2, 116, 3], [2, 84, 3], [3, 116, 4], [3, 84, 4], [4, 112, 5], [4, 80, 5], [5, 115, 9], [5, 83, 9], [5, 58, 10], [6, 105, 7], [6, 73, 7], [7, 108, 8], [7, 76, 8], [8, 101, 9], [8, 69, 9], [9, 58, 10], [10, 47, 11], [11, 47, 12]])), Oe
        }()) {
            const n = function () {
                if (null === He) {
                    He = new Ne(0);
                    const e = " \t<>'\"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|";
                    for (let n = 0; n < e.length; n++) He.set(e.charCodeAt(n), 1);
                    const t = ".,;:";
                    for (let n = 0; n < t.length; n++) He.set(t.charCodeAt(n), 2)
                }
                return He
            }(), i = [];
            for (let r = 1, o = e.getLineCount(); r <= o; r++) {
                const o = e.getLineContent(r), a = o.length;
                let s = 0, l = 0, c = 0, h = 1, d = !1, u = !1, m = !1, p = !1;
                for (; s < a;) {
                    let e = !1;
                    ...
                    if (13 === h) {
                        ...
                        let t;
                        91 === a ? (u = !0, t = 0) : t = n.get(a), 1 === t ? e = !0 : h = 13
                    } else h = t.nextState(h, a), 0 === h && (e = !0);
                    e && (h = 1, d = !1, u = !1, p = !1, l = s + 1, c = a), s++
                }
                13 === h && i.push(Ue._createLink(n, o, r, l, a))
            }
            return i
        }
    }
    ...
    !function (e) {
        ...
        }), e.Cancelled = Object.freeze({isCancellationRequested: !0, onCancellationRequested: We})
    }(Pe || (Pe = {}));
    ...
    class qe {
        ...
        get onCancellationRequested() {
            return this._isCancelled ? We : (this._emitter || (this._emitter = new E), this._emitter.event)
        }
    ...
    class Fe {
        ...
        cancel() {
            this._token ? this._token instanceof qe && this._token.cancel() : this._token = Pe.Cancelled
        }

        dispose(e = !1) {
            e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof qe && this._token.dispose() : this._token = Pe.None
        }
    }
    ...
    !function () {
        ...
        e.toString = function (e) {
            ...
            return Ke.strToKeyCode(e) || je.strToKeyCode(e)
    ...
    var Ye = {};
    let Qe;
    const Ze = globalThis.vscode;
    if (void 0 !== Ze && void 0 !== Ze.process) {
        const e = Ze.process;
        Qe = {
            get platform() {
                return e.platform
    ...
    } else Qe = "undefined" != typeof process && "string" == typeof process?.versions?.node ? {
        get platform() {
    ...
    const et = Qe.cwd, tt = Qe.env, nt = Qe.platform, it = 46, rt = 47, ot = 92, at = 58;
    ...
    function lt(e, t) {
        if ("string" != typeof e) throw new st(t, "string", e)
    }
        ...
        for (let c = 0; c <= e.length; ++c) {
            ...
            if (i(l)) {
                if (a === c - 1 || 1 === s) ; else if (2 === s) {
                    if (r.length < 2 || 2 !== o || r.charCodeAt(r.length - 1) !== it || r.charCodeAt(r.length - 2) !== it) {
                        if (r.length > 2) {
    ...
    function pt(e, t) {
        !function (e, t) {
            if (null === e || "object" != typeof e) throw new st(t, "Object", e)
        }(t, "pathObject");
        const n = t.dir || t.root,
            i = t.base || `${t.name || ""}${r = t.ext, r ? `${"." === r[0] ? "" : "."}${r}` : ""}`;
        var r;
    ...
    const gt = {
        resolve(...e) {
            ...
            for (let r = e.length - 1; r >= -1; r--) {
                let o;
                if (r >= 0) {
                    if (o = e[r], lt(o, `paths[${r}]`), 0 === o.length) continue
                } else 0 === t.length ? o = et() : (o = tt[`=${t}`] || et(), (void 0 === o || o.slice(0, 2).toLowerCase() !== t.toLowerCase() && o.charCodeAt(2) === ot) && (o = `${t}\\`));
                const a = o.length;
                let s = 0, l = "", c = !1;
                const h = o.charCodeAt(0);
                if (1 === a) ht(h) && (s = 1, c = !0); else if (ht(h)) if (c = !0, ht(o.charCodeAt(1))) {
                    let e = 2, t = e;
                    for (; e < a && !ht(o.charCodeAt(e));) e++;
                    if (e < a && e !== t) {
                        const n = o.slice(t, e);
                        for (t = e; e < a && ht(o.charCodeAt(e));) e++;
                        if (e < a && e !== t) {
                            for (t = e; e < a && !ht(o.charCodeAt(e));) e++;
                            e !== a && e === t || (l = `\\\\${n}\\${o.slice(t, e)}`, s = e)
                        }
                    }
                } else s = 1; else ut(h) && o.charCodeAt(1) === at && (l = o.slice(0, 2), s = 2, a > 2 && ht(o.charCodeAt(2)) && (c = !0, s = 3));
            ...
            if (1 === t) return dt(o) ? "\\" : e;
            if (ht(o)) if (r = !0, ht(e.charCodeAt(1))) {
                let r = 2, o = r;
                for (; r < t && !ht(e.charCodeAt(r));) r++;
                if (r < t && r !== o) {
                    const a = e.slice(o, r);
                    for (o = r; r < t && ht(e.charCodeAt(r));) r++;
                    if (r < t && r !== o) {
                        for (o = r; r < t && !ht(e.charCodeAt(r));) r++;
            ...
            } else i = 1; else ut(o) && e.charCodeAt(1) === at && (n = e.slice(0, 2), i = 2, t > 2 && ht(e.charCodeAt(2)) && (r = !0, i = 3));
            let a = i < t ? mt(e.slice(i), !r, "\\", ht) : "";
            if (0 !== a.length || r || (a = "."), a.length > 0 && ht(e.charCodeAt(t - 1)) && (a += "\\"), !r && void 0 === n && e.includes(":")) {
                if (a.length >= 2 && ut(a.charCodeAt(0)) && a.charCodeAt(1) === at) return `.\\${a}`;
                let n = e.indexOf(":");
                do {
                    if (n === t - 1 || ht(e.charCodeAt(n + 1))) return `.\\${a}`
            ...
            return ht(n) || t > 2 && ut(n) && e.charCodeAt(1) === at && ht(e.charCodeAt(2))
        }, join(...e) {
            if (0 === e.length) return ".";
            let t, n;
            for (let o = 0; o < e.length; ++o) {
                const i = e[o];
                lt(i, "path"), i.length > 0 && (void 0 === t ? t = n = i : t += `\\${i}`)
            }
            if (void 0 === t) return ".";
            let i = !0, r = 0;
            if ("string" == typeof n && ht(n.charCodeAt(0))) {
                ++r;
                const e = n.length;
                e > 1 && ht(n.charCodeAt(1)) && (++r, e > 2 && (ht(n.charCodeAt(2)) ? ++r : i = !1))
            }
            if (i) {
                for (; r < t.length && ht(t.charCodeAt(r));) r++;
                r >= 2 && (t = `\\${t.slice(r)}`)
            }
            return gt.normalize(t)
        }, relative(e, t) {
            if (lt(e, "from"), lt(t, "to"), e === t) return "";
            const n = gt.resolve(e), i = gt.resolve(t);
            if (n === i) return "";
            ...
            let r = 0;
            for (; r < e.length && e.charCodeAt(r) === ot;) r++;
            let o = e.length;
            for (; o - 1 > r && e.charCodeAt(o - 1) === ot;) o--;
            const a = o - r;
            let s = 0;
            for (; s < t.length && t.charCodeAt(s) === ot;) s++;
            let l = t.length;
            for (; l - 1 > s && t.charCodeAt(l - 1) === ot;) l--;
            ...
            if (u !== h) {
                ...
                if (c > h) {
                    if (t.charCodeAt(s + u) === ot) return i.slice(s + u + 1);
                    if (2 === u) return i.slice(s + u)
                }
                a > h && (e.charCodeAt(r + u) === ot ? d = u : 2 === u && (d = 3)), -1 === d && (d = 0)
            }
            let m = "";
            for (u = r + d + 1; u <= o; ++u) u !== o && e.charCodeAt(u) !== ot || (m += 0 === m.length ? ".." : "\\..");
            return s += d, m.length > 0 ? `${m}${i.slice(s, l)}` : (i.charCodeAt(s) === ot && ++s, i.slice(s, l))
        }, toNamespacedPath(e) {
            if ("string" != typeof e || 0 === e.length) return e;
            const t = gt.resolve(e);
            if (t.length <= 2) return e;
            if (t.charCodeAt(0) === ot) {
                if (t.charCodeAt(1) === ot) {
                    const e = t.charCodeAt(2);
                    if (63 !== e && e !== it) return `\\\\?\\UNC\\${t.slice(2)}`
                }
            } else if (ut(t.charCodeAt(0)) && t.charCodeAt(1) === at && t.charCodeAt(2) === ot) return `\\\\?\\${t}`;
            return t
        }, dirname(e) {
            lt(e, "path");
            const t = e.length;
            ...
            if (1 === t) return ht(r) ? e : ".";
            if (ht(r)) {
                if (n = i = 1, ht(e.charCodeAt(1))) {
                    let r = 2, o = r;
                    for (; r < t && !ht(e.charCodeAt(r));) r++;
                    if (r < t && r !== o) {
                        for (o = r; r < t && ht(e.charCodeAt(r));) r++;
            ...
            } else ut(r) && e.charCodeAt(1) === at && (n = t > 2 && ht(e.charCodeAt(2)) ? 3 : 2, i = n);
            let o = -1, a = !0;
            for (let s = t - 1; s >= i; --s) if (ht(e.charCodeAt(s))) {
                if (!a) {
                    o = s;
                    break
                }
            ...
            let n, i = 0, r = -1, o = !0;
            if (e.length >= 2 && ut(e.charCodeAt(0)) && e.charCodeAt(1) === at && (i = 2), void 0 !== t && t.length > 0 && t.length <= e.length) {
                if (t === e) return "";
            ...
            for (n = e.length - 1; n >= i; --n) if (ht(e.charCodeAt(n))) {
                if (!o) {
                    i = n + 1;
                    break
                }
            ...
            e.length >= 2 && e.charCodeAt(1) === at && ut(e.charCodeAt(0)) && (t = i = 2);
            for (let s = e.length - 1; s >= t; --s) {
                ...
                } else -1 === r && (o = !1, r = s + 1), t === it ? -1 === n ? n = s : 1 !== a && (a = 1) : -1 !== n && (a = -1)
            }
            return -1 === n || -1 === r || 0 === a || 1 === a && n === r - 1 && n === i + 1 ? "" : e.slice(n, r)
        }, format: pt.bind(null, "\\"), parse(e) {
            lt(e, "path");
            const t = {root: "", dir: "", base: "", ext: "", name: ""};
            if (0 === e.length) return t;
            const n = e.length;
            let i = 0, r = e.charCodeAt(0);
            if (1 === n) return ht(r) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
            if (ht(r)) {
                if (i = 1, ht(e.charCodeAt(1))) {
                    let t = 2, r = t;
                    for (; t < n && !ht(e.charCodeAt(t));) t++;
                    if (t < n && t !== r) {
                        for (r = t; t < n && ht(e.charCodeAt(t));) t++;
                        if (t < n && t !== r) {
                            for (r = t; t < n && !ht(e.charCodeAt(t));) t++;
                            t === n ? i = t : t !== r && (i = t + 1)
                        }
            ...
            } else if (ut(r) && e.charCodeAt(1) === at) {
                if (n <= 2) return t.root = t.dir = e, t;
                if (i = 2, ht(e.charCodeAt(2))) {
            ...
            for (; c >= i; --c) if (r = e.charCodeAt(c), ht(r)) {
                if (!l) {
                    a = c + 1;
                    break
                }
            } else -1 === s && (l = !1, s = c + 1), r === it ? -1 === o ? o = c : 1 !== h && (h = 1) : -1 !== o && (h = -1);
        ...
        resolve(...e) {
            ...
            for (let i = e.length - 1; i >= 0 && !n; i--) {
                const r = e[i];
                lt(r, `paths[${i}]`), 0 !== r.length && (t = `${r}/${t}`, n = r.charCodeAt(0) === rt)
            }
            if (!n) {
                const e = ft();
                t = `${e}/${t}`, n = e.charCodeAt(0) === rt
            }
            return t = mt(t, !n, "/", dt), n ? `/${t}` : t.length > 0 ? t : "."
        }, normalize(e) {
            if (lt(e, "path"), 0 === e.length) return ".";
            const t = e.charCodeAt(0) === rt, n = e.charCodeAt(e.length - 1) === rt;
            return 0 === (e = mt(e, !t, "/", dt)).length ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e)
        }, isAbsolute: e => (lt(e, "path"), e.length > 0 && e.charCodeAt(0) === rt), join(...e) {
            if (0 === e.length) return ".";
            const t = [];
            for (let n = 0; n < e.length; ++n) {
                const i = e[n];
                lt(i, "path"), i.length > 0 && t.push(i)
            }
            ...
            if (s === o) if (r > o) {
                if (t.charCodeAt(1 + s) === rt) return t.slice(1 + s + 1);
                if (0 === s) return t.slice(1 + s)
            } else i > o && (e.charCodeAt(1 + s) === rt ? a = s : 0 === s && (a = 0));
            let l = "";
            for (s = 1 + a + 1; s <= n; ++s) s !== n && e.charCodeAt(s) !== rt || (l += 0 === l.length ? ".." : "/..");
            return `${l}${t.slice(1 + a)}`
        }, toNamespacedPath: e => e, dirname(e) {
            if (lt(e, "path"), 0 === e.length) return ".";
            const t = e.charCodeAt(0) === rt;
            let n = -1, i = !0;
            for (let r = e.length - 1; r >= 1; --r) if (e.charCodeAt(r) === rt) {
                if (!i) {
                    n = r;
                    break
                }
            ...
            for (n = e.length - 1; n >= 0; --n) if (e.charCodeAt(n) === rt) {
                if (!o) {
                    i = n + 1;
                    break
                }
            ...
            for (let a = e.length - 1; a >= 0; --a) {
                const s = e[a];
                if ("/" !== s) -1 === i && (r = !1, i = a + 1), "." === s ? -1 === t ? t = a : 1 !== o && (o = 1) : -1 !== t && (o = -1); else if (!r) {
                    n = a + 1;
                    break
                }
            }
            ...
            const t = {root: "", dir: "", base: "", ext: "", name: ""};
            if (0 === e.length) return t;
            const n = e.charCodeAt(0) === rt;
            let i;
            n ? (t.root = "/", i = 1) : i = 0;
            let r = -1, o = 0, a = -1, s = !0, l = e.length - 1, c = 0;
            for (; l >= i; --l) {
                const t = e.charCodeAt(l);
                if (t !== rt) -1 === a && (s = !1, a = l + 1), t === it ? -1 === r ? r = l : 1 !== c && (c = 1) : -1 !== r && (c = -1); else if (!s) {
                    o = l + 1;
                    break
                }
            }
    ...
    bt.win32 = gt.win32 = gt, bt.posix = gt.posix = bt, ct ? gt.normalize : bt.normalize, ct ? gt.resolve : bt.resolve, ct ? gt.relative : bt.relative, ct ? gt.dirname : bt.dirname, ct ? gt.basename : bt.basename, ct ? gt.extname : bt.extname, ct ? gt.sep : bt.sep;
    const _t = /^\w[\w\d+.-]*$/, wt = /^\//, vt = /^\/\//;
    const yt = "", Tt = "/", kt = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
    let St = class e {
        static isUri(t) {
        ...
        constructor(e, t, n, i, r, o = !1) {
            "object" == typeof e ? (this.scheme = e.scheme || yt, this.authority = e.authority || yt, this.path = e.path || yt, this.query = e.query || yt, this.fragment = e.fragment || yt) : (this.scheme = function (e, t) {
                return e || t ? e : "file"
            }(e, o), this.authority = t || yt, this.path = function (e, t) {
                switch (e) {
                    case"https":
                    case"http":
                    case"file":
                ...
                return t
            }(this.scheme, n || yt), this.query = i || yt, this.fragment = r || yt, function (e, t) {
                ...
                if (e.scheme && !_t.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
                if (e.path) if (e.authority) {
                    if (!wt.test(e.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')
                } else if (vt.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
            }(this, o))
        }
        ...
        with(e) {
            ...
            return void 0 === t ? t = this.scheme : null === t && (t = yt), void 0 === n ? n = this.authority : null === n && (n = yt), void 0 === i ? i = this.path : null === i && (i = yt), void 0 === r ? r = this.query : null === r && (r = yt), void 0 === o ? o = this.fragment : null === o && (o = yt), t === this.scheme && n === this.authority && i === this.path && r === this.query && o === this.fragment ? this : new xt(t, n, i, r, o)
        }

        static parse(e, t = !1) {
            const n = kt.exec(e);
            return n ? new xt(n[2] || yt, zt(n[4] || yt), zt(n[5] || yt), zt(n[7] || yt), zt(n[9] || yt), t) : new xt(yt, yt, yt, yt, yt)
        }

        static file(e) {
            let t = yt;
            if (j && (e = e.replace(/\\/g, Tt)), e[0] === Tt && e[1] === Tt) {
                const n = e.indexOf(Tt, 2);
                -1 === n ? (t = e.substring(2), e = Tt) : (t = e.substring(2, n), e = e.substring(n) || Tt)
            }
            return new xt("file", t, e, yt, yt)
        }

        static from(e, t) {
            return new xt(e.scheme, e.authority, e.path, e.query, e.fragment, t)
        }

        static joinPath(t, ...n) {
            if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
            let i;
            return i = j && "file" === t.scheme ? e.file(gt.join(Rt(t, !0), ...n)).path : bt.join(t.path, ...n), t.with({path: i})
        }
        ...
        static revive(t) {
            if (t) {
                ...
                {
                    const e = new xt(t);
                    return e._formatted = t.external ?? null, e._fsPath = t._sep === Lt ? t.fsPath ?? null : null, e
                }
            }
            return t
        }
    ...
    class xt extends St {
        ...
        toString(e = !1) {
            return e ? Mt(this, !0) : (this._formatted || (this._formatted = Mt(this, !1)), this._formatted)
        }

        toJSON() {
            const e = {$mid: 1};
            return this._fsPath && (e.fsPath = this._fsPath, e._sep = Lt), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e
        }
    }
    ...
    function Et(e, t, n) {
        ...
        for (let o = 0; o < e.length; o++) {
            ...
            if (a >= 97 && a <= 122 || a >= 65 && a <= 90 || a >= 48 && a <= 57 || 45 === a || 46 === a || 95 === a || 126 === a || t && 47 === a || n && 91 === a || n && 93 === a || n && 58 === a) -1 !== r && (i += encodeURIComponent(e.substring(r, o)), r = -1), void 0 !== i && (i += e.charAt(o)); else {
    ...
    function At(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const i = e.charCodeAt(n);
            35 === i || 63 === i ? (void 0 === t && (t = e.substr(0, n)), t += Ct[i]) : void 0 !== t && (t += e[n])
        }
        return void 0 !== t ? t : e
    }
    ...
    function Mt(e, t) {
        ...
        if (r && (i += r, i += ":"), (o || "file" === r) && (i += Tt, i += Tt), o) {
            let e = o.indexOf("@");
            if (-1 !== e) {
        ...
        return s && (i += "?", i += n(s, !1, !1)), l && (i += "#", i += t ? l : Et(l, !1, !1)), i
    }
    ...
    function Nt(e) {
        try {
            ...
            return e.length > 3 ? e.substr(0, 3) + Nt(e.substr(3)) : e
        }
    }

    const It = /(%[0-9A-Za-z][0-9A-Za-z])+/g;

    function zt(e) {
        return e.match(It) ? e.replace(It, e => Nt(e)) : e
    }
    ...
    class Ot extends Ae {
        ...
        equalsSelection(e) {
            return Ot.selectionsEqual(this, e)
        }
        ...
        setEndPosition(e, t) {
            return 0 === this.getDirection() ? new Ot(this.startLineNumber, this.startColumn, e, t) : new Ot(e, t, this.startLineNumber, this.startColumn)
        }
        ...
        setStartPosition(e, t) {
            return 0 === this.getDirection() ? new Ot(e, t, this.endLineNumber, this.endColumn) : new Ot(this.endLineNumber, this.endColumn, e, t)
        }

        static fromPositions(e, t = e) {
            return new Ot(e.lineNumber, e.column, t.lineNumber, t.column)
        }

        static fromRange(e, t) {
            return 0 === t ? new Ot(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : new Ot(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn)
        }

        static liftSelection(e) {
            return new Ot(e.selectionStartLineNumber, e.selectionStartColumn, e.positionLineNumber, e.positionColumn)
        }
        ...
        static createWithDirection(e, t, n, i, r) {
            return 0 === r ? new Ot(e, t, n, i) : new Ot(n, i, e, t)
        }
    }
    ...
    const Dt = {
        ...{
            add: Ut("add", 6e4),
            plus: Ut("plus", 6e4),
            gistNew: Ut("gist-new", 6e4),
            repoCreate: Ut("repo-create", 6e4),
            lightbulb: Ut("lightbulb", 60001),
            lightBulb: Ut("light-bulb", 60001),
            repo: Ut("repo", 60002),
            repoDelete: Ut("repo-delete", 60002),
            gistFork: Ut("gist-fork", 60003),
            repoForked: Ut("repo-forked", 60003),
            gitPullRequest: Ut("git-pull-request", 60004),
            gitPullRequestAbandoned: Ut("git-pull-request-abandoned", 60004),
            recordKeys: Ut("record-keys", 60005),
            keyboard: Ut("keyboard", 60005),
            tag: Ut("tag", 60006),
            gitPullRequestLabel: Ut("git-pull-request-label", 60006),
            tagAdd: Ut("tag-add", 60006),
            tagRemove: Ut("tag-remove", 60006),
            person: Ut("person", 60007),
            personFollow: Ut("person-follow", 60007),
            personOutline: Ut("person-outline", 60007),
            personFilled: Ut("person-filled", 60007),
            sourceControl: Ut("source-control", 60008),
            mirror: Ut("mirror", 60009),
            mirrorPublic: Ut("mirror-public", 60009),
            star: Ut("star", 60010),
            starAdd: Ut("star-add", 60010),
            starDelete: Ut("star-delete", 60010),
            starEmpty: Ut("star-empty", 60010),
            comment: Ut("comment", 60011),
            commentAdd: Ut("comment-add", 60011),
            alert: Ut("alert", 60012),
            warning: Ut("warning", 60012),
            search: Ut("search", 60013),
            searchSave: Ut("search-save", 60013),
            logOut: Ut("log-out", 60014),
            signOut: Ut("sign-out", 60014),
            logIn: Ut("log-in", 60015),
            signIn: Ut("sign-in", 60015),
            eye: Ut("eye", 60016),
            eyeUnwatch: Ut("eye-unwatch", 60016),
            eyeWatch: Ut("eye-watch", 60016),
            circleFilled: Ut("circle-filled", 60017),
            primitiveDot: Ut("primitive-dot", 60017),
            closeDirty: Ut("close-dirty", 60017),
            debugBreakpoint: Ut("debug-breakpoint", 60017),
            debugBreakpointDisabled: Ut("debug-breakpoint-disabled", 60017),
            debugHint: Ut("debug-hint", 60017),
            terminalDecorationSuccess: Ut("terminal-decoration-success", 60017),
            primitiveSquare: Ut("primitive-square", 60018),
            edit: Ut("edit", 60019),
            pencil: Ut("pencil", 60019),
            info: Ut("info", 60020),
            issueOpened: Ut("issue-opened", 60020),
            gistPrivate: Ut("gist-private", 60021),
            gitForkPrivate: Ut("git-fork-private", 60021),
            lock: Ut("lock", 60021),
            mirrorPrivate: Ut("mirror-private", 60021),
            close: Ut("close", 60022),
            removeClose: Ut("remove-close", 60022),
            x: Ut("x", 60022),
            repoSync: Ut("repo-sync", 60023),
            sync: Ut("sync", 60023),
            clone: Ut("clone", 60024),
            desktopDownload: Ut("desktop-download", 60024),
            beaker: Ut("beaker", 60025),
            microscope: Ut("microscope", 60025),
            vm: Ut("vm", 60026),
            deviceDesktop: Ut("device-desktop", 60026),
            file: Ut("file", 60027),
            more: Ut("more", 60028),
            ellipsis: Ut("ellipsis", 60028),
            kebabHorizontal: Ut("kebab-horizontal", 60028),
            mailReply: Ut("mail-reply", 60029),
            reply: Ut("reply", 60029),
            organization: Ut("organization", 60030),
            organizationFilled: Ut("organization-filled", 60030),
            organizationOutline: Ut("organization-outline", 60030),
            newFile: Ut("new-file", 60031),
            fileAdd: Ut("file-add", 60031),
            newFolder: Ut("new-folder", 60032),
            fileDirectoryCreate: Ut("file-directory-create", 60032),
            trash: Ut("trash", 60033),
            trashcan: Ut("trashcan", 60033),
            history: Ut("history", 60034),
            clock: Ut("clock", 60034),
            folder: Ut("folder", 60035),
            fileDirectory: Ut("file-directory", 60035),
            symbolFolder: Ut("symbol-folder", 60035),
            logoGithub: Ut("logo-github", 60036),
            markGithub: Ut("mark-github", 60036),
            github: Ut("github", 60036),
            terminal: Ut("terminal", 60037),
            console: Ut("console", 60037),
            repl: Ut("repl", 60037),
            zap: Ut("zap", 60038),
            symbolEvent: Ut("symbol-event", 60038),
            error: Ut("error", 60039),
            stop: Ut("stop", 60039),
            variable: Ut("variable", 60040),
            symbolVariable: Ut("symbol-variable", 60040),
            array: Ut("array", 60042),
            symbolArray: Ut("symbol-array", 60042),
            symbolModule: Ut("symbol-module", 60043),
            symbolPackage: Ut("symbol-package", 60043),
            symbolNamespace: Ut("symbol-namespace", 60043),
            symbolObject: Ut("symbol-object", 60043),
            symbolMethod: Ut("symbol-method", 60044),
            symbolFunction: Ut("symbol-function", 60044),
            symbolConstructor: Ut("symbol-constructor", 60044),
            symbolBoolean: Ut("symbol-boolean", 60047),
            symbolNull: Ut("symbol-null", 60047),
            symbolNumeric: Ut("symbol-numeric", 60048),
            symbolNumber: Ut("symbol-number", 60048),
            symbolStructure: Ut("symbol-structure", 60049),
            symbolStruct: Ut("symbol-struct", 60049),
            symbolParameter: Ut("symbol-parameter", 60050),
            symbolTypeParameter: Ut("symbol-type-parameter", 60050),
            symbolKey: Ut("symbol-key", 60051),
            symbolText: Ut("symbol-text", 60051),
            symbolReference: Ut("symbol-reference", 60052),
            goToFile: Ut("go-to-file", 60052),
            symbolEnum: Ut("symbol-enum", 60053),
            symbolValue: Ut("symbol-value", 60053),
            symbolRuler: Ut("symbol-ruler", 60054),
            symbolUnit: Ut("symbol-unit", 60054),
            activateBreakpoints: Ut("activate-breakpoints", 60055),
            archive: Ut("archive", 60056),
            arrowBoth: Ut("arrow-both", 60057),
            arrowDown: Ut("arrow-down", 60058),
            arrowLeft: Ut("arrow-left", 60059),
            arrowRight: Ut("arrow-right", 60060),
            arrowSmallDown: Ut("arrow-small-down", 60061),
            arrowSmallLeft: Ut("arrow-small-left", 60062),
            arrowSmallRight: Ut("arrow-small-right", 60063),
            arrowSmallUp: Ut("arrow-small-up", 60064),
            arrowUp: Ut("arrow-up", 60065),
            bell: Ut("bell", 60066),
            bold: Ut("bold", 60067),
            book: Ut("book", 60068),
            bookmark: Ut("bookmark", 60069),
            debugBreakpointConditionalUnverified: Ut("debug-breakpoint-conditional-unverified", 60070),
            debugBreakpointConditional: Ut("debug-breakpoint-conditional", 60071),
            debugBreakpointConditionalDisabled: Ut("debug-breakpoint-conditional-disabled", 60071),
            debugBreakpointDataUnverified: Ut("debug-breakpoint-data-unverified", 60072),
            debugBreakpointData: Ut("debug-breakpoint-data", 60073),
            debugBreakpointDataDisabled: Ut("debug-breakpoint-data-disabled", 60073),
            debugBreakpointLogUnverified: Ut("debug-breakpoint-log-unverified", 60074),
            debugBreakpointLog: Ut("debug-breakpoint-log", 60075),
            debugBreakpointLogDisabled: Ut("debug-breakpoint-log-disabled", 60075),
            briefcase: Ut("briefcase", 60076),
            broadcast: Ut("broadcast", 60077),
            browser: Ut("browser", 60078),
            bug: Ut("bug", 60079),
            calendar: Ut("calendar", 60080),
            caseSensitive: Ut("case-sensitive", 60081),
            check: Ut("check", 60082),
            checklist: Ut("checklist", 60083),
            chevronDown: Ut("chevron-down", 60084),
            chevronLeft: Ut("chevron-left", 60085),
            chevronRight: Ut("chevron-right", 60086),
            chevronUp: Ut("chevron-up", 60087),
            chromeClose: Ut("chrome-close", 60088),
            chromeMaximize: Ut("chrome-maximize", 60089),
            chromeMinimize: Ut("chrome-minimize", 60090),
            chromeRestore: Ut("chrome-restore", 60091),
            circleOutline: Ut("circle-outline", 60092),
            circle: Ut("circle", 60092),
            debugBreakpointUnverified: Ut("debug-breakpoint-unverified", 60092),
            terminalDecorationIncomplete: Ut("terminal-decoration-incomplete", 60092),
            circleSlash: Ut("circle-slash", 60093),
            circuitBoard: Ut("circuit-board", 60094),
            clearAll: Ut("clear-all", 60095),
            clippy: Ut("clippy", 60096),
            closeAll: Ut("close-all", 60097),
            cloudDownload: Ut("cloud-download", 60098),
            cloudUpload: Ut("cloud-upload", 60099),
            code: Ut("code", 60100),
            collapseAll: Ut("collapse-all", 60101),
            colorMode: Ut("color-mode", 60102),
            commentDiscussion: Ut("comment-discussion", 60103),
            creditCard: Ut("credit-card", 60105),
            dash: Ut("dash", 60108),
            dashboard: Ut("dashboard", 60109),
            database: Ut("database", 60110),
            debugContinue: Ut("debug-continue", 60111),
            debugDisconnect: Ut("debug-disconnect", 60112),
            debugPause: Ut("debug-pause", 60113),
            debugRestart: Ut("debug-restart", 60114),
            debugStart: Ut("debug-start", 60115),
            debugStepInto: Ut("debug-step-into", 60116),
            debugStepOut: Ut("debug-step-out", 60117),
            debugStepOver: Ut("debug-step-over", 60118),
            debugStop: Ut("debug-stop", 60119),
            debug: Ut("debug", 60120),
            deviceCameraVideo: Ut("device-camera-video", 60121),
            deviceCamera: Ut("device-camera", 60122),
            deviceMobile: Ut("device-mobile", 60123),
            diffAdded: Ut("diff-added", 60124),
            diffIgnored: Ut("diff-ignored", 60125),
            diffModified: Ut("diff-modified", 60126),
            diffRemoved: Ut("diff-removed", 60127),
            diffRenamed: Ut("diff-renamed", 60128),
            diff: Ut("diff", 60129),
            diffSidebyside: Ut("diff-sidebyside", 60129),
            discard: Ut("discard", 60130),
            editorLayout: Ut("editor-layout", 60131),
            emptyWindow: Ut("empty-window", 60132),
            exclude: Ut("exclude", 60133),
            extensions: Ut("extensions", 60134),
            eyeClosed: Ut("eye-closed", 60135),
            fileBinary: Ut("file-binary", 60136),
            fileCode: Ut("file-code", 60137),
            fileMedia: Ut("file-media", 60138),
            filePdf: Ut("file-pdf", 60139),
            fileSubmodule: Ut("file-submodule", 60140),
            fileSymlinkDirectory: Ut("file-symlink-directory", 60141),
            fileSymlinkFile: Ut("file-symlink-file", 60142),
            fileZip: Ut("file-zip", 60143),
            files: Ut("files", 60144),
            filter: Ut("filter", 60145),
            flame: Ut("flame", 60146),
            foldDown: Ut("fold-down", 60147),
            foldUp: Ut("fold-up", 60148),
            fold: Ut("fold", 60149),
            folderActive: Ut("folder-active", 60150),
            folderOpened: Ut("folder-opened", 60151),
            gear: Ut("gear", 60152),
            gift: Ut("gift", 60153),
            gistSecret: Ut("gist-secret", 60154),
            gist: Ut("gist", 60155),
            gitCommit: Ut("git-commit", 60156),
            gitCompare: Ut("git-compare", 60157),
            compareChanges: Ut("compare-changes", 60157),
            gitMerge: Ut("git-merge", 60158),
            githubAction: Ut("github-action", 60159),
            githubAlt: Ut("github-alt", 60160),
            globe: Ut("globe", 60161),
            grabber: Ut("grabber", 60162),
            graph: Ut("graph", 60163),
            gripper: Ut("gripper", 60164),
            heart: Ut("heart", 60165),
            home: Ut("home", 60166),
            horizontalRule: Ut("horizontal-rule", 60167),
            hubot: Ut("hubot", 60168),
            inbox: Ut("inbox", 60169),
            issueReopened: Ut("issue-reopened", 60171),
            issues: Ut("issues", 60172),
            italic: Ut("italic", 60173),
            jersey: Ut("jersey", 60174),
            json: Ut("json", 60175),
            kebabVertical: Ut("kebab-vertical", 60176),
            key: Ut("key", 60177),
            law: Ut("law", 60178),
            lightbulbAutofix: Ut("lightbulb-autofix", 60179),
            linkExternal: Ut("link-external", 60180),
            link: Ut("link", 60181),
            listOrdered: Ut("list-ordered", 60182),
            listUnordered: Ut("list-unordered", 60183),
            liveShare: Ut("live-share", 60184),
            loading: Ut("loading", 60185),
            location: Ut("location", 60186),
            mailRead: Ut("mail-read", 60187),
            mail: Ut("mail", 60188),
            markdown: Ut("markdown", 60189),
            megaphone: Ut("megaphone", 60190),
            mention: Ut("mention", 60191),
            milestone: Ut("milestone", 60192),
            gitPullRequestMilestone: Ut("git-pull-request-milestone", 60192),
            mortarBoard: Ut("mortar-board", 60193),
            move: Ut("move", 60194),
            multipleWindows: Ut("multiple-windows", 60195),
            mute: Ut("mute", 60196),
            noNewline: Ut("no-newline", 60197),
            note: Ut("note", 60198),
            octoface: Ut("octoface", 60199),
            openPreview: Ut("open-preview", 60200),
            package: Ut("package", 60201),
            paintcan: Ut("paintcan", 60202),
            pin: Ut("pin", 60203),
            play: Ut("play", 60204),
            run: Ut("run", 60204),
            plug: Ut("plug", 60205),
            preserveCase: Ut("preserve-case", 60206),
            preview: Ut("preview", 60207),
            project: Ut("project", 60208),
            pulse: Ut("pulse", 60209),
            question: Ut("question", 60210),
            quote: Ut("quote", 60211),
            radioTower: Ut("radio-tower", 60212),
            reactions: Ut("reactions", 60213),
            references: Ut("references", 60214),
            refresh: Ut("refresh", 60215),
            regex: Ut("regex", 60216),
            remoteExplorer: Ut("remote-explorer", 60217),
            remote: Ut("remote", 60218),
            remove: Ut("remove", 60219),
            replaceAll: Ut("replace-all", 60220),
            replace: Ut("replace", 60221),
            repoClone: Ut("repo-clone", 60222),
            repoForcePush: Ut("repo-force-push", 60223),
            repoPull: Ut("repo-pull", 60224),
            repoPush: Ut("repo-push", 60225),
            report: Ut("report", 60226),
            requestChanges: Ut("request-changes", 60227),
            rocket: Ut("rocket", 60228),
            rootFolderOpened: Ut("root-folder-opened", 60229),
            rootFolder: Ut("root-folder", 60230),
            rss: Ut("rss", 60231),
            ruby: Ut("ruby", 60232),
            saveAll: Ut("save-all", 60233),
            saveAs: Ut("save-as", 60234),
            save: Ut("save", 60235),
            screenFull: Ut("screen-full", 60236),
            screenNormal: Ut("screen-normal", 60237),
            searchStop: Ut("search-stop", 60238),
            server: Ut("server", 60240),
            settingsGear: Ut("settings-gear", 60241),
            settings: Ut("settings", 60242),
            shield: Ut("shield", 60243),
            smiley: Ut("smiley", 60244),
            sortPrecedence: Ut("sort-precedence", 60245),
            splitHorizontal: Ut("split-horizontal", 60246),
            splitVertical: Ut("split-vertical", 60247),
            squirrel: Ut("squirrel", 60248),
            starFull: Ut("star-full", 60249),
            starHalf: Ut("star-half", 60250),
            symbolClass: Ut("symbol-class", 60251),
            symbolColor: Ut("symbol-color", 60252),
            symbolConstant: Ut("symbol-constant", 60253),
            symbolEnumMember: Ut("symbol-enum-member", 60254),
            symbolField: Ut("symbol-field", 60255),
            symbolFile: Ut("symbol-file", 60256),
            symbolInterface: Ut("symbol-interface", 60257),
            symbolKeyword: Ut("symbol-keyword", 60258),
            symbolMisc: Ut("symbol-misc", 60259),
            symbolOperator: Ut("symbol-operator", 60260),
            symbolProperty: Ut("symbol-property", 60261),
            wrench: Ut("wrench", 60261),
            wrenchSubaction: Ut("wrench-subaction", 60261),
            symbolSnippet: Ut("symbol-snippet", 60262),
            tasklist: Ut("tasklist", 60263),
            telescope: Ut("telescope", 60264),
            textSize: Ut("text-size", 60265),
            threeBars: Ut("three-bars", 60266),
            thumbsdown: Ut("thumbsdown", 60267),
            thumbsup: Ut("thumbsup", 60268),
            tools: Ut("tools", 60269),
            triangleDown: Ut("triangle-down", 60270),
            triangleLeft: Ut("triangle-left", 60271),
            triangleRight: Ut("triangle-right", 60272),
            triangleUp: Ut("triangle-up", 60273),
            twitter: Ut("twitter", 60274),
            unfold: Ut("unfold", 60275),
            unlock: Ut("unlock", 60276),
            unmute: Ut("unmute", 60277),
            unverified: Ut("unverified", 60278),
            verified: Ut("verified", 60279),
            versions: Ut("versions", 60280),
            vmActive: Ut("vm-active", 60281),
            vmOutline: Ut("vm-outline", 60282),
            vmRunning: Ut("vm-running", 60283),
            watch: Ut("watch", 60284),
            whitespace: Ut("whitespace", 60285),
            wholeWord: Ut("whole-word", 60286),
            window: Ut("window", 60287),
            wordWrap: Ut("word-wrap", 60288),
            zoomIn: Ut("zoom-in", 60289),
            zoomOut: Ut("zoom-out", 60290),
            listFilter: Ut("list-filter", 60291),
            listFlat: Ut("list-flat", 60292),
            listSelection: Ut("list-selection", 60293),
            selection: Ut("selection", 60293),
            listTree: Ut("list-tree", 60294),
            debugBreakpointFunctionUnverified: Ut("debug-breakpoint-function-unverified", 60295),
            debugBreakpointFunction: Ut("debug-breakpoint-function", 60296),
            debugBreakpointFunctionDisabled: Ut("debug-breakpoint-function-disabled", 60296),
            debugStackframeActive: Ut("debug-stackframe-active", 60297),
            circleSmallFilled: Ut("circle-small-filled", 60298),
            debugStackframeDot: Ut("debug-stackframe-dot", 60298),
            terminalDecorationMark: Ut("terminal-decoration-mark", 60298),
            debugStackframe: Ut("debug-stackframe", 60299),
            debugStackframeFocused: Ut("debug-stackframe-focused", 60299),
            debugBreakpointUnsupported: Ut("debug-breakpoint-unsupported", 60300),
            symbolString: Ut("symbol-string", 60301),
            debugReverseContinue: Ut("debug-reverse-continue", 60302),
            debugStepBack: Ut("debug-step-back", 60303),
            debugRestartFrame: Ut("debug-restart-frame", 60304),
            debugAlt: Ut("debug-alt", 60305),
            callIncoming: Ut("call-incoming", 60306),
            callOutgoing: Ut("call-outgoing", 60307),
            menu: Ut("menu", 60308),
            expandAll: Ut("expand-all", 60309),
            feedback: Ut("feedback", 60310),
            gitPullRequestReviewer: Ut("git-pull-request-reviewer", 60310),
            groupByRefType: Ut("group-by-ref-type", 60311),
            ungroupByRefType: Ut("ungroup-by-ref-type", 60312),
            account: Ut("account", 60313),
            gitPullRequestAssignee: Ut("git-pull-request-assignee", 60313),
            bellDot: Ut("bell-dot", 60314),
            debugConsole: Ut("debug-console", 60315),
            library: Ut("library", 60316),
            output: Ut("output", 60317),
            runAll: Ut("run-all", 60318),
            syncIgnored: Ut("sync-ignored", 60319),
            pinned: Ut("pinned", 60320),
            githubInverted: Ut("github-inverted", 60321),
            serverProcess: Ut("server-process", 60322),
            serverEnvironment: Ut("server-environment", 60323),
            pass: Ut("pass", 60324),
            issueClosed: Ut("issue-closed", 60324),
            stopCircle: Ut("stop-circle", 60325),
            playCircle: Ut("play-circle", 60326),
            record: Ut("record", 60327),
            debugAltSmall: Ut("debug-alt-small", 60328),
            vmConnect: Ut("vm-connect", 60329),
            cloud: Ut("cloud", 60330),
            merge: Ut("merge", 60331),
            export: Ut("export", 60332),
            graphLeft: Ut("graph-left", 60333),
            magnet: Ut("magnet", 60334),
            notebook: Ut("notebook", 60335),
            redo: Ut("redo", 60336),
            checkAll: Ut("check-all", 60337),
            pinnedDirty: Ut("pinned-dirty", 60338),
            passFilled: Ut("pass-filled", 60339),
            circleLargeFilled: Ut("circle-large-filled", 60340),
            circleLarge: Ut("circle-large", 60341),
            circleLargeOutline: Ut("circle-large-outline", 60341),
            combine: Ut("combine", 60342),
            gather: Ut("gather", 60342),
            table: Ut("table", 60343),
            variableGroup: Ut("variable-group", 60344),
            typeHierarchy: Ut("type-hierarchy", 60345),
            typeHierarchySub: Ut("type-hierarchy-sub", 60346),
            typeHierarchySuper: Ut("type-hierarchy-super", 60347),
            gitPullRequestCreate: Ut("git-pull-request-create", 60348),
            runAbove: Ut("run-above", 60349),
            runBelow: Ut("run-below", 60350),
            notebookTemplate: Ut("notebook-template", 60351),
            debugRerun: Ut("debug-rerun", 60352),
            workspaceTrusted: Ut("workspace-trusted", 60353),
            workspaceUntrusted: Ut("workspace-untrusted", 60354),
            workspaceUnknown: Ut("workspace-unknown", 60355),
            terminalCmd: Ut("terminal-cmd", 60356),
            terminalDebian: Ut("terminal-debian", 60357),
            terminalLinux: Ut("terminal-linux", 60358),
            terminalPowershell: Ut("terminal-powershell", 60359),
            terminalTmux: Ut("terminal-tmux", 60360),
            terminalUbuntu: Ut("terminal-ubuntu", 60361),
            terminalBash: Ut("terminal-bash", 60362),
            arrowSwap: Ut("arrow-swap", 60363),
            copy: Ut("copy", 60364),
            personAdd: Ut("person-add", 60365),
            filterFilled: Ut("filter-filled", 60366),
            wand: Ut("wand", 60367),
            debugLineByLine: Ut("debug-line-by-line", 60368),
            inspect: Ut("inspect", 60369),
            layers: Ut("layers", 60370),
            layersDot: Ut("layers-dot", 60371),
            layersActive: Ut("layers-active", 60372),
            compass: Ut("compass", 60373),
            compassDot: Ut("compass-dot", 60374),
            compassActive: Ut("compass-active", 60375),
            azure: Ut("azure", 60376),
            issueDraft: Ut("issue-draft", 60377),
            gitPullRequestClosed: Ut("git-pull-request-closed", 60378),
            gitPullRequestDraft: Ut("git-pull-request-draft", 60379),
            debugAll: Ut("debug-all", 60380),
            debugCoverage: Ut("debug-coverage", 60381),
            runErrors: Ut("run-errors", 60382),
            folderLibrary: Ut("folder-library", 60383),
            debugContinueSmall: Ut("debug-continue-small", 60384),
            beakerStop: Ut("beaker-stop", 60385),
            graphLine: Ut("graph-line", 60386),
            graphScatter: Ut("graph-scatter", 60387),
            pieChart: Ut("pie-chart", 60388),
            bracket: Ut("bracket", 60175),
            bracketDot: Ut("bracket-dot", 60389),
            bracketError: Ut("bracket-error", 60390),
            lockSmall: Ut("lock-small", 60391),
            azureDevops: Ut("azure-devops", 60392),
            verifiedFilled: Ut("verified-filled", 60393),
            newline: Ut("newline", 60394),
            layout: Ut("layout", 60395),
            layoutActivitybarLeft: Ut("layout-activitybar-left", 60396),
            layoutActivitybarRight: Ut("layout-activitybar-right", 60397),
            layoutPanelLeft: Ut("layout-panel-left", 60398),
            layoutPanelCenter: Ut("layout-panel-center", 60399),
            layoutPanelJustify: Ut("layout-panel-justify", 60400),
            layoutPanelRight: Ut("layout-panel-right", 60401),
            layoutPanel: Ut("layout-panel", 60402),
            layoutSidebarLeft: Ut("layout-sidebar-left", 60403),
            layoutSidebarRight: Ut("layout-sidebar-right", 60404),
            layoutStatusbar: Ut("layout-statusbar", 60405),
            layoutMenubar: Ut("layout-menubar", 60406),
            layoutCentered: Ut("layout-centered", 60407),
            target: Ut("target", 60408),
            indent: Ut("indent", 60409),
            recordSmall: Ut("record-small", 60410),
            errorSmall: Ut("error-small", 60411),
            terminalDecorationError: Ut("terminal-decoration-error", 60411),
            arrowCircleDown: Ut("arrow-circle-down", 60412),
            arrowCircleLeft: Ut("arrow-circle-left", 60413),
            arrowCircleRight: Ut("arrow-circle-right", 60414),
            arrowCircleUp: Ut("arrow-circle-up", 60415),
            layoutSidebarRightOff: Ut("layout-sidebar-right-off", 60416),
            layoutPanelOff: Ut("layout-panel-off", 60417),
            layoutSidebarLeftOff: Ut("layout-sidebar-left-off", 60418),
            blank: Ut("blank", 60419),
            heartFilled: Ut("heart-filled", 60420),
            map: Ut("map", 60421),
            mapHorizontal: Ut("map-horizontal", 60421),
            foldHorizontal: Ut("fold-horizontal", 60421),
            mapFilled: Ut("map-filled", 60422),
            mapHorizontalFilled: Ut("map-horizontal-filled", 60422),
            foldHorizontalFilled: Ut("fold-horizontal-filled", 60422),
            circleSmall: Ut("circle-small", 60423),
            bellSlash: Ut("bell-slash", 60424),
            bellSlashDot: Ut("bell-slash-dot", 60425),
            commentUnresolved: Ut("comment-unresolved", 60426),
            gitPullRequestGoToChanges: Ut("git-pull-request-go-to-changes", 60427),
            gitPullRequestNewChanges: Ut("git-pull-request-new-changes", 60428),
            searchFuzzy: Ut("search-fuzzy", 60429),
            commentDraft: Ut("comment-draft", 60430),
            send: Ut("send", 60431),
            sparkle: Ut("sparkle", 60432),
            insert: Ut("insert", 60433),
            mic: Ut("mic", 60434),
            thumbsdownFilled: Ut("thumbsdown-filled", 60435),
            thumbsupFilled: Ut("thumbsup-filled", 60436),
            coffee: Ut("coffee", 60437),
            snake: Ut("snake", 60438),
            game: Ut("game", 60439),
            vr: Ut("vr", 60440),
            chip: Ut("chip", 60441),
            piano: Ut("piano", 60442),
            music: Ut("music", 60443),
            micFilled: Ut("mic-filled", 60444),
            repoFetch: Ut("repo-fetch", 60445),
            copilot: Ut("copilot", 60446),
            lightbulbSparkle: Ut("lightbulb-sparkle", 60447),
            robot: Ut("robot", 60448),
            sparkleFilled: Ut("sparkle-filled", 60449),
            diffSingle: Ut("diff-single", 60450),
            diffMultiple: Ut("diff-multiple", 60451),
            surroundWith: Ut("surround-with", 60452),
            share: Ut("share", 60453),
            gitStash: Ut("git-stash", 60454),
            gitStashApply: Ut("git-stash-apply", 60455),
            gitStashPop: Ut("git-stash-pop", 60456),
            vscode: Ut("vscode", 60457),
            vscodeInsiders: Ut("vscode-insiders", 60458),
            codeOss: Ut("code-oss", 60459),
            runCoverage: Ut("run-coverage", 60460),
            runAllCoverage: Ut("run-all-coverage", 60461),
            coverage: Ut("coverage", 60462),
            githubProject: Ut("github-project", 60463),
            mapVertical: Ut("map-vertical", 60464),
            foldVertical: Ut("fold-vertical", 60464),
            mapVerticalFilled: Ut("map-vertical-filled", 60465),
            foldVerticalFilled: Ut("fold-vertical-filled", 60465),
            goToSearch: Ut("go-to-search", 60466),
            percentage: Ut("percentage", 60467),
            sortPercentage: Ut("sort-percentage", 60467),
            attach: Ut("attach", 60468),
            goToEditingSession: Ut("go-to-editing-session", 60469),
            editSession: Ut("edit-session", 60470),
            codeReview: Ut("code-review", 60471),
            copilotWarning: Ut("copilot-warning", 60472),
            python: Ut("python", 60473),
            copilotLarge: Ut("copilot-large", 60474),
            copilotWarningLarge: Ut("copilot-warning-large", 60475),
            keyboardTab: Ut("keyboard-tab", 60476),
            copilotBlocked: Ut("copilot-blocked", 60477),
            copilotNotConnected: Ut("copilot-not-connected", 60478),
            flag: Ut("flag", 60479),
            lightbulbEmpty: Ut("lightbulb-empty", 60480),
            symbolMethodArrow: Ut("symbol-method-arrow", 60481),
            copilotUnavailable: Ut("copilot-unavailable", 60482),
            repoPinned: Ut("repo-pinned", 60483),
            keyboardTabAbove: Ut("keyboard-tab-above", 60484),
            keyboardTabBelow: Ut("keyboard-tab-below", 60485),
            gitPullRequestDone: Ut("git-pull-request-done", 60486),
            mcp: Ut("mcp", 60487),
            extensionsLarge: Ut("extensions-large", 60488),
            layoutPanelDock: Ut("layout-panel-dock", 60489),
            layoutSidebarLeftDock: Ut("layout-sidebar-left-dock", 60490),
            layoutSidebarRightDock: Ut("layout-sidebar-right-dock", 60491),
            copilotInProgress: Ut("copilot-in-progress", 60492),
            copilotError: Ut("copilot-error", 60493),
            copilotSuccess: Ut("copilot-success", 60494),
            chatSparkle: Ut("chat-sparkle", 60495),
            searchSparkle: Ut("search-sparkle", 60496),
            editSparkle: Ut("edit-sparkle", 60497),
            copilotSnooze: Ut("copilot-snooze", 60498),
            sendToRemoteAgent: Ut("send-to-remote-agent", 60499),
            commentDiscussionSparkle: Ut("comment-discussion-sparkle", 60500),
            chatSparkleWarning: Ut("chat-sparkle-warning", 60501),
            chatSparkleError: Ut("chat-sparkle-error", 60502),
            collection: Ut("collection", 60503),
            newCollection: Ut("new-collection", 60504),
            thinking: Ut("thinking", 60505),
            build: Ut("build", 60506),
            commentDiscussionQuote: Ut("comment-discussion-quote", 60507),
            cursor: Ut("cursor", 60508),
            eraser: Ut("eraser", 60509),
            fileText: Ut("file-text", 60510),
            gitLens: Ut("git-lens", 60511),
            quotes: Ut("quotes", 60512),
            rename: Ut("rename", 60513),
            runWithDeps: Ut("run-with-deps", 60514),
            debugConnected: Ut("debug-connected", 60515),
            strikethrough: Ut("strikethrough", 60516),
            openInProduct: Ut("open-in-product", 60517),
            indexZero: Ut("index-zero", 60518),
            agent: Ut("agent", 60519),
            editCode: Ut("edit-code", 60520),
            repoSelected: Ut("repo-selected", 60521),
            skip: Ut("skip", 60522),
            mergeInto: Ut("merge-into", 60523),
            gitBranchChanges: Ut("git-branch-changes", 60524),
            gitBranchStagedChanges: Ut("git-branch-staged-changes", 60525),
            gitBranchConflicts: Ut("git-branch-conflicts", 60526),
            gitBranch: Ut("git-branch", 60527),
            gitBranchCreate: Ut("git-branch-create", 60527),
            gitBranchDelete: Ut("git-branch-delete", 60527),
            searchLarge: Ut("search-large", 60528),
            terminalGitBash: Ut("terminal-git-bash", 60529)
        }, ...{
            dialogError: Ut("dialog-error", "error"),
            dialogWarning: Ut("dialog-warning", "warning"),
            dialogInfo: Ut("dialog-info", "info"),
            dialogClose: Ut("dialog-close", "close"),
            treeItemExpanded: Ut("tree-item-expanded", "chevron-down"),
            treeFilterOnTypeOn: Ut("tree-filter-on-type-on", "list-filter"),
            treeFilterOnTypeOff: Ut("tree-filter-on-type-off", "list-selection"),
            treeFilterClear: Ut("tree-filter-clear", "close"),
            treeItemLoading: Ut("tree-item-loading", "loading"),
            menuSelection: Ut("menu-selection", "check"),
            menuSubmenu: Ut("menu-submenu", "chevron-right"),
            menuBarMore: Ut("menubar-more", "more"),
            scrollbarButtonLeft: Ut("scrollbar-button-left", "triangle-left"),
            scrollbarButtonRight: Ut("scrollbar-button-right", "triangle-right"),
            scrollbarButtonUp: Ut("scrollbar-button-up", "triangle-up"),
            scrollbarButtonDown: Ut("scrollbar-button-down", "triangle-down"),
            toolBarMore: Ut("toolbar-more", "more"),
            quickInputBack: Ut("quick-input-back", "arrow-left"),
            dropDownButton: Ut("drop-down-button", 60084),
            symbolCustomColor: Ut("symbol-customcolor", 60252),
            exportIcon: Ut("export", 60332),
            workspaceUnspecified: Ut("workspace-unspecified", 60355),
            newLine: Ut("newline", 60394),
            thumbsDownFilled: Ut("thumbsdown-filled", 60435),
            thumbsUpFilled: Ut("thumbsup-filled", 60436),
            gitFetch: Ut("git-fetch", 60445),
            lightbulbSparkleAutofix: Ut("lightbulb-sparkle-autofix", 60447),
            debugBreakpointPending: Ut("debug-breakpoint-pending", 60377)
        }
    };
    ...
    var qt, Ft, Vt, Bt, Kt, jt, Gt, $t, Xt;
    !function (e) {
        e[e.Increase = 0] = "Increase", e[e.Decrease = 1] = "Decrease"
    }(qt || (qt = {})), function (e) {
        const t = new Map;
        t.set(0, Dt.symbolMethod), t.set(1, Dt.symbolFunction), t.set(2, Dt.symbolConstructor), t.set(3, Dt.symbolField), t.set(4, Dt.symbolVariable), t.set(5, Dt.symbolClass), t.set(6, Dt.symbolStruct), t.set(7, Dt.symbolInterface), t.set(8, Dt.symbolModule), t.set(9, Dt.symbolProperty), t.set(10, Dt.symbolEvent), t.set(11, Dt.symbolOperator), t.set(12, Dt.symbolUnit), t.set(13, Dt.symbolValue), t.set(15, Dt.symbolEnum), t.set(14, Dt.symbolConstant), t.set(15, Dt.symbolEnum), t.set(16, Dt.symbolEnumMember), t.set(17, Dt.symbolKeyword), t.set(28, Dt.symbolSnippet), t.set(18, Dt.symbolText), t.set(19, Dt.symbolColor), t.set(20, Dt.symbolFile), t.set(21, Dt.symbolReference), t.set(22, Dt.symbolCustomColor), t.set(23, Dt.symbolFolder), t.set(24, Dt.symbolTypeParameter), t.set(25, Dt.account), t.set(26, Dt.issues), t.set(27, Dt.tools), e.toIcon = function (e) {
            let n = t.get(e);
            ...
            switch (e) {
                case 0:
                    return I(728, "Method");
                case 1:
                    return I(729, "Function");
                case 2:
                    return I(730, "Constructor");
                case 3:
                    return I(731, "Field");
                case 4:
                    return I(732, "Variable");
                case 5:
                    return I(733, "Class");
                case 6:
                    return I(734, "Struct");
                case 7:
                    return I(735, "Interface");
                case 8:
                    return I(736, "Module");
                case 9:
                    return I(737, "Property");
                case 10:
                    return I(738, "Event");
                case 11:
                    return I(739, "Operator");
                case 12:
                    return I(740, "Unit");
                case 13:
                    return I(741, "Value");
                case 14:
                    return I(742, "Constant");
                case 15:
                    return I(743, "Enum");
                case 16:
                    return I(744, "Enum Member");
                case 17:
                    return I(745, "Keyword");
                case 18:
                    return I(746, "Text");
                case 19:
                    return I(747, "Color");
                case 20:
                    return I(748, "File");
                case 21:
                    return I(749, "Reference");
                case 22:
                    return I(750, "Custom Color");
                case 23:
                    return I(751, "Folder");
                case 24:
                    return I(752, "Type Parameter");
                case 25:
                    return I(753, "User");
                case 26:
                    return I(754, "Issue");
    ...
    }($t || ($t = {})), I(757, "array"), I(758, "boolean"), I(759, "class"), I(760, "constant"), I(761, "constructor"), I(762, "enumeration"), I(763, "enumeration member"), I(764, "event"), I(765, "field"), I(766, "file"), I(767, "function"), I(768, "interface"), I(769, "key"), I(770, "method"), I(771, "module"), I(772, "namespace"), I(773, "null"), I(774, "number"), I(775, "object"), I(776, "operator"), I(777, "package"), I(778, "property"), I(779, "string"), I(780, "struct"), I(781, "type parameter"), I(782, "variable"), function (e) {
        const t = new Map;
        t.set(0, Dt.symbolFile), t.set(1, Dt.symbolModule), t.set(2, Dt.symbolNamespace), t.set(3, Dt.symbolPackage), t.set(4, Dt.symbolClass), t.set(5, Dt.symbolMethod), t.set(6, Dt.symbolProperty), t.set(7, Dt.symbolField), t.set(8, Dt.symbolConstructor), t.set(9, Dt.symbolEnum), t.set(10, Dt.symbolInterface), t.set(11, Dt.symbolFunction), t.set(12, Dt.symbolVariable), t.set(13, Dt.symbolConstant), t.set(14, Dt.symbolString), t.set(15, Dt.symbolNumber), t.set(16, Dt.symbolBoolean), t.set(17, Dt.symbolArray), t.set(18, Dt.symbolObject), t.set(19, Dt.symbolKey), t.set(20, Dt.symbolNull), t.set(21, Dt.symbolEnumMember), t.set(22, Dt.symbolStruct), t.set(23, Dt.symbolEvent), t.set(24, Dt.symbolOperator), t.set(25, Dt.symbolTypeParameter), e.toIcon = function (e) {
            let n = t.get(e);
            return n || (n = Dt.symbolProperty), n
        };
        const n = new Map;
    ...
    var Jt, Yt, Qt, Zt, en, tn, nn, rn, on, an, sn, ln, cn, hn, dn, un, mn, pn, gn, fn, bn, _n, wn, vn, yn, Tn, kn, Sn,
        Ln, xn, Cn, En, An, Rn, Mn, Nn, In, zn, On, Hn, Un, Dn, Wn, Pn, qn, Fn, Vn, Bn, Kn, jn, Gn, $n, Xn, Jn, Yn, Qn,
        Zn;
    !function (e) {
        ...
        constructor() {
            this._tokenizationSupports = new Map, this._factories = new Map, this._onDidChange = new E, this.onDidChange = this._onDidChange.event, this._colorMap = null
        }
        ...
        register(e, t) {
            return this._tokenizationSupports.set(e, t), this.handleChange([e]), p(() => {
        ...
        registerFactory(e, t) {
            ...
            const n = new Wt(this, e, t);
            return this._factories.set(e, n), p(() => {
    ...
    class ti {
        constructor() {
            this[Xn] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
        }
        ...
        next(e) {
            ...
            do {
                ...
                if (i === this._prevMatchStartIndex && r === this._prevMatchLength) {
                    if (0 === r) {
                        ie(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
                        continue
                    }
                    return null
                }
                if (this._prevMatchStartIndex = i, this._prevMatchLength = r, !this._wordSeparators || ri(this._wordSeparators, e, t, i, r)) return n
            } while (n);
            return null
        }
    }
    ...
    function ci(e, t, n, i, r) {
        if (t = si(t), r || (r = d.first(li)), n.length > r.maxLen) {
            let o = e - r.maxLen / 2;
            return o < 0 ? o = 0 : i += o, ci(e, t, n = n.substring(o, e + r.maxLen / 2), i, r)
        }
        const o = Date.now(), a = e - 1 - i;
        let s = -1, l = null;
        for (let c = 1; !(Date.now() - o >= r.timeBudget); c++) {
            const e = a - r.windowSize * c;
        ...
        if (l) {
            const e = {word: l[0], startColumn: i + 1 + l.index, endColumn: i + 1 + l.index + l[0].length};
    ...
    li.unshift({maxLen: 1e3, windowSize: 15, timeBudget: 150});

    class di {
        static computeUnicodeHighlights(e, t, n) {
            const i = n ? n.startLineNumber : 1, r = n ? n.endLineNumber : e.getLineCount(), o = new ui(t),
                a = o.getCandidateCodePoints();
            let l;
            var c, h;
            l = "allNonBasicAscii" === a ? new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : new RegExp("" + (c = Array.from(a), `[${h = c.map(e => String.fromCodePoint(e)).join(""), h.replace(/[\\\{\}\*\+\?\|\^\$\.\[\]\(\)]/g, "\\$&")}]`), "g");
            const d = new oi(null, l), u = [];
        ...
        static computeUnicodeHighlightReason(e, t) {
            ...
            switch (n.shouldHighlightNonBasicASCII(e, null)) {
                ...
                case 2:
                    return {kind: 1};
                case 3: {
                    const i = e.codePointAt(0), r = n.ambiguousCharacters.getPrimaryConfusable(i),
                        o = ae.getLocales().filter(e => !ae.getInstance(new Set([...t.allowedLocales, e])).isAmbiguous(i));
                    return {kind: 0, confusableWith: String.fromCodePoint(r), notAmbiguousInLocales: o}
                }
                case 1:
                    return {kind: 2}
            }
    ...
    class ui {
        constructor(e) {
            this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = ae.getInstance(new Set(e.allowedLocales))
        }

        getCandidateCodePoints() {
            if (this.options.nonBasicASCII) return "allNonBasicAscii";
            const e = new Set;
            if (this.options.invisibleCharacters) for (const t of se.codePoints) mi(String.fromCodePoint(t)) || e.add(t);
        ...
        shouldHighlightNonBasicASCII(e, t) {
            ...
            if (t) for (const o of t) {
                const e = o.codePointAt(0), t = oe(o);
                i = i || t, t || this.ambiguousCharacters.isAmbiguous(e) || se.isInvisibleCharacter(e) || (r = !0)
            }
            return !i && r ? 0 : this.options.invisibleCharacters && !mi(e) && se.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0
        }
    }
    ...
    class wi {
        ...
        filter(e) {
            return new wi(t => this.iterate(n => !e(n) || t(n)))
        }

        map(e) {
            return new wi(t => this.iterate(n => t(e(n))))
        }
        ...
        findLastMaxBy(e) {
            let t, n = !0;
            return this.iterate(i => ((n || fi.isGreaterThan(e(i, t))) && (n = !1, t = i), !0)), t
        }
    }
    ...
    class vi {
        ...
        static addRange(e, t) {
            ...
            let i = n;
            for (; i < t.length && t[i].start <= e.endExclusive;) i++;
            if (n === i) t.splice(n, 0, e); else {
                const r = Math.min(e.start, t[n].start), o = Math.max(e.endExclusive, t[i - 1].endExclusive);
                t.splice(n, i - n, new vi(r, o))
            }
        }

        static tryCreate(e, t) {
            if (!(e > t)) return new vi(e, t)
        }
        ...
        delta(e) {
            return new vi(this.start + e, this.endExclusive + e)
        }

        deltaStart(e) {
            return new vi(this.start + e, this.endExclusive)
        }

        deltaEnd(e) {
            return new vi(this.start, this.endExclusive + e)
        }
        ...
        join(e) {
            return new vi(Math.min(this.start, e.start), Math.max(this.endExclusive, e.endExclusive))
        }

        intersect(e) {
            const t = Math.max(this.start, e.start), n = Math.min(this.endExclusive, e.endExclusive);
            if (t <= n) return new vi(t, n)
        }
        ...
        joinRightTouching(e) {
            if (this.endExclusive !== e.start) throw new a(`Invalid join: ${this.toString()} and ${e.toString()}`);
            return new vi(this.start, e.endExclusive)
        }
    }
    ...
    class Si {
        ...
        findLastMonotonous(e) {
            if (Si.assertInvariants) {
                if (this._prevFindLastPredicate) for (const t of this._array) if (this._prevFindLastPredicate(t) && !e(t)) throw new Error("MonotonousArray: current predicate must be weaker than (or equal to) the previous predicate.");
                this._prevFindLastPredicate = e
            }
            const t = Ti(this._array, e, this._findLastMonotonousLastIdx);
    ...
    class Li {
        ...
        static fromRange(e) {
            return new Li(e.startLineNumber, e.endLineNumber)
        }

        static fromRangeInclusive(e) {
            return new Li(e.startLineNumber, e.endLineNumber + 1)
        }

        static {
            this.compareByStart = bi(e => e.startLineNumber, _i)
        }

        static joinMany(e) {
            if (0 === e.length) return [];
            let t = new xi(e[0].slice());
            for (let n = 1; n < e.length; n++) t = t.getUnion(new xi(e[n].slice()));
            return t.ranges
        }

        static join(e) {
            if (0 === e.length) throw new a("lineRanges cannot be empty");
            let t = e[0].startLineNumber, n = e[0].endLineNumberExclusive;
            for (let i = 1; i < e.length; i++) t = Math.min(t, e[i].startLineNumber), n = Math.max(n, e[i].endLineNumberExclusive);
            return new Li(t, n)
        }

        static deserialize(e) {
            return new Li(e[0], e[1])
        }
        ...
        delta(e) {
            return new Li(this.startLineNumber + e, this.endLineNumberExclusive + e)
        }

        deltaLength(e) {
            return new Li(this.startLineNumber, this.endLineNumberExclusive + e)
        }
        ...
        join(e) {
            return new Li(Math.min(this.startLineNumber, e.startLineNumber), Math.max(this.endLineNumberExclusive, e.endLineNumberExclusive))
        }
        ...
        toOffsetRange() {
            return new vi(this.startLineNumber - 1, this.endLineNumberExclusive - 1)
        }

        addMargin(e, t) {
            return new Li(this.startLineNumber - e, this.endLineNumberExclusive + t)
        }
    }
    ...
    class xi {
        ...
        addRange(e) {
            if (0 === e.length) return;
            const t = ki(this._normalizedRanges, t => t.endLineNumberExclusive >= e.startLineNumber),
                n = Ti(this._normalizedRanges, t => t.startLineNumber <= e.endLineNumberExclusive) + 1;
            if (t === n) this._normalizedRanges.splice(t, 0, e); else if (t === n - 1) {
        ...
        contains(e) {
            const t = yi(this._normalizedRanges, t => t.startLineNumber <= e);
            return !!t && t.endLineNumberExclusive > e
        }

        intersects(e) {
            const t = yi(this._normalizedRanges, t => t.startLineNumber < e.endLineNumberExclusive);
        ...
        getUnion(e) {
            ...
            for (; n < this._normalizedRanges.length || i < e._normalizedRanges.length;) {
                ...
                if (n < this._normalizedRanges.length && i < e._normalizedRanges.length) {
                    const t = this._normalizedRanges[n], r = e._normalizedRanges[i];
                    t.startLineNumber < r.startLineNumber ? (o = t, n++) : (o = r, i++)
                } else n < this._normalizedRanges.length ? (o = this._normalizedRanges[n], n++) : (o = e._normalizedRanges[i], i++);
                null === r ? r = o : r.endLineNumberExclusive >= o.startLineNumber ? r = new Li(r.startLineNumber, Math.max(r.endLineNumberExclusive, o.endLineNumberExclusive)) : (t.push(r), r = o)
            }
            return null !== r && t.push(r), new xi(t)
        }

        subtractFrom(e) {
            const t = ki(this._normalizedRanges, t => t.endLineNumberExclusive >= e.startLineNumber),
                n = Ti(this._normalizedRanges, t => t.startLineNumber <= e.endLineNumberExclusive) + 1;
            if (t === n) return new xi([e]);
            const i = [];
            let r = e.startLineNumber;
            for (let o = t; o < n; o++) {
                const e = this._normalizedRanges[o];
                e.startLineNumber > r && i.push(new Li(r, e.startLineNumber)), r = e.endLineNumberExclusive
            }
            return r < e.endLineNumberExclusive && i.push(new Li(r, e.endLineNumberExclusive)), new xi(i)
        }
        ...
        getIntersection(e) {
            ...
            let n = 0, i = 0;
            for (; n < this._normalizedRanges.length && i < e._normalizedRanges.length;) {
                const r = this._normalizedRanges[n], o = e._normalizedRanges[i], a = r.intersect(o);
                a && !a.isEmpty && t.push(a), r.endLineNumberExclusive < o.endLineNumberExclusive ? n++ : i++
            }
            return new xi(t)
        }

        getWithDelta(e) {
            return new xi(this._normalizedRanges.map(t => t.delta(e)))
        }
    }

    class Ci {
        static {
            this.zero = new Ci(0, 0)
        }

        static betweenPositions(e, t) {
            return e.lineNumber === t.lineNumber ? new Ci(0, t.column - e.column) : new Ci(t.lineNumber - e.lineNumber, t.column - 1)
        }
        ...
        static ofRange(e) {
            return Ci.betweenPositions(e.getStartPosition(), e.getEndPosition())
        }
        ...
        add(e) {
            return 0 === e.lineCount ? new Ci(this.lineCount, this.columnCount + e.columnCount) : new Ci(this.lineCount + e.lineCount, e.columnCount)
        }

        createRange(e) {
            return 0 === this.lineCount ? new Ae(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount) : new Ae(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1)
        }

        toRange() {
            return new Ae(1, 1, this.lineCount + 1, this.columnCount + 1)
        }

        toLineRange() {
            return Li.ofLength(1, this.lineCount + 1)
        }

        addToPosition(e) {
            return 0 === this.lineCount ? new Ee(e.lineNumber, e.column + this.columnCount) : new Ee(e.lineNumber + this.lineCount, this.columnCount + 1)
        }
    ...
    class Ei {
        getOffsetRange(e) {
            return new vi(this.getOffset(e.getStartPosition()), this.getOffset(e.getEndPosition()))
        }

        getRange(e) {
            return Ae.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive))
        }

        getStringReplacement(e) {
            return new Ai.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
        }

        getTextReplacement(e) {
            return new Ai.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
        }

        getTextEdit(e) {
            const t = e.replacements.map(e => this.getTextReplacement(e));
            return new Ai.deps.TextEdit(t)
        }
    }
    ...
    class Ri extends Ei {
        ...
        _validatePosition(e) {
            ...
            if (e.column < 1) return new Ee(e.lineNumber, 1);
            const n = this.getLineLength(e.lineNumber);
            return e.column - 1 > n ? new Ee(e.lineNumber, n + 1) : e
        }

        getPosition(e) {
            const t = Ti(this.lineStartOffsetByLineIdx, t => t <= e), n = t + 1,
                i = e - this.lineStartOffsetByLineIdx[t] + 1;
            return new Ee(n, i)
        }

        get textLength() {
            const e = this.lineStartOffsetByLineIdx.length - 1;
            return new Ai.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
        }
    ...
    class Mi {
        ...
        getLineLength(e) {
            return this.getValueOfRange(new Ae(e, 1, e, Number.MAX_SAFE_INTEGER)).length
        }

        getTransformer() {
            return this._transformer || (this._transformer = new Ri(this.getValue())), this._transformer
        }

        getLineAt(e) {
            return this.getValueOfRange(new Ae(e, 1, e, Number.MAX_SAFE_INTEGER))
        }
    }
    ...
    class Ni extends Mi {
        ...
        get length() {
            ...
            return new Ci(this._lineCount - 1, e.length)
        }
    }
    ...
    class zi {
        static joinReplacements(e, t) {
            ...
            const n = e[0].range.getStartPosition(), i = e[e.length - 1].range.getEndPosition();
            let r = "";
            for (let o = 0; o < e.length; o++) {
                const n = e[o];
                if (r += n.text, o < e.length - 1) {
                    const i = e[o + 1], a = Ae.fromPositions(n.range.getEndPosition(), i.range.getStartPosition());
                    r += t.getValueOfRange(a)
                }
            }
            return new zi(Ae.fromPositions(n, i), r)
        }

        static fromStringReplacement(e, t) {
            return new zi(t.getTransformer().getRange(e.replaceRange), e.newText)
        }
        ...
        removeCommonPrefix(e) {
            const t = e.getValueOfRange(this.range).replaceAll("\r\n", "\n"), n = this.text.replaceAll("\r\n", "\n"),
                i = function (e, t) {
                    ...
                    return n
                }(t, n), r = Ci.ofText(t.substring(0, i)).addToPosition(this.range.getStartPosition()),
                o = n.substring(i), a = Ae.fromPositions(r, this.range.getEndPosition());
            return new zi(a, o)
        }
        ...
        removeCommonSuffix(e) {
            const t = e.getValueOfRange(this.range).replaceAll("\r\n", "\n"), n = this.text.replaceAll("\r\n", "\n"),
                i = function (e, t) {
                    ...
                    return n
                }(t, n), r = Ci.ofText(t.substring(0, t.length - i)).addToPosition(this.range.getStartPosition()),
                o = n.substring(0, n.length - i), a = Ae.fromPositions(this.range.getStartPosition(), r);
            return new zi(a, o)
        }
    ...
    class Oi {
        static inverse(e, t, n) {
            ...
            let r = 1, o = 1;
            for (const s of e) {
                const e = new Oi(new Li(r, s.original.startLineNumber), new Li(o, s.modified.startLineNumber));
                e.modified.isEmpty || i.push(e), r = s.original.endLineNumberExclusive, o = s.modified.endLineNumberExclusive
            }
            const a = new Oi(new Li(r, t + 1), new Li(o, n + 1));
        ...
        static clip(e, t, n) {
            const i = [];
            for (const r of e) {
                const e = r.original.intersect(t), o = r.modified.intersect(n);
                e && !e.isEmpty && o && !o.isEmpty && i.push(new Oi(e, o))
            }
            return i
        }
        ...
        flip() {
            return new Oi(this.modified, this.original)
        }

        join(e) {
            return new Oi(this.original.join(e.original), this.modified.join(e.modified))
        }

        toRangeMapping() {
            const e = this.original.toInclusiveRange(), t = this.modified.toInclusiveRange();
            if (e && t) return new Wi(e, t);
            if (1 === this.original.startLineNumber || 1 === this.modified.startLineNumber) {
                ...
                return new Wi(new Ae(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new Ae(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1))
            }
            return new Wi(new Ae(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new Ae(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER))
        }

        toRangeMapping2(e, t) {
            if (Ui(this.original.endLineNumberExclusive, e) && Ui(this.modified.endLineNumberExclusive, t)) return new Wi(new Ae(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new Ae(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
            if (!this.original.isEmpty && !this.modified.isEmpty) return new Wi(Ae.fromPositions(new Ee(this.original.startLineNumber, 1), Hi(new Ee(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), Ae.fromPositions(new Ee(this.modified.startLineNumber, 1), Hi(new Ee(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
            if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new Wi(Ae.fromPositions(Hi(new Ee(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), Hi(new Ee(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), Ae.fromPositions(Hi(new Ee(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Hi(new Ee(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
            throw new a
        }
    }
    ...
    function Hi(e, t) {
        if (e.lineNumber < 1) return new Ee(1, 1);
        if (e.lineNumber > t.length) return new Ee(t.length, t[t.length - 1].length + 1);
    ...
    class Di extends Oi {
        static fromRangeMappings(e) {
            const t = Li.join(e.map(e => Li.fromRangeInclusive(e.originalRange))),
                n = Li.join(e.map(e => Li.fromRangeInclusive(e.modifiedRange)));
            return new Di(t, n, e)
        }
        ...
        flip() {
            return new Di(this.modified, this.original, this.innerChanges?.map(e => e.flip()))
        }

        withInnerChangesFromLineRanges() {
            return new Di(this.original, this.modified, [this.toRangeMapping()])
        }
    }
    ...
    class Wi {
        static fromEdit(e) {
            ...
            return e.replacements.map((e, n) => new Wi(e.range, t[n]))
        }
        ...
        flip() {
            return new Wi(this.modifiedRange, this.originalRange)
        }

        toTextEdit(e) {
            const t = e.getValueOfRange(this.modifiedRange);
            return new zi(this.originalRange, t)
        }
    }

    function Pi(e, t, n, i = !1) {
        const r = [];
        for (const o of function* (e, t) {
            ...
            const o = new Li(e.originalRange.startLineNumber + i, e.originalRange.endLineNumber + 1 + r),
                a = new Li(e.modifiedRange.startLineNumber + i, e.modifiedRange.endLineNumber + 1 + r);
            return new Di(o, a, [e])
        }(e, t, n)), (e, t) => e.original.intersectsOrTouches(t.original) || e.modified.intersectsOrTouches(t.modified))) {
            const e = o[0], t = o[o.length - 1];
            r.push(new Di(e.original.join(t.original), e.modified.join(t.modified), o.map(e => e.innerChanges[0])))
        }
        return l(() => {
            if (!i && r.length > 0) {
    ...
    class qi {
        computeDiff(e, t, n) {
            ...
            for (const a of i.changes) {
                let e, t;
                e = 0 === a.originalEndLineNumber ? new Li(a.originalStartLineNumber + 1, a.originalStartLineNumber + 1) : new Li(a.originalStartLineNumber, a.originalEndLineNumber + 1), t = 0 === a.modifiedEndLineNumber ? new Li(a.modifiedStartLineNumber + 1, a.modifiedStartLineNumber + 1) : new Li(a.modifiedStartLineNumber, a.modifiedEndLineNumber + 1);
                let n = new Di(e, t, a.charChanges?.map(e => new Wi(new Ae(e.originalStartLineNumber, e.originalStartColumn, e.originalEndLineNumber, e.originalEndColumn), new Ae(e.modifiedStartLineNumber, e.modifiedStartColumn, e.modifiedEndLineNumber, e.modifiedEndColumn))));
                o && (o.modified.endLineNumberExclusive !== n.modified.startLineNumber && o.original.endLineNumberExclusive !== n.original.startLineNumber || (n = new Di(o.original.join(n.original), o.modified.join(n.modified), o.innerChanges && n.innerChanges ? o.innerChanges.concat(n.innerChanges) : void 0), r.pop())), r.push(n), o = n
            }
            return l(() => c(r, (e, t) => t.original.startLineNumber - e.original.endLineNumberExclusive === t.modified.startLineNumber - e.modified.endLineNumberExclusive && e.original.endLineNumberExclusive < t.original.startLineNumber && e.modified.endLineNumberExclusive < t.modified.startLineNumber)), new pi(r, [], i.quitEarly)
        }
    }

    function Fi(e, t, n, i) {
        return new Ce(e, t, n).ComputeDiff(i)
    }

    let Vi = class {
        constructor(e) {
            const t = [], n = [];
            for (let i = 0, r = e.length; i < r; i++) t[i] = $i(e[i], 1), n[i] = Xi(e[i], 1);
        ...
        createCharSequence(e, t, n) {
            ...
            for (let s = t; s <= n; s++) {
                ...
                for (let e = l; e < c; e++) i[a] = t.charCodeAt(e - 1), r[a] = s + 1, o[a] = e, a++;
    ...
    class Ki {
        ...
        static createFromDiffChange(e, t, n) {
            const i = t.getStartLineNumber(e.originalStart), r = t.getStartColumn(e.originalStart),
                o = t.getEndLineNumber(e.originalStart + e.originalLength - 1),
                a = t.getEndColumn(e.originalStart + e.originalLength - 1), s = n.getStartLineNumber(e.modifiedStart),
                l = n.getStartColumn(e.modifiedStart), c = n.getEndLineNumber(e.modifiedStart + e.modifiedLength - 1),
                h = n.getEndColumn(e.modifiedStart + e.modifiedLength - 1);
            return new Ki(i, r, o, a, s, l, c, h)
        }
    }
    ...
    class ji {
        ...
        static createFromDiffResult(e, t, n, i, r, o, a) {
            let s, l, c, h, d;
            if (0 === t.originalLength ? (s = n.getStartLineNumber(t.originalStart) - 1, l = 0) : (s = n.getStartLineNumber(t.originalStart), l = n.getEndLineNumber(t.originalStart + t.originalLength - 1)), 0 === t.modifiedLength ? (c = i.getStartLineNumber(t.modifiedStart) - 1, h = 0) : (c = i.getStartLineNumber(t.modifiedStart), h = i.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1)), o && t.originalLength > 0 && t.originalLength < 20 && t.modifiedLength > 0 && t.modifiedLength < 20 && r()) {
                ...
                if (o.getElements().length > 0 && s.getElements().length > 0) {
                    let e = Fi(o, s, r, !0).changes;
                    a && (e = function (e) {
                        if (e.length <= 1) return e;
                        const t = [e[0]];
                        let n = t[0];
                        for (let i = 1, r = e.length; i < r; i++) {
                            const r = e[i], o = r.originalStart - (n.originalStart + n.originalLength),
                                a = r.modifiedStart - (n.modifiedStart + n.modifiedLength);
                            Math.min(o, a) < 3 ? (n.originalLength = r.originalStart + r.originalLength - n.originalStart, n.modifiedLength = r.modifiedStart + r.modifiedLength - n.modifiedStart) : (t.push(r), n = r)
                        }
                        return t
                    }(e)), d = [];
                    for (let t = 0, n = e.length; t < n; t++) d.push(Ki.createFromDiffChange(e[t], o, s))
                }
            }
            return new ji(s, l, c, h, d)
        }
    }
    ...
    class Gi {
        ...
        computeDiff() {
            ...
            const e = Fi(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), t = e.changes,
                n = e.quitEarly;
            if (this.shouldIgnoreTrimWhitespace) {
                const e = [];
                for (let n = 0, i = t.length; n < i; n++) e.push(ji.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[n], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
                return {quitEarly: n, changes: e}
            }
            const i = [];
            let r = 0, o = 0;
            for (let a = -1, s = t.length; a < s; a++) {
                const e = a + 1 < s ? t[a + 1] : null, n = e ? e.originalStart : this.originalLines.length,
                ...
                e && (i.push(ji.createFromDiffResult(this.shouldIgnoreTrimWhitespace, e, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), r += e.originalLength, o += e.modifiedLength)
            }
        ...
        _pushTrimWhitespaceCharChange(e, t, n, i, r, o, a) {
            ...
            let s;
            this.shouldComputeCharChanges && (s = [new Ki(t, n, t, i, r, o, r, a)]), e.push(new ji(t, t, r, r, s))
        }
        ...
        _mergeTrimWhitespaceCharChange(e, t, n, i, r, o, a) {
            ...
            if (0 === s) return !1;
            const l = e[s - 1];
            return 0 !== l.originalEndLineNumber && 0 !== l.modifiedEndLineNumber && (l.originalEndLineNumber === t && l.modifiedEndLineNumber === r ? (this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Ki(t, n, t, i, r, o, r, a)), !0) : l.originalEndLineNumber + 1 === t && l.modifiedEndLineNumber + 1 === r && (l.originalEndLineNumber = t, l.modifiedEndLineNumber = r, this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Ki(t, n, t, i, r, o, r, a)), !0))
        }
    }
    ...
    class Yi {
        static trivial(e, t) {
            return new Yi([new Qi(vi.ofLength(e.length), vi.ofLength(t.length))], !1)
        }

        static trivialTimedOut(e, t) {
            return new Yi([new Qi(vi.ofLength(e.length), vi.ofLength(t.length))], !0)
        }
    ...
    class Qi {
        static invert(e, t) {
            ...
            return function (e, t) {
                ...
                n.push(Qi.fromOffsetPairs(e ? e.getEndExclusives() : Zi.zero, i ? i.getStarts() : new Zi(t, (e ? e.seq2Range.endExclusive - e.seq1Range.endExclusive : 0) + t)))
            }), n
        }

        static fromOffsetPairs(e, t) {
            return new Qi(new vi(e.offset1, t.offset1), new vi(e.offset2, t.offset2))
        }
        ...
        swap() {
            return new Qi(this.seq2Range, this.seq1Range)
        }
        ...
        join(e) {
            return new Qi(this.seq1Range.join(e.seq1Range), this.seq2Range.join(e.seq2Range))
        }

        delta(e) {
            return 0 === e ? this : new Qi(this.seq1Range.delta(e), this.seq2Range.delta(e))
        }

        deltaStart(e) {
            return 0 === e ? this : new Qi(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e))
        }

        deltaEnd(e) {
            return 0 === e ? this : new Qi(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e))
        }

        intersect(e) {
            const t = this.seq1Range.intersect(e.seq1Range), n = this.seq2Range.intersect(e.seq2Range);
            if (t && n) return new Qi(t, n)
        }

        getStarts() {
            return new Zi(this.seq1Range.start, this.seq2Range.start)
        }

        getEndExclusives() {
            return new Zi(this.seq1Range.endExclusive, this.seq2Range.endExclusive)
        }
    }

    class Zi {
        static {
            this.zero = new Zi(0, 0)
        }
        static {
            this.max = new Zi(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER)
        }
        ...
        delta(e) {
            return 0 === e ? this : new Zi(this.offset1 + e, this.offset2 + e)
        }
    ...
    class or {
        compute(e, t, n = er.instance, i) {
            if (0 === e.length || 0 === t.length) return Yi.trivial(e, t);
            const r = new nr(e.length, t.length), o = new nr(e.length, t.length), a = new nr(e.length, t.length);
            for (let m = 0; m < e.length; m++) for (let s = 0; s < t.length; s++) {
                if (!n.isValid()) return Yi.trivialTimedOut(e, t);
            ...
            function h(e, t) {
                e + 1 === l && t + 1 === c || s.push(new Qi(new vi(e + 1, l), new vi(t + 1, c))), l = e, c = t
            }

            let d = e.length - 1, u = t.length - 1;
            for (; d >= 0 && u >= 0;) 3 === o.get(d, u) ? (h(d, u), d--, u--) : 1 === o.get(d, u) ? d-- : u--;
            return h(-1, -1), s.reverse(), new Yi(s, !1)
        }
    }

    class ar {
        compute(e, t, n = er.instance) {
            if (0 === e.length || 0 === t.length) return Yi.trivial(e, t);
            const i = e, r = t;
            ...
            s.set(0, o(0, 0));
            const l = new cr;
            l.set(0, 0 === s.get(0) ? null : new sr(null, 0, 0, s.get(0)));
            let c = 0;
            e:for (; ;) {
                if (a++, !n.isValid()) return Yi.trivialTimedOut(i, r);
                const e = -Math.min(a, r.length + a % 2), t = Math.min(a, i.length + a % 2);
                for (c = e; c <= t; c += 2) {
                    const n = c === t ? -1 : s.get(c + 1), a = c === e ? -1 : s.get(c - 1) + 1,
                        h = Math.min(Math.max(n, a), i.length), d = h - c;
                    if (h > i.length || d > r.length) continue;
                    const u = o(h, d);
                    s.set(c, u);
                    const m = h === n ? l.get(c + 1) : l.get(c - 1);
                    if (l.set(c, u !== h ? new sr(m, h, d, u - h) : m), s.get(c) === i.length && s.get(c) - c === r.length) break e
                }
            }
            let h = l.get(c);
            const d = [];
            ...
            for (; ;) {
                ...
                if (e === u && t === m || d.push(new Qi(new vi(e, u), new vi(t, m))), !h) break;
                u = h.x, m = h.y, h = h.prev
            }
            return d.reverse(), new Yi(d, !1)
        }
    }
    ...
    class hr {
        ...
        get text() {
            return this.getText(new vi(0, this.length))
        }
        ...
        getBoundaryScore(e) {
            const t = gr(e > 0 ? this.elements[e - 1] : -1), n = gr(e < this.elements.length ? this.elements[e] : -1);
            if (7 === t && 8 === n) return 0;
            if (8 === t) return 150;
            let i = 0;
            return t !== n && (i += 10, 0 === t && 1 === n && (i += 1)), i += pr(t), i += pr(n), i
        }

        translateOffset(e, t = "right") {
            const n = Ti(this.firstElementOffsetByLineIdx, t => t <= e), i = e - this.firstElementOffsetByLineIdx[n];
            return new Ee(this.range.startLineNumber + n, 1 + this.lineStartOffsets[n] + i + (0 === i && "left" === t ? 0 : this.trimmedWsLengthsByLineIdx[n]))
        }

        translateRange(e) {
            const t = this.translateOffset(e.start, "right"), n = this.translateOffset(e.endExclusive, "left");
            return n.isBefore(t) ? Ae.fromPositions(n, n) : Ae.fromPositions(t, n)
        }

        findWordContaining(e) {
            if (e < 0 || e >= this.elements.length) return;
            if (!dr(this.elements[e])) return;
            let t = e;
            for (; t > 0 && dr(this.elements[t - 1]);) t--;
            let n = e;
            for (; n < this.elements.length && dr(this.elements[n]);) n++;
            return new vi(t, n)
        }
        ...
        findSubWordContaining(e) {
            ...
            if (!dr(this.elements[e])) return;
            let t = e;
            for (; t > 0 && dr(this.elements[t - 1]) && !ur(this.elements[t]);) t--;
            let n = e;
            for (; n < this.elements.length && dr(this.elements[n]) && !ur(this.elements[n]);) n++;
            return new vi(t, n)
        }
        ...
        extendToFullLines(e) {
            const t = yi(this.firstElementOffsetByLineIdx, t => t <= e.start) ?? 0, n = function (e, t) {
                const n = ki(e, t);
    ...
    const mr = {0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10};
    ...
    function gr(e) {
        return 10 === e ? 8 : 13 === e ? 7 : ir(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : -1 === e ? 3 : 44 === e || 59 === e ? 5 : 4
    }

    function fr(e, t, n, i, r, o) {
        let {moves: a, excludedChanges: s} = function (e, t, n, i) {
            const r = [],
                o = e.filter(e => e.modified.isEmpty && e.original.length >= 3).map(e => new rr(e.original, t, e)),
                a = new Set(e.filter(e => e.original.isEmpty && e.modified.length >= 3).map(e => new rr(e.modified, n, e))),
                s = new Set;
            for (const l of o) {
                let e, t = -1;
                for (const n of a) {
                ...
                if (t > .9 && e && (a.delete(e), r.push(new Oi(l.range, e.range)), s.add(l.source), s.add(e.source)), !i.isValid()) return {
                    moves: r,
                    excludedChanges: s
                }
            }
            return {moves: r, excludedChanges: s}
        }(e, t, n, o);
        if (!o.isValid()) return [];
        const l = function (e, t, n, i, r, o) {
            ...
            for (const m of e) for (let e = m.original.startLineNumber; e < m.original.endLineNumberExclusive - 2; e++) {
                ...
                s.add(n, {range: new Li(e, e + 3)})
            }
            const l = [];
            e.sort(bi(e => e.modified.startLineNumber, _i));
            for (const m of e) {
                let e = [];
                for (let t = m.modified.startLineNumber; t < m.modified.endLineNumberExclusive - 2; t++) {
                    const i = `${n[t - 1]}:${n[t + 1 - 1]}:${n[t + 2 - 1]}`, r = new Li(t, t + 3), o = [];
                    s.forEach(i, ({range: t}) => {
                        for (const i of e) if (i.originalLineRange.endLineNumberExclusive + 1 === t.endLineNumberExclusive && i.modifiedLineRange.endLineNumberExclusive + 1 === r.endLineNumberExclusive) return i.originalLineRange = new Li(i.originalLineRange.startLineNumber, t.endLineNumberExclusive), i.modifiedLineRange = new Li(i.modifiedLineRange.startLineNumber, r.endLineNumberExclusive), void o.push(i);
                        const n = {modifiedLineRange: r, originalLineRange: t};
                        l.push(n), o.push(n)
                    }), e = o
                }
                if (!o.isValid()) return []
            }
            l.sort((c = bi(e => e.modifiedLineRange.length, _i), (e, t) => -c(e, t)));
            var c;
            const h = new xi, d = new xi;
            for (const m of l) {
                const e = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber,
                    t = h.subtractFrom(m.modifiedLineRange), n = d.subtractFrom(m.originalLineRange).getWithDelta(e),
                    i = t.getIntersection(n);
                for (const r of i.ranges) {
                    if (r.length < 3) continue;
                    const t = r, n = r.delta(-e);
                    a.push(new Oi(n, t)), h.addRange(t), d.addRange(n)
                }
            }
            a.sort(bi(e => e.original.startLineNumber, _i));
            const u = new Si(e);
            for (let m = 0; m < a.length; m++) {
                const t = a[m], n = u.findLastMonotonous(e => e.original.startLineNumber <= t.original.startLineNumber),
                    s = yi(e, e => e.modified.startLineNumber <= t.modified.startLineNumber),
                    l = Math.max(t.original.startLineNumber - n.original.startLineNumber, t.modified.startLineNumber - s.modified.startLineNumber),
                    c = u.findLastMonotonous(e => e.original.startLineNumber < t.original.endLineNumberExclusive),
                    p = yi(e, e => e.modified.startLineNumber < t.modified.endLineNumberExclusive),
                    g = Math.max(c.original.endLineNumberExclusive - t.original.endLineNumberExclusive, p.modified.endLineNumberExclusive - t.modified.endLineNumberExclusive);
                let f, b;
                for (f = 0; f < l; f++) {
                    ...
                    if (!br(i[e - 1], r[n - 1], o)) break
                }
                for (f > 0 && (d.addRange(new Li(t.original.startLineNumber - f, t.original.startLineNumber)), h.addRange(new Li(t.modified.startLineNumber - f, t.modified.startLineNumber))), b = 0; b < g; b++) {
                    const e = t.original.endLineNumberExclusive + b, n = t.modified.endLineNumberExclusive + b;
                    if (e > i.length || n > r.length) break;
                    if (h.contains(n) || d.contains(e)) break;
                    if (!br(i[e - 1], r[n - 1], o)) break
                }
                b > 0 && (d.addRange(new Li(t.original.endLineNumberExclusive, t.original.endLineNumberExclusive + b)), h.addRange(new Li(t.modified.endLineNumberExclusive, t.modified.endLineNumberExclusive + b))), (f > 0 || b > 0) && (a[m] = new Oi(new Li(t.original.startLineNumber - f, t.original.endLineNumberExclusive + b), new Li(t.modified.startLineNumber - f, t.modified.endLineNumberExclusive + b)))
            }
            return a
        ...
        return function (e, t) {
            ...
            e.sort(bi(e => e.original.startLineNumber, _i));
            const t = [e[0]];
            for (let n = 1; n < e.length; n++) {
                const i = t[t.length - 1], r = e[n], o = r.original.startLineNumber - i.original.endLineNumberExclusive,
            ...
            const n = new Si(e);
            return t = t.filter(t => (n.findLastMonotonous(e => e.original.startLineNumber < t.original.endLineNumberExclusive) || new Oi(new Li(1, 1), new Li(1, 1))) !== yi(e, e => e.modified.startLineNumber < t.modified.endLineNumberExclusive)), t
        }(e, a), a
    }
    ...
    function br(e, t, n) {
        ...
        const i = (new ar).compute(new hr([e], new Ae(1, 1, 1, e.length), !1), new hr([t], new Ae(1, 1, 1, t.length), !1), n);
        let r = 0;
        const o = Qi.invert(i.diffs, e.length);
        for (const s of o) s.seq1Range.forEach(t => {
            ir(e.charCodeAt(t)) || r++
        });
        const a = function (t) {
            let n = 0;
            for (let i = 0; i < e.length; i++) ir(t.charCodeAt(i)) || n++;
            return n
    ...
    function _r(e, t, n) {
        let i = n;
        return i = wr(e, t, i), i = wr(e, t, i), i = function (e, t, n) {
            if (!e.getBoundaryScore || !t.getBoundaryScore) return n;
            for (let i = 0; i < n.length; i++) {
                const r = i > 0 ? n[i - 1] : void 0, o = n[i], a = i + 1 < n.length ? n[i + 1] : void 0,
                    s = new vi(r ? r.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : e.length),
                    l = new vi(r ? r.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : t.length);
                o.seq1Range.isEmpty ? n[i] = vr(o, e, t, s, l) : o.seq2Range.isEmpty && (n[i] = vr(o.swap(), t, e, l, s).swap())
            }
            return n
        }(e, t, i), i
    }
    ...
    function wr(e, t, n) {
        ...
        for (let o = 1; o < n.length; o++) {
            ...
            if (a.seq1Range.isEmpty || a.seq2Range.isEmpty) {
                ...
                if (o--, o === n) {
                    i[i.length - 1] = new Qi(new vi(r.seq1Range.start, a.seq1Range.endExclusive - n), new vi(r.seq2Range.start, a.seq2Range.endExclusive - n));
                    continue
                }
                a = a.delta(-o)
            }
        ...
        for (let o = 0; o < i.length - 1; o++) {
            ...
            if (a.seq1Range.isEmpty || a.seq2Range.isEmpty) {
                ...
                if (s === r) {
                    i[o + 1] = new Qi(new vi(a.seq1Range.start + r, n.seq1Range.endExclusive), new vi(a.seq2Range.start + r, n.seq2Range.endExclusive));
                    continue
                }
                s > 0 && (a = a.delta(s))
            }
    ...
    function vr(e, t, n, i, r) {
        ...
        let s = 0, l = -1;
        for (let c = -o; c <= a; c++) {
            const i = e.seq2Range.start + c, r = e.seq2Range.endExclusive + c, o = e.seq1Range.start + c,
                a = t.getBoundaryScore(o) + n.getBoundaryScore(i) + n.getBoundaryScore(r);
            a > l && (l = a, s = c)
        }
        return e.delta(s)
    }

    function yr(e, t, n, i, r = !1) {
        const o = Qi.invert(n, e.length), a = [];
        let s = new Zi(0, 0);
        ...
        function l(n, l) {
            ...
            for (; o.length > 0;) {
                ...
                const r = i(e, n.seq1Range.start), a = i(t, n.seq2Range.start), s = new Qi(r, a), l = s.intersect(n);
                if (m += l.seq1Range.length, p += l.seq2Range.length, d = d.join(s), !(d.seq1Range.endExclusive >= n.seq1Range.endExclusive)) break;
                o.shift()
            }
    ...
    class Tr {
        ...
        getBoundaryScore(e) {
            return 1e3 - ((0 === e ? 0 : kr(this.lines[e - 1])) + (e === this.lines.length ? 0 : kr(this.lines[e])))
        }
    ...
    class Sr {
        constructor() {
            this.dynamicProgrammingDiffing = new or, this.myersDiffingAlgorithm = new ar
        }
        ...
        computeDiff(e, t, n) {
            if (e.length <= 1 && function (e, t, n = (e, t) => e === t) {
                ...
                return !0
            }(e, t, (e, t) => e === t)) return new pi([], [], !1);
            if (1 === e.length && 0 === e[0].length || 1 === t.length && 0 === t[0].length) return new pi([new Di(new Li(1, e.length + 1), new Li(1, t.length + 1), [new Wi(new Ae(1, 1, e.length, e[e.length - 1].length + 1), new Ae(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
            const i = 0 === n.maxComputationTimeMs ? er.instance : new tr(n.maxComputationTimeMs),
                r = !n.ignoreTrimWhitespace, o = new Map;
            ...
            const s = e.map(e => a(e.trim())), c = t.map(e => a(e.trim())), h = new Tr(s, e), d = new Tr(c, t),
                u = (() => h.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, d, i, (n, i) => e[n] === t[i] ? 0 === t[i].length ? .1 : 1 + Math.log(1 + t[i].length) : .99) : this.myersDiffingAlgorithm.compute(h, d, i))();
            let m = u.diffs, p = u.hitTimeout;
            m = _r(h, d, m), m = function (e, t, n) {
                let i = n;
                ...
                do {
                    ...
                    for (let s = 1; s < i.length; s++) {
                        ...
                        function h(t, n) {
                            const i = new vi(c.seq1Range.endExclusive, l.seq1Range.start);
            ...
            const g = [], f = o => {
                if (r) for (let a = 0; a < o; a++) {
                    const o = b + a, s = _ + a;
                    if (e[o] !== t[s]) {
                        const a = this.refineDiff(e, t, new Qi(new vi(o, o + 1), new vi(s, s + 1)), i, r, n);
            ...
            let b = 0, _ = 0;
            for (const k of m) {
                l(() => k.seq1Range.start - b === k.seq2Range.start - _);
                f(k.seq1Range.start - b), b = k.seq1Range.endExclusive, _ = k.seq2Range.endExclusive;
                const o = this.refineDiff(e, t, k, i, r, n);
                o.hitTimeout && (p = !0);
                for (const e of o.mappings) g.push(e)
            }
            f(e.length - b);
            const w = new Ii(e), v = new Ii(t), y = Pi(g, w, v);
            let T = [];
            return n.computeMoves && (T = this.computeMoves(y, e, t, s, c, i, r, n)), l(() => {
                function n(e, t) {
        ...
        computeMoves(e, t, n, i, r, o, a, s) {
            return fr(e, t, n, i, r, o).map(e => {
                const i = Pi(this.refineDiff(t, n, new Qi(e.original.toOffsetRange(), e.modified.toOffsetRange()), o, a, s).mappings, new Ii(t), new Ii(n), !0);
                return new gi(e, i)
            })
        }
        ...
        refineDiff(e, t, n, i, r, o) {
            var a;
            const s = new Oi(new Li((a = n).seq1Range.start + 1, a.seq1Range.endExclusive + 1), new Li(a.seq2Range.start + 1, a.seq2Range.endExclusive + 1)).toRangeMapping2(e, t),
                l = new hr(e, s.originalRange, r), c = new hr(t, s.modifiedRange, r),
                h = l.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(l, c, i) : this.myersDiffingAlgorithm.compute(l, c, i);
            let d = h.diffs;
            d = _r(l, c, d), d = yr(l, c, d, (e, t) => e.findWordContaining(t)), o.extendToSubwords && (d = yr(l, c, d, (e, t) => e.findSubWordContaining(t), !0)), d = function (e, t, n) {
                const i = [];
                for (const r of n) {
                    const e = i[i.length - 1];
                    e && (r.seq1Range.start - e.seq1Range.endExclusive <= 2 || r.seq2Range.start - e.seq2Range.endExclusive <= 2) ? i[i.length - 1] = new Qi(e.seq1Range.join(r.seq1Range), e.seq2Range.join(r.seq2Range)) : i.push(r)
                }
                return i
                ...
                do {
                    ...
                    for (let l = 1; l < i.length; l++) {
                        ...
                        function d(n, i) {
                            const r = new vi(h.seq1Range.endExclusive, c.seq1Range.start);
                            if (e.countLinesIn(r) > 5 || r.length > 500) return !1;
                            const o = e.getText(r).trim();
                            if (o.length > 20 || o.split(/\r\n|\r|\n/).length > 1) return !1;
                            const a = e.countLinesIn(n.seq1Range), s = n.seq1Range.length,
                                l = t.countLinesIn(n.seq2Range), d = n.seq2Range.length,
                                u = e.countLinesIn(i.seq1Range), m = i.seq1Range.length,
                                p = t.countLinesIn(i.seq2Range), g = i.seq2Range.length;
                ...
                return function (e, t) {
                    ...
                    const s = e.extendToFullLines(n.seq1Range), l = e.getText(new vi(s.start, n.seq1Range.start));
                    o(l) && (r = r.deltaStart(-l.length));
                    const c = e.getText(new vi(n.seq1Range.endExclusive, s.endExclusive));
                    o(c) && (r = r.deltaEnd(c.length));
                    const h = Qi.fromOffsetPairs(t ? t.getEndExclusives() : Zi.zero, i ? i.getStarts() : Zi.max),
                        d = r.intersect(h);
                    a.length > 0 && d.getStarts().equals(a[a.length - 1].getEndExclusives()) ? a[a.length - 1] = a[a.length - 1].join(d) : a.push(d)
                }), a
            }(l, c, d);
            return {
                mappings: d.map(e => new Wi(l.translateRange(e.seq1Range), c.translateRange(e.seq2Range))),
                hitTimeout: h.hitTimeout
            }
        }
    }

    const Lr = () => new qi, xr = () => new Sr;
    ...
    class Ar {
        ...
        static fromRGBA(e) {
            const t = e.r / 255, n = e.g / 255, i = e.b / 255, r = e.a, o = Math.max(t, n, i), a = Math.min(t, n, i);
            let s = 0, l = 0;
            const c = (a + o) / 2, h = o - a;
            if (h > 0) {
        ...
        static toRGBA(e) {
            const t = e.h / 360, {s: n, l: i, a: r} = e;
            let o, a, s;
            if (0 === n) o = a = s = i; else {
                const e = i < .5 ? i * (1 + n) : i + n - i * n, r = 2 * i - e;
                o = Ar._hue2rgb(r, e, t + 1 / 3), a = Ar._hue2rgb(r, e, t), s = Ar._hue2rgb(r, e, t - 1 / 3)
            }
            return new Er(Math.round(255 * o), Math.round(255 * a), Math.round(255 * s), r)
        }
    }
    ...
    class Rr {
        ...
        static fromRGBA(e) {
            const t = e.r / 255, n = e.g / 255, i = e.b / 255, r = Math.max(t, n, i), o = r - Math.min(t, n, i),
                a = 0 === r ? 0 : o / r;
            let s;
            return s = 0 === o ? 0 : r === t ? ((n - i) / o % 6 + 6) % 6 : r === n ? (i - t) / o + 2 : (t - n) / o + 4, new Rr(Math.round(60 * s), a, r, e.a)
        }
    ...
    let Mr = class e {
        ...
        constructor(e) {
            ...
            if (e instanceof Er) this.rgba = e; else if (e instanceof Ar) this._hsla = e, this.rgba = Ar.toRGBA(e); else {
        ...
        mix(t, n = .5) {
            const i = Math.min(Math.max(n, 0), 1), r = this.rgba, o = t.rgba, a = r.r + (o.r - r.r) * i,
                s = r.g + (o.g - r.g) * i, l = r.b + (o.b - r.b) * i, c = r.a + (o.a - r.a) * i;
            return new e(new Er(a, s, l, c))
        }
    ...
    function Or(e, t) {
        ...
        return n ? {range: e, color: Ir(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)} : void 0
    }

    function Hr(e, t, n) {
        if (!e || 1 !== t.length) return;
        const i = Nr(t[0].values());
        return {range: e, color: Ir(i[0], i[1], i[2], n ? i[3] : 1)}
    }

    function Ur(e, t, n) {
        if (!e || 1 !== t.length) return;
        const i = Nr(t[0].values()), r = new Mr(new Ar(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
        return {range: e, color: Ir(r.rgba.r, r.rgba.g, r.rgba.b, r.rgba.a)}
    }
    ...
    function Wr(e) {
        return e && "function" == typeof e.getValue && "function" == typeof e.positionAt ? function (e) {
            const t = [],
                n = Dr(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|^(#)([A-Fa-f0-9]{3})\b|^(#)([A-Fa-f0-9]{4})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b|(?<=['"\s])(#)([A-Fa-f0-9]{3})\b|(?<=['"\s])(#)([A-Fa-f0-9]{4})\b|(?<=['"\s])(#)([A-Fa-f0-9]{6})\b|(?<=['"\s])(#)([A-Fa-f0-9]{8})\b/gm);
            if (n.length > 0) for (const i of n) {
                ...
                if ("rgb" === r) {
                    ...
                    a = Hr(zr(e, i), Dr(o, t), !0)
                } else if ("hsl" === r) {
                    const t = /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm;
                    a = Ur(zr(e, i), Dr(o, t), !1)
                } else if ("hsla" === r) {
                    const t = /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm;
                    a = Ur(zr(e, i), Dr(o, t), !0)
                } else "#" === r && (a = Or(zr(e, i), r + o));
                a && t.push(a)
            }
            return t
        }(e) : []
        ...
        (function (t) {
            ...
            function i(t) {
                ...
                if (7 === n) {
                    ...
                    return new e(new Er(n, i, o, 1))
                }
                if (9 === n) {
                    const n = 16 * r(t.charCodeAt(1)) + r(t.charCodeAt(2)),
                        i = 16 * r(t.charCodeAt(3)) + r(t.charCodeAt(4)),
                        o = 16 * r(t.charCodeAt(5)) + r(t.charCodeAt(6)),
                        a = 16 * r(t.charCodeAt(7)) + r(t.charCodeAt(8));
                    return new e(new Er(n, i, o, a / 255))
                }
                if (4 === n) {
            ...
            t.formatRGB = function (t) {
                ...
                if (t.startsWith("rgba(")) {
                    ...
                    const i = parseInt(n.groups?.r ?? "0"), r = parseInt(n.groups?.g ?? "0"),
                        o = parseInt(n.groups?.b ?? "0"), a = parseFloat(n.groups?.a ?? "0");
                    return new e(new Er(i, r, o, a))
                }
                if (t.startsWith("rgb(")) {
                    const n = t.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
                    if (!n) throw new Error("Invalid color format " + t);
                    const i = parseInt(n.groups?.r ?? "0"), r = parseInt(n.groups?.g ?? "0"),
                        o = parseInt(n.groups?.b ?? "0");
                    return new e(new Er(i, r, o))
                }
                return function (t) {
                    switch (t) {
                        case"aliceblue":
                            return new e(new Er(240, 248, 255, 1));
                        case"antiquewhite":
                            return new e(new Er(250, 235, 215, 1));
                        case"aqua":
                        case"cyan":
                            return new e(new Er(0, 255, 255, 1));
                        case"aquamarine":
                            return new e(new Er(127, 255, 212, 1));
                        case"azure":
                            return new e(new Er(240, 255, 255, 1));
                        case"beige":
                            return new e(new Er(245, 245, 220, 1));
                        case"bisque":
                            return new e(new Er(255, 228, 196, 1));
                        case"black":
                            return new e(new Er(0, 0, 0, 1));
                        case"blanchedalmond":
                            return new e(new Er(255, 235, 205, 1));
                        case"blue":
                            return new e(new Er(0, 0, 255, 1));
                        case"blueviolet":
                            return new e(new Er(138, 43, 226, 1));
                        case"brown":
                            return new e(new Er(165, 42, 42, 1));
                        case"burlywood":
                            return new e(new Er(222, 184, 135, 1));
                        case"cadetblue":
                            return new e(new Er(95, 158, 160, 1));
                        case"chartreuse":
                            return new e(new Er(127, 255, 0, 1));
                        case"chocolate":
                            return new e(new Er(210, 105, 30, 1));
                        case"coral":
                            return new e(new Er(255, 127, 80, 1));
                        case"cornflowerblue":
                            return new e(new Er(100, 149, 237, 1));
                        case"cornsilk":
                            return new e(new Er(255, 248, 220, 1));
                        case"crimson":
                            return new e(new Er(220, 20, 60, 1));
                        case"darkblue":
                            return new e(new Er(0, 0, 139, 1));
                        case"darkcyan":
                            return new e(new Er(0, 139, 139, 1));
                        case"darkgoldenrod":
                            return new e(new Er(184, 134, 11, 1));
                        case"darkgray":
                        case"darkgrey":
                            return new e(new Er(169, 169, 169, 1));
                        case"darkgreen":
                            return new e(new Er(0, 100, 0, 1));
                        case"darkkhaki":
                            return new e(new Er(189, 183, 107, 1));
                        case"darkmagenta":
                            return new e(new Er(139, 0, 139, 1));
                        case"darkolivegreen":
                            return new e(new Er(85, 107, 47, 1));
                        case"darkorange":
                            return new e(new Er(255, 140, 0, 1));
                        case"darkorchid":
                            return new e(new Er(153, 50, 204, 1));
                        case"darkred":
                            return new e(new Er(139, 0, 0, 1));
                        case"darksalmon":
                            return new e(new Er(233, 150, 122, 1));
                        case"darkseagreen":
                            return new e(new Er(143, 188, 143, 1));
                        case"darkslateblue":
                            return new e(new Er(72, 61, 139, 1));
                        case"darkslategray":
                        case"darkslategrey":
                            return new e(new Er(47, 79, 79, 1));
                        case"darkturquoise":
                            return new e(new Er(0, 206, 209, 1));
                        case"darkviolet":
                            return new e(new Er(148, 0, 211, 1));
                        case"deeppink":
                            return new e(new Er(255, 20, 147, 1));
                        case"deepskyblue":
                            return new e(new Er(0, 191, 255, 1));
                        case"dimgray":
                        case"dimgrey":
                            return new e(new Er(105, 105, 105, 1));
                        case"dodgerblue":
                            return new e(new Er(30, 144, 255, 1));
                        case"firebrick":
                            return new e(new Er(178, 34, 34, 1));
                        case"floralwhite":
                            return new e(new Er(255, 250, 240, 1));
                        case"forestgreen":
                            return new e(new Er(34, 139, 34, 1));
                        case"fuchsia":
                        case"magenta":
                            return new e(new Er(255, 0, 255, 1));
                        case"gainsboro":
                            return new e(new Er(220, 220, 220, 1));
                        case"ghostwhite":
                            return new e(new Er(248, 248, 255, 1));
                        case"gold":
                            return new e(new Er(255, 215, 0, 1));
                        case"goldenrod":
                            return new e(new Er(218, 165, 32, 1));
                        case"gray":
                        case"grey":
                            return new e(new Er(128, 128, 128, 1));
                        case"green":
                            return new e(new Er(0, 128, 0, 1));
                        case"greenyellow":
                            return new e(new Er(173, 255, 47, 1));
                        case"honeydew":
                            return new e(new Er(240, 255, 240, 1));
                        case"hotpink":
                            return new e(new Er(255, 105, 180, 1));
                        case"indianred":
                            return new e(new Er(205, 92, 92, 1));
                        case"indigo":
                            return new e(new Er(75, 0, 130, 1));
                        case"ivory":
                            return new e(new Er(255, 255, 240, 1));
                        case"khaki":
                            return new e(new Er(240, 230, 140, 1));
                        case"lavender":
                            return new e(new Er(230, 230, 250, 1));
                        case"lavenderblush":
                            return new e(new Er(255, 240, 245, 1));
                        case"lawngreen":
                            return new e(new Er(124, 252, 0, 1));
                        case"lemonchiffon":
                            return new e(new Er(255, 250, 205, 1));
                        case"lightblue":
                            return new e(new Er(173, 216, 230, 1));
                        case"lightcoral":
                            return new e(new Er(240, 128, 128, 1));
                        case"lightcyan":
                            return new e(new Er(224, 255, 255, 1));
                        case"lightgoldenrodyellow":
                            return new e(new Er(250, 250, 210, 1));
                        case"lightgray":
                        case"lightgrey":
                            return new e(new Er(211, 211, 211, 1));
                        case"lightgreen":
                            return new e(new Er(144, 238, 144, 1));
                        case"lightpink":
                            return new e(new Er(255, 182, 193, 1));
                        case"lightsalmon":
                            return new e(new Er(255, 160, 122, 1));
                        case"lightseagreen":
                            return new e(new Er(32, 178, 170, 1));
                        case"lightskyblue":
                            return new e(new Er(135, 206, 250, 1));
                        case"lightslategray":
                        case"lightslategrey":
                            return new e(new Er(119, 136, 153, 1));
                        case"lightsteelblue":
                            return new e(new Er(176, 196, 222, 1));
                        case"lightyellow":
                            return new e(new Er(255, 255, 224, 1));
                        case"lime":
                            return new e(new Er(0, 255, 0, 1));
                        case"limegreen":
                            return new e(new Er(50, 205, 50, 1));
                        case"linen":
                            return new e(new Er(250, 240, 230, 1));
                        case"maroon":
                            return new e(new Er(128, 0, 0, 1));
                        case"mediumaquamarine":
                            return new e(new Er(102, 205, 170, 1));
                        case"mediumblue":
                            return new e(new Er(0, 0, 205, 1));
                        case"mediumorchid":
                            return new e(new Er(186, 85, 211, 1));
                        case"mediumpurple":
                            return new e(new Er(147, 112, 219, 1));
                        case"mediumseagreen":
                            return new e(new Er(60, 179, 113, 1));
                        case"mediumslateblue":
                            return new e(new Er(123, 104, 238, 1));
                        case"mediumspringgreen":
                            return new e(new Er(0, 250, 154, 1));
                        case"mediumturquoise":
                            return new e(new Er(72, 209, 204, 1));
                        case"mediumvioletred":
                            return new e(new Er(199, 21, 133, 1));
                        case"midnightblue":
                            return new e(new Er(25, 25, 112, 1));
                        case"mintcream":
                            return new e(new Er(245, 255, 250, 1));
                        case"mistyrose":
                            return new e(new Er(255, 228, 225, 1));
                        case"moccasin":
                            return new e(new Er(255, 228, 181, 1));
                        case"navajowhite":
                            return new e(new Er(255, 222, 173, 1));
                        case"navy":
                            return new e(new Er(0, 0, 128, 1));
                        case"oldlace":
                            return new e(new Er(253, 245, 230, 1));
                        case"olive":
                            return new e(new Er(128, 128, 0, 1));
                        case"olivedrab":
                            return new e(new Er(107, 142, 35, 1));
                        case"orange":
                            return new e(new Er(255, 165, 0, 1));
                        case"orangered":
                            return new e(new Er(255, 69, 0, 1));
                        case"orchid":
                            return new e(new Er(218, 112, 214, 1));
                        case"palegoldenrod":
                            return new e(new Er(238, 232, 170, 1));
                        case"palegreen":
                            return new e(new Er(152, 251, 152, 1));
                        case"paleturquoise":
                            return new e(new Er(175, 238, 238, 1));
                        case"palevioletred":
                            return new e(new Er(219, 112, 147, 1));
                        case"papayawhip":
                            return new e(new Er(255, 239, 213, 1));
                        case"peachpuff":
                            return new e(new Er(255, 218, 185, 1));
                        case"peru":
                            return new e(new Er(205, 133, 63, 1));
                        case"pink":
                            return new e(new Er(255, 192, 203, 1));
                        case"plum":
                            return new e(new Er(221, 160, 221, 1));
                        case"powderblue":
                            return new e(new Er(176, 224, 230, 1));
                        case"purple":
                            return new e(new Er(128, 0, 128, 1));
                        case"rebeccapurple":
                            return new e(new Er(102, 51, 153, 1));
                        case"red":
                            return new e(new Er(255, 0, 0, 1));
                        case"rosybrown":
                            return new e(new Er(188, 143, 143, 1));
                        case"royalblue":
                            return new e(new Er(65, 105, 225, 1));
                        case"saddlebrown":
                            return new e(new Er(139, 69, 19, 1));
                        case"salmon":
                            return new e(new Er(250, 128, 114, 1));
                        case"sandybrown":
                            return new e(new Er(244, 164, 96, 1));
                        case"seagreen":
                            return new e(new Er(46, 139, 87, 1));
                        case"seashell":
                            return new e(new Er(255, 245, 238, 1));
                        case"sienna":
                            return new e(new Er(160, 82, 45, 1));
                        case"silver":
                            return new e(new Er(192, 192, 192, 1));
                        case"skyblue":
                            return new e(new Er(135, 206, 235, 1));
                        case"slateblue":
                            return new e(new Er(106, 90, 205, 1));
                        case"slategray":
                        case"slategrey":
                            return new e(new Er(112, 128, 144, 1));
                        case"snow":
                            return new e(new Er(255, 250, 250, 1));
                        case"springgreen":
                            return new e(new Er(0, 255, 127, 1));
                        case"steelblue":
                            return new e(new Er(70, 130, 180, 1));
                        case"tan":
                            return new e(new Er(210, 180, 140, 1));
                        case"teal":
                            return new e(new Er(0, 128, 128, 1));
                        case"thistle":
                            return new e(new Er(216, 191, 216, 1));
                        case"tomato":
                            return new e(new Er(255, 99, 71, 1));
                        case"turquoise":
                            return new e(new Er(64, 224, 208, 1));
                        case"violet":
                            return new e(new Er(238, 130, 238, 1));
                        case"wheat":
                            return new e(new Er(245, 222, 179, 1));
                        case"white":
                            return new e(new Er(255, 255, 255, 1));
                        case"whitesmoke":
                            return new e(new Er(245, 245, 245, 1));
                        case"yellow":
                            return new e(new Er(255, 255, 0, 1));
                        case"yellowgreen":
                            return new e(new Er(154, 205, 50, 1));
                        default:
                            return null
                    }
                }(t)
    ...
    function Fr(e, t) {
                ...
                for (let r = 1; r <= i; r++) {
                    ...
                    if (o) {
                        ...
                        if (e.endColumn > e.startColumn) {
                            const t = {range: e, ...Vr(i.substring(o[0].length)), shouldBeInComments: !1};
        ...
        if (t.findMarkSectionHeaders) {
            const i = function (e, t) {
                ...
                if (a = o, "^" !== a.source && "^$" !== a.source && "$" !== a.source && "^\\s*$" !== a.source && a.exec("") && 0 === a.lastIndex) return n;
                var a;
                for (let s = 1; s <= i; s += 95) {
                    const t = Math.min(s + qr - 1, i), r = [];
                    ...
                    for (o.lastIndex = 0; null !== (l = o.exec(a));) {
                        ...
                        (m.text || m.hasSeparatorLine) && (0 === n.length || n[n.length - 1].range.endLineNumber < m.range.startLineNumber) && n.push(m), o.lastIndex = l.index + l[0].length
                    }
                }
                return n
            }(e, t);
    ...
    function Vr(e) {
        ...
        return {text: e = e.replace(Pr, ""), hasSeparatorLine: t}
    }
    ...
    class Gr {
        constructor(e, t) {
            this._onReturn = t, this._producerConsumer = new jr, this._iterator = {
                next: () => this._producerConsumer.consume(),
                return: () => (this._onReturn?.(), Promise.resolve({done: !0, value: void 0})),
                throw: async e => (this._finishError(e), {done: !0, value: void 0})
            }, queueMicrotask(async () => {
                const t = e({
                    emitOne: e => this._producerConsumer.produce({ok: !0, value: {done: !1, value: e}}),
                    emitMany: e => {
                        for (const t of e) this._producerConsumer.produce({ok: !0, value: {done: !1, value: t}})
                    },
        ...
        static {
            this.EMPTY = Gr.fromArray([])
        }

        static map(e, t) {
            return new Gr(async n => {
                for await(const i of e) n.emitOne(t(i))
            })
        }

        map(e) {
            return Gr.map(this, e)
        }

        static coalesce(e) {
            return Gr.filter(e, e => !!e)
        }

        coalesce() {
            return Gr.coalesce(this)
        }

        static filter(e, t) {
            return new Gr(async n => {
                for await(const i of e) t(i) && n.emitOne(i)
            })
        }

        filter(e) {
            return Gr.filter(this, e)
        }
    ...
    class $r {
        ...
        setValue(e, t) {
            return e = Me(e), t = Me(t), this.values[e] !== t && (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0)
        }
        ...
        getPrefixSum(e) {
            return e < 0 ? 0 : (e = Me(e), this._getPrefixSum(e))
        }
        ...
        getIndexOf(e) {
            ...
            for (; t <= n;) if (i = t + (n - t) / 2 | 0, r = this.prefixSum[i], o = r - this.values[i], e < o) n = i - 1; else {
                if (!(e >= r)) break;
                t = i + 1
            }
            return new Xr(i, e - o)
    ...
    class Jr {
        ...
        onEvents(e) {
            ...
            const t = e.changes;
            for (const n of t) this._acceptDeleteRange(n.range), this._acceptInsertText(new Ee(n.range.startLineNumber, n.range.startColumn), n.text);
    ...
    class Yr {
        ...
        $acceptNewModel(e) {
            this._models[e.url] = new Qr(St.parse(e.url), e.lines, e.EOL, e.versionId)
        }
    ...
    class Qr extends Jr {
        ...
        findMatches(e) {
            ...
            for (let n = 0; n < this._lines.length; n++) {
                const i = this._lines[n], r = this.offsetAt(new Ee(n + 1, 1)), o = i.matchAll(e);
        ...
        getWordAtPosition(e, t) {
            const n = ci(e.column, si(t), this._lines[e.lineNumber - 1], 0);
            return n ? new Ae(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null
        }
    ...
    class Zr {
        constructor(e = null) {
            this._foreignModule = e, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new Yr
        }
        ...
        async $computeUnicodeHighlights(e, t, n) {
            ...
            return i ? di.computeUnicodeHighlights(i, t, n) : {
                ranges: [],
                hasMore: !1,
        ...
        async $computeDiff(e, t, n, i) {
            ...
            if (!r || !o) return null;
            return Zr.computeDiff(r, o, n, i)
        }

        static computeDiff(e, t, n, i) {
            const r = "advanced" === i ? xr() : Lr(), o = e.getLinesContent(), a = t.getLinesContent(),
                s = r.computeDiff(o, a, n);
            ...
            return {
                ...
                changes: l(s.changes),
                moves: s.moves.map(e => [e.lineRangeMapping.original.startLineNumber, e.lineRangeMapping.original.endLineNumberExclusive, e.lineRangeMapping.modified.startLineNumber, e.lineRangeMapping.modified.endLineNumberExclusive, l(e.changes)])
            }
        }
        ...
        async $computeMoreMinimalEdits(e, t, n) {
            ...
            t = t.slice(0).sort((e, t) => {
                if (e.range && t.range) return Ae.compareRangesUsingStarts(e.range, t.range);
                return (e.range ? 0 : 1) - (t.range ? 0 : 1)
            });
            let a = 0;
            for (let s = 1; s < t.length; s++) Ae.getEndPosition(t[a].range).equals(Ae.getStartPosition(t[s].range)) ? (t[a].range = Ae.fromPositions(Ae.getStartPosition(t[a].range), Ae.getEndPosition(t[s].range)), t[a].text += t[s].text) : (a++, t[a] = t[s]);
            t.length = a + 1;
            for (let {range: s, text: l, eol: c} of t) {
                if ("number" == typeof c && (o = c), Ae.isEmpty(s) && !l) continue;
                const e = i.getValueInRange(s);
                if (l = l.replace(/\r\n|\n|\r/g, i.eol), e === l) continue;
                if (Math.max(l.length, e.length) > Zr._diffLimit) {
                    r.push({range: s, text: l});
                    continue
                }
                const t = ke(e, l, n), a = i.offsetAt(Ae.lift(s).getStartPosition());
                for (const n of t) {
                    const e = i.positionAt(a + n.originalStart),
                        t = i.positionAt(a + n.originalStart + n.originalLength), o = {
        ...
        async $textualSuggest(e, t, n, i) {
            const r = new v, o = new RegExp(n, i), a = new Set;
            e:for (const s of e) {
                const e = this._getModel(s);
                if (e) for (const n of e.words(o)) if (n !== t && isNaN(Number(n)) && (a.add(n), a.size > Zr._suggestionsLimit)) break e
            }
        ...
        async $navigateValueSet(e, t, n, i, r) {
            ...
            return De.INSTANCE.navigateValueSet(t, s, l, c, n)
        }
    ...
    class eo {
        ...
        static getChannel(e) {
            return e.getChannel(eo.CHANNEL_NAME)
        }

        static setChannel(e, t) {
            e.setChannel(eo.CHANNEL_NAME, t)
        }
    }
    ...
    function to(e) {
        ...
        const n = function (e) {
            ...
            _e = !0;
            const t = new be(e => globalThis.postMessage(e), t => e(t));
            return globalThis.onmessage = e => {
                t.onmessage(e.data)
            }, t
        }(i => {
            const r = eo.getChannel(i), o = new Proxy({}, {
                get(e, t, n) {
                    if ("then" !== t) {
            ...
            return t = e({host: o, getMirrorModels: () => n.requestHandler.getModels()}), new Zr(t)
        });
        return t
    }
    ...
    function no(...e) {
        const t = e[0];
        let n, i, r;
        if ("string" == typeof t) n = t, i = t, e.splice(0, 1), r = e && "object" == typeof e[0] ? e[0] : e; else {
        ...
        return function (e, t) {
            ...
            return e.replace(Aa, (e, n) => t[n] ?? e)
        }(i, r)
    }

    var io, ro, oo, ao, so, lo, co, ho, uo, mo, po, go, fo, bo, _o, wo, vo, yo, To, ko, So, Lo, xo, Co, Eo, Ao, Ro, Mo,
        No, Io, zo, Oo, Ho, Uo, Do, Wo, Po, qo, Fo, Vo, Bo, Ko, jo, Go, $o, Xo, Jo, Yo, Qo, Zo, ea, ta, na, ia, ra, oa,
        aa, sa, la, ca, ha, da, ua, ma, pa, ga, fa, ba, _a, wa, va, ya, Ta, ka, Sa, La, xa, Ca, Ea, Aa = /{([^}]+)}/g;
    !function (e) {
        e.is = function (e) {
        ...
        e.create = function (e, t) {
            return e === Number.MAX_VALUE && (e = ao.MAX_VALUE), t === Number.MAX_VALUE && (t = ao.MAX_VALUE), {
                line: e,
                character: t
            }
        }, e.is = function (e) {
            let t = e;
            return Ma.objectLiteral(t) && Ma.uinteger(t.line) && Ma.uinteger(t.character)
        }
    }(so || (so = {})), function (e) {
        e.create = function (e, t, n, i) {
            if (Ma.uinteger(e) && Ma.uinteger(t) && Ma.uinteger(n) && Ma.uinteger(i)) return {
                start: so.create(e, t),
                end: so.create(n, i)
            };
            if (so.is(e) && so.is(t)) return {start: e, end: t};
            throw new Error(`Range#create called with invalid arguments[${e}, ${t}, ${n}, ${i}]`)
        }, e.is = function (e) {
            let t = e;
            return Ma.objectLiteral(t) && so.is(t.start) && so.is(t.end)
        }
    }(lo || (lo = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return Ma.objectLiteral(t) && lo.is(t.range) && (Ma.string(t.uri) || Ma.undefined(t.uri))
        }
    }(co || (co = {})), function (e) {
        e.create = function (e, t, n, i) {
            ...
            let t = e;
            return Ma.objectLiteral(t) && lo.is(t.targetRange) && Ma.string(t.targetUri) && lo.is(t.targetSelectionRange) && (lo.is(t.originSelectionRange) || Ma.undefined(t.originSelectionRange))
        }
    }(ho || (ho = {})), function (e) {
        e.create = function (e, t, n, i) {
            ...
            const t = e;
            return Ma.objectLiteral(t) && Ma.numberRange(t.red, 0, 1) && Ma.numberRange(t.green, 0, 1) && Ma.numberRange(t.blue, 0, 1) && Ma.numberRange(t.alpha, 0, 1)
        }
    }(uo || (uo = {})), function (e) {
        e.create = function (e, t) {
            ...
            const t = e;
            return Ma.objectLiteral(t) && lo.is(t.range) && uo.is(t.color)
        }
    }(mo || (mo = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            const t = e;
            return Ma.objectLiteral(t) && Ma.string(t.label) && (Ma.undefined(t.textEdit) || ko.is(t)) && (Ma.undefined(t.additionalTextEdits) || Ma.typedArray(t.additionalTextEdits, ko.is))
        }
    }(po || (po = {})), function (e) {
        ...
        e.create = function (e, t, n, i, r, o) {
            ...
            return Ma.defined(n) && (a.startCharacter = n), Ma.defined(i) && (a.endCharacter = i), Ma.defined(r) && (a.kind = r), Ma.defined(o) && (a.collapsedText = o), a
        }, e.is = function (e) {
            const t = e;
            return Ma.objectLiteral(t) && Ma.uinteger(t.startLine) && Ma.uinteger(t.startLine) && (Ma.undefined(t.startCharacter) || Ma.uinteger(t.startCharacter)) && (Ma.undefined(t.endCharacter) || Ma.uinteger(t.endCharacter)) && (Ma.undefined(t.kind) || Ma.string(t.kind))
        }
    }(fo || (fo = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return Ma.defined(t) && co.is(t.location) && Ma.string(t.message)
        }
    }(bo || (bo = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return Ma.objectLiteral(t) && Ma.string(t.href)
        }
    }(vo || (vo = {})), function (e) {
        e.create = function (e, t, n, i, r, o) {
            let a = {range: e, message: t};
            return Ma.defined(n) && (a.severity = n), Ma.defined(i) && (a.code = i), Ma.defined(r) && (a.source = r), Ma.defined(o) && (a.relatedInformation = o), a
        }, e.is = function (e) {
            var t;
            let n = e;
            return Ma.defined(n) && lo.is(n.range) && Ma.string(n.message) && (Ma.number(n.severity) || Ma.undefined(n.severity)) && (Ma.integer(n.code) || Ma.string(n.code) || Ma.undefined(n.code)) && (Ma.undefined(n.codeDescription) || Ma.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) && (Ma.string(n.source) || Ma.undefined(n.source)) && (Ma.undefined(n.relatedInformation) || Ma.typedArray(n.relatedInformation, bo.is))
        }
    }(yo || (yo = {})), function (e) {
        e.create = function (e, t, ...n) {
            let i = {title: e, command: t};
            return Ma.defined(n) && n.length > 0 && (i.arguments = n), i
        }, e.is = function (e) {
            let t = e;
            return Ma.defined(t) && Ma.string(t.title) && Ma.string(t.command)
        }
    }(To || (To = {})), function (e) {
        e.replace = function (e, t) {
            ...
            const t = e;
            return Ma.objectLiteral(t) && Ma.string(t.newText) && lo.is(t.range)
        }
    }(ko || (ko = {})), function (e) {
        e.create = function (e, t, n) {
            const i = {label: e};
            ...
            const t = e;
            return Ma.objectLiteral(t) && Ma.string(t.label) && (Ma.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) && (Ma.string(t.description) || void 0 === t.description)
        }
    }(So || (So = {})), function (e) {
        e.is = function (e) {
            const t = e;
        ...
        e.replace = function (e, t, n) {
            ...
            const t = e;
            return ko.is(t) && (So.is(t.annotationId) || Lo.is(t.annotationId))
        }
    }(xo || (xo = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return Ma.defined(t) && zo.is(t.textDocument) && Array.isArray(t.edits)
        }
    }(Co || (Co = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            let t = e;
            return t && "create" === t.kind && Ma.string(t.uri) && (void 0 === t.options || (void 0 === t.options.overwrite || Ma.boolean(t.options.overwrite)) && (void 0 === t.options.ignoreIfExists || Ma.boolean(t.options.ignoreIfExists))) && (void 0 === t.annotationId || Lo.is(t.annotationId))
        }
    }(Eo || (Eo = {})), function (e) {
        e.create = function (e, t, n, i) {
            ...
            let t = e;
            return t && "rename" === t.kind && Ma.string(t.oldUri) && Ma.string(t.newUri) && (void 0 === t.options || (void 0 === t.options.overwrite || Ma.boolean(t.options.overwrite)) && (void 0 === t.options.ignoreIfExists || Ma.boolean(t.options.ignoreIfExists))) && (void 0 === t.annotationId || Lo.is(t.annotationId))
        }
    }(Ao || (Ao = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            let t = e;
            return t && "delete" === t.kind && Ma.string(t.uri) && (void 0 === t.options || (void 0 === t.options.recursive || Ma.boolean(t.options.recursive)) && (void 0 === t.options.ignoreIfNotExists || Ma.boolean(t.options.ignoreIfNotExists))) && (void 0 === t.annotationId || Lo.is(t.annotationId))
        }
    }(Ro || (Ro = {})), function (e) {
        e.is = function (e) {
            let t = e;
            return t && (void 0 !== t.changes || void 0 !== t.documentChanges) && (void 0 === t.documentChanges || t.documentChanges.every(e => Ma.string(e.kind) ? Eo.is(e) || Ao.is(e) || Ro.is(e) : Co.is(e)))
        }
    }(Mo || (Mo = {})), function (e) {
        e.create = function (e) {
            return {uri: e}
            ...
            let t = e;
            return Ma.defined(t) && Ma.string(t.uri)
        }
    }(No || (No = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return Ma.defined(t) && Ma.string(t.uri) && Ma.integer(t.version)
        }
    }(Io || (Io = {})), function (e) {
        e.create = function (e, t) {
            return {uri: e, version: t}
            ...
            let t = e;
            return Ma.defined(t) && Ma.string(t.uri) && (null === t.version || Ma.integer(t.version))
        }
    }(zo || (zo = {})), function (e) {
        e.create = function (e, t, n, i) {
            ...
            let t = e;
            return Ma.defined(t) && Ma.string(t.uri) && Ma.string(t.languageId) && Ma.integer(t.version) && Ma.string(t.text)
        }
    }(Oo || (Oo = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return Ma.objectLiteral(e) && Ho.is(t.kind) && Ma.string(t.value)
        }
    }(Uo || (Uo = {})), function (e) {
        ...
        e.create = function (e, t, n) {
            ...
            const t = e;
            return t && Ma.string(t.newText) && lo.is(t.insert) && lo.is(t.replace)
        }
    }(qo || (qo = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return t && (Ma.string(t.detail) || void 0 === t.detail) && (Ma.string(t.description) || void 0 === t.description)
        }
    }(Vo || (Vo = {})), function (e) {
        e.create = function (e) {
            return {label: e}
        ...
        e.fromPlainText = function (e) {
            ...
            const t = e;
            return Ma.string(t) || Ma.objectLiteral(t) && Ma.string(t.language) && Ma.string(t.value)
        }
    }(jo || (jo = {})), function (e) {
        e.is = function (e) {
            let t = e;
            return !!t && Ma.objectLiteral(t) && (Uo.is(t.contents) || jo.is(t.contents) || Ma.typedArray(t.contents, jo.is)) && (void 0 === e.range || lo.is(e.range))
        }
    }(Go || (Go = {})), function (e) {
        e.create = function (e, t) {
        ...
        e.create = function (e, t, ...n) {
            let i = {label: e};
            return Ma.defined(t) && (i.documentation = t), Ma.defined(n) ? i.parameters = n : i.parameters = [], i
        }
    }(Xo || (Xo = {})), function (e) {
        ...
        e.create = function (e, t, n, i, r, o) {
            let a = {name: e, detail: t, kind: n, range: i, selectionRange: r};
            return void 0 !== o && (a.children = o), a
        }, e.is = function (e) {
            let t = e;
            return t && Ma.string(t.name) && Ma.number(t.kind) && lo.is(t.range) && lo.is(t.selectionRange) && (void 0 === t.detail || Ma.string(t.detail)) && (void 0 === t.deprecated || Ma.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children)) && (void 0 === t.tags || Array.isArray(t.tags))
        }
    }(na || (na = {})), function (e) {
        ...
        e.create = function (e, t, n) {
            ...
            let t = e;
            return Ma.defined(t) && Ma.typedArray(t.diagnostics, yo.is) && (void 0 === t.only || Ma.typedArray(t.only, Ma.string)) && (void 0 === t.triggerKind || t.triggerKind === ra.Invoked || t.triggerKind === ra.Automatic)
        }
    }(oa || (oa = {})), function (e) {
        e.create = function (e, t, n) {
            let i = {title: e}, r = !0;
            return "string" == typeof t ? (r = !1, i.kind = t) : To.is(t) ? i.command = t : i.edit = t, r && void 0 !== n && (i.kind = n), i
        }, e.is = function (e) {
            let t = e;
            return t && Ma.string(t.title) && (void 0 === t.diagnostics || Ma.typedArray(t.diagnostics, yo.is)) && (void 0 === t.kind || Ma.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || To.is(t.command)) && (void 0 === t.isPreferred || Ma.boolean(t.isPreferred)) && (void 0 === t.edit || Mo.is(t.edit))
        }
    }(aa || (aa = {})), function (e) {
        e.create = function (e, t) {
            let n = {range: e};
            return Ma.defined(t) && (n.data = t), n
        }, e.is = function (e) {
            let t = e;
            return Ma.defined(t) && lo.is(t.range) && (Ma.undefined(t.command) || To.is(t.command))
        }
    }(sa || (sa = {})), function (e) {
        e.create = function (e, t) {
            ...
            let t = e;
            return Ma.defined(t) && Ma.uinteger(t.tabSize) && Ma.boolean(t.insertSpaces)
        }
    }(la || (la = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            let t = e;
            return Ma.defined(t) && lo.is(t.range) && (Ma.undefined(t.target) || Ma.string(t.target))
        }
    }(ca || (ca = {})), function (e) {
        e.create = function (e, t) {
            ...
            let n = t;
            return Ma.objectLiteral(n) && lo.is(n.range) && (void 0 === n.parent || e.is(n.parent))
        }
    }(ha || (ha = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return Ma.objectLiteral(t) && (void 0 === t.resultId || "string" == typeof t.resultId) && Array.isArray(t.data) && (0 === t.data.length || "number" == typeof t.data[0])
        }
    }(ma || (ma = {})), function (e) {
        e.create = function (e, t) {
            ...
            const t = e;
            return null != t && lo.is(t.range) && Ma.string(t.text)
        }
    }(pa || (pa = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            const t = e;
            return null != t && lo.is(t.range) && Ma.boolean(t.caseSensitiveLookup) && (Ma.string(t.variableName) || void 0 === t.variableName)
        }
    }(ga || (ga = {})), function (e) {
        e.create = function (e, t) {
            ...
            const t = e;
            return null != t && lo.is(t.range) && (Ma.string(t.expression) || void 0 === t.expression)
        }
    }(fa || (fa = {})), function (e) {
        e.create = function (e, t) {
            ...
            const t = e;
            return Ma.defined(t) && lo.is(e.stoppedLocation)
        }
    }(ba || (ba = {})), function (e) {
        ...
        e.create = function (e) {
            ...
            const t = e;
            return Ma.objectLiteral(t) && (void 0 === t.tooltip || Ma.string(t.tooltip) || Uo.is(t.tooltip)) && (void 0 === t.location || co.is(t.location)) && (void 0 === t.command || To.is(t.command))
        }
    }(wa || (wa = {})), function (e) {
        e.create = function (e, t, n) {
            ...
            const t = e;
            return Ma.objectLiteral(t) && so.is(t.position) && (Ma.string(t.label) || Ma.typedArray(t.label, wa.is)) && (void 0 === t.kind || _a.is(t.kind)) && void 0 === t.textEdits || Ma.typedArray(t.textEdits, ko.is) && (void 0 === t.tooltip || Ma.string(t.tooltip) || Uo.is(t.tooltip)) && (void 0 === t.paddingLeft || Ma.boolean(t.paddingLeft)) && (void 0 === t.paddingRight || Ma.boolean(t.paddingRight))
        }
    }(va || (va = {})), function (e) {
        ...
        e.is = function (e) {
            const t = e;
            return Ma.objectLiteral(t) && ro.is(t.uri) && Ma.string(t.name)
        }
    }(Ca || (Ca = {})), function (e) {
        function t(e, n) {
            if (e.length <= 1) return e;
        ...
        e.create = function (e, t, n, i) {
            return new Ra(e, t, n, i)
        }, e.is = function (e) {
            let t = e;
            return !!(Ma.defined(t) && Ma.string(t.uri) && (Ma.undefined(t.languageId) || Ma.string(t.languageId)) && Ma.uinteger(t.lineCount) && Ma.func(t.getText) && Ma.func(t.positionAt) && Ma.func(t.offsetAt))
    ...
    let Ra = class {
        ...
        positionAt(e) {
            ...
            if (0 === i) return so.create(0, e);
            for (; n < i;) {
                let r = Math.floor((n + i) / 2);
                t[r] > e ? i = r : n = r + 1
            }
            let r = n - 1;
            return so.create(r, e - t[r])
        }
    ...
    class Ua {
        ...
        update(e, t) {
            for (let n of e) if (Ua.isIncremental(n)) {
                const e = Pa(n.range), t = this.offsetAt(e.start), i = this.offsetAt(e.end);
                this._content = this._content.substring(0, t) + n.text + this._content.substring(i, this._content.length);
                const r = Math.max(e.start.line, 0), o = Math.max(e.end.line, 0);
                let a = this._lineOffsets;
                const s = Wa(n.text, !1, t);
                if (o - r === s.length) for (let n = 0, c = s.length; n < c; n++) a[n + r + 1] = s[n]; else s.length < 1e4 ? a.splice(r + 1, o - r, ...s) : this._lineOffsets = a = a.slice(0, r + 1).concat(s, a.slice(o + 1));
                const l = n.text.length - (i - t);
                if (0 !== l) for (let n = r + 1 + s.length, c = a.length; n < c; n++) a[n] = a[n] + l
            } else {
                if (!Ua.isFull(n)) throw new Error("Unknown change event received");
        ...
        getLineOffsets() {
            return void 0 === this._lineOffsets && (this._lineOffsets = Wa(this._content, !0)), this._lineOffsets
        }
    ...
    !function (e) {
        e.create = function (e, t, n, i) {
            return new Ua(e, t, n, i)
        }, e.update = function (e, t, n) {
            if (e instanceof Ua) return e.update(t, n), e;
            throw new Error("TextDocument.update: document must be created by TextDocument.create")
        }, e.applyEdits = function (e, t) {
            let n = e.getText(), i = Da(t.map(qa), (e, t) => {
                let n = e.range.start.line - t.range.start.line;
                return 0 === n ? e.range.start.character - t.range.start.character : n
            }), r = 0;
            const o = [];
        ...
        e.LATEST = {
            textDocument: {
                completion: {completionItem: {documentationFormat: [Ho.Markdown, Ho.PlainText]}},
                hover: {contentFormat: [Ho.Markdown, Ho.PlainText]}
            }
        }
    }(Oa || (Oa = {})), function (e) {
    ...
    class Fa {
        ...
        skipWhitespace() {
            return this.advanceWhileChar(e => e === es || e === ts || e === Ya || e === Za || e === Qa) > 0
        }
    ...
    const Va = "!".charCodeAt(0), Ba = "-".charCodeAt(0), Ka = "<".charCodeAt(0), ja = ">".charCodeAt(0),
        Ga = "/".charCodeAt(0), $a = "=".charCodeAt(0), Xa = '"'.charCodeAt(0), Ja = "'".charCodeAt(0),
        Ya = "\n".charCodeAt(0), Qa = "\r".charCodeAt(0), Za = "\f".charCodeAt(0), es = " ".charCodeAt(0),
        ts = "\t".charCodeAt(0), ns = {"text/x-handlebars-template": !0, "text/html": !0};

    function is(e, t = 0, n = za.WithinContent, i = !1) {
        const r = new Fa(e, t);
        let o, a, s, l, c, h = n, d = 0, u = Ia.Unknown;
        ...
        function g() {
            const e = r.pos();
            if (r.eos()) return p(e, Ia.EOS);
            let t;
            switch (h) {
                case za.WithinComment:
                    return r.advanceIfChars([Ba, Ba, ja]) ? (h = za.WithinContent, p(e, Ia.EndCommentTag)) : (r.advanceUntilChars([Ba, Ba, ja]), p(e, Ia.Comment));
                case za.WithinDoctype:
                    return r.advanceIfChar(ja) ? (h = za.WithinContent, p(e, Ia.EndDoctypeTag)) : (r.advanceUntilChar(ja), p(e, Ia.Doctype));
                case za.WithinContent:
                    if (r.advanceIfChar(Ka)) {
                        if (!r.eos() && r.peekChar() === Va) {
                            if (r.advanceIfChars([Va, Ba, Ba])) return h = za.WithinComment, p(e, Ia.StartCommentTag);
                            if (r.advanceIfRegExp(/^!doctype/i)) return h = za.WithinDoctype, p(e, Ia.StartDoctypeTag)
                        }
                        return r.advanceIfChar(Ga) ? (h = za.AfterOpeningEndTag, p(e, Ia.EndTagOpen)) : (h = za.AfterOpeningStartTag, p(e, Ia.StartTagOpen))
                    }
                    return r.advanceUntilChar(Ka), p(e, Ia.Content);
                case za.AfterOpeningEndTag:
                    return m().length > 0 ? (h = za.WithinEndTag, p(e, Ia.EndTag)) : r.skipWhitespace() ? p(e, Ia.Whitespace, no("Tag name must directly follow the open bracket.")) : (h = za.WithinEndTag, r.advanceUntilChar(ja), e < r.pos() ? p(e, Ia.Unknown, no("End tag name expected.")) : g());
                case za.WithinEndTag:
                    if (r.skipWhitespace()) return p(e, Ia.Whitespace);
                    if (r.advanceIfChar(ja)) return h = za.WithinContent, p(e, Ia.EndTagClose);
                    if (i && r.peekChar() === Ka) return h = za.WithinContent, p(e, Ia.EndTagClose, no("Closing bracket missing."));
                    t = no("Closing bracket expected.");
                    break;
                case za.AfterOpeningStartTag:
                    return s = m(), c = void 0, l = void 0, s.length > 0 ? (a = !1, h = za.WithinTag, p(e, Ia.StartTag)) : r.skipWhitespace() ? p(e, Ia.Whitespace, no("Tag name must directly follow the open bracket.")) : (h = za.WithinTag, r.advanceUntilChar(ja), e < r.pos() ? p(e, Ia.Unknown, no("Start tag name expected.")) : g());
                case za.WithinTag:
                    return r.skipWhitespace() ? (a = !0, p(e, Ia.Whitespace)) : a && (l = r.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase(), l.length > 0) ? (h = za.AfterAttributeName, a = !1, p(e, Ia.AttributeName)) : r.advanceIfChars([Ga, ja]) ? (h = za.WithinContent, p(e, Ia.StartTagSelfClose)) : r.advanceIfChar(ja) ? (h = "script" === s ? c && ns[c] ? za.WithinContent : za.WithinScriptContent : "style" === s ? za.WithinStyleContent : za.WithinContent, p(e, Ia.StartTagClose)) : i && r.peekChar() === Ka ? (h = za.WithinContent, p(e, Ia.StartTagClose, no("Closing bracket missing."))) : (r.advance(1), p(e, Ia.Unknown, no("Unexpected character in tag.")));
                case za.AfterAttributeName:
                    return r.skipWhitespace() ? (a = !0, p(e, Ia.Whitespace)) : r.advanceIfChar($a) ? (h = za.BeforeAttributeValue, p(e, Ia.DelimiterAssign)) : (h = za.WithinTag, g());
                case za.BeforeAttributeValue:
                    if (r.skipWhitespace()) return p(e, Ia.Whitespace);
                    let n = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
                    if (n.length > 0 && (r.peekChar() === ja && r.peekChar(-1) === Ga && (r.goBack(1), n = n.substring(0, n.length - 1)), "type" === l && (c = n), n.length > 0)) return h = za.WithinTag, a = !1, p(e, Ia.AttributeValue);
                    const o = r.peekChar();
                    return o === Ja || o === Xa ? (r.advance(1), r.advanceUntilChar(o) && r.advance(1), "type" === l && (c = r.getSource().substring(e + 1, r.pos() - 1)), h = za.WithinTag, a = !1, p(e, Ia.AttributeValue)) : (h = za.WithinTag, a = !1, g());
                case za.WithinScriptContent:
                    let d = 1;
                    for (; !r.eos();) {
                        const t = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
                        if (0 === t.length) return r.goToEnd(), p(e, Ia.Script);
                        if ("\x3c!--" === t) 1 === d && (d = 2); else if ("--\x3e" === t) d = 1; else if ("/" !== t[1]) 2 === d && (d = 3); else {
                            if (3 !== d) {
                                r.goBack(t.length);
                                break
                            }
                    ...
                    return h = za.WithinContent, e < r.pos() ? p(e, Ia.Script) : g();
                case za.WithinStyleContent:
                    return r.advanceUntilRegExp(/<\/style/i), h = za.WithinContent, e < r.pos() ? p(e, Ia.Styles) : g()
            }
            return r.advance(1), h = za.WithinContent, p(e, Ia.Unknown, t)
        }

        return {
            scan: function () {
                const e = r.pos(), t = g();
                return t === Ia.EOS || e !== r.pos() || i && (t === Ia.StartTagClose || t === Ia.EndTagClose) ? t : (r.advance(1), p(e, Ia.Unknown))
            },
            getTokenType: () => u,
            getTokenOffset: () => d,
    ...
    class os {
        ...
        findNodeBefore(e) {
            const t = rs(this.children, t => e <= t.start) - 1;
            if (t >= 0) {
    ...
    class as {
        ...
        parse(e, t) {
            const n = is(e, void 0, void 0, !0), i = new os(0, e.length, [], void 0);
            let r, o = i, a = -1, s = null, l = n.scan();
            for (; l !== Ia.EOS;) {
                switch (l) {
                    case Ia.StartTagOpen:
                        const i = new os(n.getTokenOffset(), e.length, [], o);
                        o.children.push(i), o = i;
                        break;
                    case Ia.StartTag:
                        o.tag = n.getTokenText();
                        break;
                    case Ia.StartTagClose:
                    ...
                    case Ia.EndTagClose:
                        ...
                        break;
                    case Ia.AttributeName: {
                        s = n.getTokenText();
                        let e = o.attributes;
                        e || (o.attributes = e = {}), e[s] = null;
                        break
                    }
                    case Ia.AttributeValue: {
    ...
    const ds = "a".charCodeAt(0), us = "z".charCodeAt(0), ms = "A".charCodeAt(0), ps = "Z".charCodeAt(0),
        gs = "0".charCodeAt(0), fs = "9".charCodeAt(0);

    function bs(e, t) {
        const n = e.charCodeAt(t);
        return ds <= n && n <= us || ms <= n && n <= ps || gs <= n && n <= fs
    }
    ...
    class ys {
        ...
        async computeCompletions(e, t) {
            ...
            for (const i of this.atributeCompletions) {
                const r = ks(e.getText(i.range));
                if (Ss(r)) if ("." === r || ".." === r) n.isIncomplete = !0; else {
                    const o = Ls(i.value, r, i.range), a = await this.providePathSuggestions(i.value, o, e, t);
        ...
        async providePathSuggestions(e, t, n, i) {
            ...
            if (o) try {
                ...
                for (const [i, r] of n) i.charCodeAt(0) !== Ts && e.push(xs(i, r === Ha.Directory, t));
                return e
            } catch (gl) {
            }
            return []
    ...
    const Ts = ".".charCodeAt(0);

    function ks(e) {
        return ls(e, "'") || ls(e, '"') ? e.slice(1, -1) : e
    }

    function Ss(e) {
        return !(ls(e, "http") || ls(e, "https") || ls(e, "//"))
    }
    ...
    function Ls(e, t, n) {
        ...
        if (-1 === r) i = function (e, t, n) {
            const i = Cs(e.start, t), r = Cs(e.end, n);
            return lo.create(i, r)
        }(n, 1, -1); else {
            const e = t.slice(r + 1), o = Cs(n.end, -1 - e.length), a = e.indexOf(" ");
            let s;
            s = -1 !== a ? Cs(o, a) : Cs(n.end, -1), i = lo.create(o, s)
        }
        return i
    }
    ...
    function xs(e, t, n) {
        return t ? {
            label: e += "/",
            kind: Do.Folder,
            textEdit: ko.replace(n, e),
            command: {title: "Suggest", command: "editor.action.triggerSuggest"}
        } : {label: e, kind: Do.File, textEdit: ko.replace(n, e)}
    }

    function Cs(e, t) {
        return so.create(e.line, e.character + t)
    }
    ...
    class Es {
        ...
        async doComplete2(e, t, n, i, r) {
            ...
            const o = new ys(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory),
            ...
            try {
                ...
                return {isIncomplete: s.isIncomplete || t.isIncomplete, items: t.items.concat(s.items)}
            } finally {
        ...
        _doComplete(e, t, n, i) {
            const r = {isIncomplete: !1, items: []}, o = this.completionParticipants,
                a = this.dataManager.getDataProviders().filter(t => t.isApplicable(e.languageId) && (!i || !1 !== i[t.getId()])),
                s = this.dataManager.getVoidElements(a), l = this.doesSupportMarkdown(), c = e.getText(),
                h = e.offsetAt(t), d = n.findNodeBefore(h);
            if (!d) return r;
            const u = is(c, d.start);
            let m, p = "";

            function g(t, n = h) {
                return t > h && (t = h), {start: e.positionAt(t), end: e.positionAt(n)}
            }
                ...
                return a.forEach(e => {
                    e.provideTags().forEach(e => {
                        r.items.push({
                            label: e.name,
                            kind: Do.Property,
                            documentation: vs(e, void 0, l),
                            textEdit: ko.replace(n, e.name),
                            insertTextFormat: Wo.PlainText
                        })
                    })
                }), r
            }
            ...
            function _(e, t, n = h) {
                const i = g(e, n), o = Rs(c, n, za.WithinEndTag, Ia.EndTagClose) ? "" : ">";
                let s = d;
                for (t && (s = s.parent); s;) {
                    const t = s.tag;
                    if (t && (!s.closed || s.endTagStart && s.endTagStart > h)) {
                        const n = {
                            ...
                            kind: Do.Property,
                            filterText: "/" + t,
                            textEdit: ko.replace(i, "/" + t + o),
                            insertTextFormat: Wo.PlainText
                        }, a = b(s.start), l = b(e - 1);
                        if (null !== a && null !== l && a !== l) {
                            const i = a + "</" + t + o;
                            n.textEdit = ko.replace(g(e - 1 - l.length), i), n.filterText = l + "</" + t
                        }
                ...
                return t || a.forEach(e => {
                    e.provideTags().forEach(e => {
                        r.items.push({
                            ...
                            documentation: vs(e, void 0, l),
                            filterText: "/" + e.name + o,
                            textEdit: ko.replace(i, "/" + e.name + o),
                            insertTextFormat: Wo.PlainText
                        })
                    })
                }), r
            ...
            const w = (t, n) => {
                ...
                if (!this.dataManager.isVoidElement(n, s)) {
                    ...
                    r.items.push({
                        ...
                        kind: Do.Property,
                        filterText: "</" + n + ">",
                        textEdit: ko.insert(i, "$0</" + n + ">"),
                        insertTextFormat: Wo.Snippet
                    })
                }
                return r
            };
            ...
            function y(e, t = h) {
                ...
                let m = "";
                if (!Rs(c, t, za.AfterAttributeName, Ia.DelimiterAssign)) {
                ...
                return f[s] = !1, a.forEach(e => {
                    e.provideAttributes(p).forEach(e => {
                        ...
                        "v" !== e.valueSet && m.length && (n += m, (e.valueSet || "style" === e.name) && (t = {
                            ...
                            label: e.name,
                            kind: "handler" === e.valueSet ? Do.Function : Do.Value,
                            documentation: vs(e, void 0, l),
                            textEdit: ko.replace(u, n),
                            insertTextFormat: Wo.Snippet,
                            command: t
                        })
                    })
                    ...
                    function a(e) {
                        e.attributeNames.forEach(e => {
                            !ls(e, i) || o[e] || t[e] || (o[e] = e + '="$1"')
                        }), e.children.forEach(e => a(e))
                    }

                    o[i] = `${i}$1="$2"`, n && n.roots.forEach(e => a(e));
                    Object.keys(o).forEach(t => r.items.push({
                        label: t,
                        kind: Do.Value,
                        textEdit: ko.replace(e, o[t]),
                        insertTextFormat: Wo.Snippet
                    }))
                }(u, f), r
            }
            ...
            function T(n, i = h) {
                ...
                if (h > n && h <= i && (f = c[n], /^["']*$/.test(f))) {
                    ...
                    const r = function (e, t, n) {
                        for (; t > n && !As(e[t - 1]);) t--;
                        return t
                    }(c, h, e), o = function (e, t, n) {
                        for (; t < n && !As(e[t]);) t++;
                        return t
                    }(c, h, t);
                    s = g(r, o), u = h >= e && h <= t ? c.substring(e, h) : "", d = !1
            ...
            function S() {
                for (const n of o) n.onHtmlContent && n.onHtmlContent({document: e, position: t});
                return L()
            }
            ...
            function L() {
                ...
                for (; e >= 0 && bs(c, e);) e--, n--;
                if (e >= 0 && "&" === c[e]) {
                    const e = lo.create(so.create(t.line, n - 1), t);
                    for (const t in ss) if (cs(t, ";")) {
                        const n = "&" + t;
                        r.items.push({
                            label: n,
                            kind: Do.Keyword,
                            documentation: no("Character entity representing '{0}'", ss[t]),
                            textEdit: ko.replace(e, n),
                            insertTextFormat: Wo.PlainText
                        })
                    }
                }
            ...
            function x(e, t) {
                ...
                r.items.push({
                    ...
                    textEdit: ko.replace(n, "!DOCTYPE html>"),
                    insertTextFormat: Wo.PlainText
                })
            }

            let C = u.scan();
            for (; C !== Ia.EOS && u.getTokenOffset() <= h;) {
                switch (C) {
                    case Ia.StartTagOpen:
                        if (u.getTokenEnd() === h) {
                            const e = k(Ia.StartTag);
                    ...
                    case Ia.AttributeName:
                        ...
                        m = u.getTokenText();
                        break;
                    case Ia.DelimiterAssign:
                        if (u.getTokenEnd() === h) {
                            const e = k(Ia.AttributeValue);
                            return T(h, e)
                        }
                        break;
                    case Ia.AttributeValue:
                    ...
                    case Ia.Whitespace:
                        if (h <= u.getTokenEnd()) switch (u.getScannerState()) {
                            case za.AfterOpeningStartTag:
                                return v(u.getTokenOffset(), k(Ia.StartTag));
                            case za.WithinTag:
                            case za.AfterAttributeName:
                    ...
                    case Ia.EndTagOpen:
                        if (h <= u.getTokenEnd()) {
                            return _(u.getTokenOffset() + 1, !1, k(Ia.EndTag))
                        }
                        break;
                    case Ia.EndTag:
                        if (h <= u.getTokenEnd()) {
        ...
        doQuoteComplete(e, t, n, i) {
            ...
            if (s && s.attributes && s.start < r && (!s.endTagStart || s.endTagStart > r)) {
                const t = is(e.getText(), s.start);
                let n = t.scan();
                for (; n !== Ia.EOS && t.getTokenEnd() <= r;) {
                    if (n === Ia.AttributeName && t.getTokenEnd() === r - 1) return n = t.scan(), n !== Ia.DelimiterAssign ? null : (n = t.scan(), n === Ia.Unknown || n === Ia.AttributeValue ? null : a);
                    n = t.scan()
                }
            }
            return null
        ...
        doTagComplete(e, t, n) {
            ...
            if (">" === r) {
                ...
                if (r && r.tag && !this.dataManager.isVoidElement(r.tag, t) && r.start < i && (!r.endTagStart || r.endTagStart > i)) {
                    const t = is(e.getText(), r.start);
                    let n = t.scan();
                    for (; n !== Ia.EOS && t.getTokenEnd() <= i;) {
                        if (n === Ia.StartTagClose && t.getTokenEnd() === i) return `$0</${r.tag}>`;
                        n = t.scan()
                    }
                }
            } else if ("/" === r) {
                ...
                if (t && t.tag) {
                    const n = is(e.getText(), t.start);
                    let r = n.scan();
                    for (; r !== Ia.EOS && n.getTokenEnd() <= i;) {
                        if (r === Ia.EndTagOpen && n.getTokenEnd() === i) return ">" !== e.getText().charAt(i) ? `${t.tag}>` : t.tag;
                        r = n.scan()
                    }
                }
            }
        ...
        doesSupportMarkdown() {
            if (!_s(this.supportsMarkdown)) {
                if (!_s(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
                const e = this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;
                this.supportsMarkdown = Array.isArray(e) && -1 !== e.indexOf(Ho.Markdown)
            }
    ...
    class Ms {
        ...
        doHover(e, t, n, i) {
            const r = this.convertContents.bind(this), o = this.doesSupportMarkdown(), a = e.offsetAt(t),
                s = n.findNodeAt(a), l = e.getText();
                ...
                for (const a of c) {
                    ...
                    if (a.provideTags().forEach(r => {
                        if (r.name.toLowerCase() === e.toLowerCase()) {
                            let e = vs(r, i, o);
                            e || (e = {kind: o ? "markdown" : "plaintext", value: ""}), n = {contents: e, range: t}
                        }
            ...
            function d(t, n) {
                const i = is(e.getText(), n);
                let r = i.scan();
                for (; r !== Ia.EOS && (i.getTokenEnd() < a || i.getTokenEnd() === a && r !== t);) r = i.scan();
            ...
            if (s.endTagStart && a >= s.endTagStart) {
                const e = d(Ia.EndTag, s.endTagStart);
                return e ? h(s.tag, e) : null
            }
            const u = d(Ia.StartTag, s.start);
            if (u) return h(s.tag, u);
            const m = d(Ia.AttributeName, s.start);
            if (m) {
            ...
            const p = function () {
                ...
                if (e >= 0 && "&" === l[e]) {
                    let e = null;
                    return e = ";" === l[i] ? lo.create(so.create(t.line, n), so.create(t.line, r + 1)) : lo.create(so.create(t.line, n), so.create(t.line, r)), e
                }
                return null
            }();
            if (p) return function (e, t) {
                let n = function (e) {
                    let t = a - 1, n = "&";
                    for (; t >= 0 && bs(e, t);) t--;
                    for (t += 1; bs(e, t);) n += e[t], t += 1;
                    return n += ";", n
                }(e);
                for (const i in ss) {
                    let e = null;
                    if (n === "&" + i) {
                        let n = ss[i].charCodeAt(0).toString(16).toUpperCase(), r = "U+";
                        if (n.length < 4) {
                            const e = 4 - n.length;
                            let t = 0;
                            for (; t < e;) r += "0", t += 1
                        ...
                        r += n;
                        const o = no("Character entity representing '{0}', unicode equivalent '{1}'", ss[i], r);
                        e = o ? {contents: o, range: t} : null
                    }
                    if (e) return e.contents = r(e.contents), e
                }
                return null
            }(l, p);
            const g = d(Ia.AttributeValue, s.start);
            if (g) {
                const t = s.tag, n = function (e) {
                    ...
                    return e
                }(e.getText(g)), a = function (t, n) {
                    const i = is(e.getText(), t);
                    let r, o = i.scan();
                    for (; o !== Ia.EOS && i.getTokenEnd() <= n;) o = i.scan(), o === Ia.AttributeName && (r = i.getTokenText());
                    return r
    ...
    Is = [, , function (e) {
        ...
        var i = n(17).Options, r = n(2).Output, o = n(8).InputScanner, a = new (0, n(13).Directives)(/\/\*/, /\*\//),
            s = /\r\n|[\r\n]/, l = /\r\n|[\r\n]/g, c = /\s/, h = /(?:\s|\n)+/g, d = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g,
            u = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
        ...
        m.prototype.eatString = function (e) {
            ...
            for (var i, m, p = 0, g = !1, f = !1, b = !1, _ = !1, w = !1, v = this._ch, y = !1; i = "" !== this._input.read(h), m = v, this._ch = this._input.next(), "\\" === this._ch && this._input.hasNext() && (this._ch += this._input.next()), v = this._ch, this._ch;) if ("/" === this._ch && "*" === this._input.peek()) {
                ...
                var T = this._input.read(d), k = a.get_directives(T);
                k && "start" === k.ignore && (T += a.readIgnored(this._input)), this.print_string(T), this.eatWhitespace(!0), this._output.add_new_line()
            } else if ("/" === this._ch && "/" === this._input.peek()) this._output.space_before_token = !0, this._input.back(), this.print_string(this._input.read(u)), this.eatWhitespace(!0); else if ("$" === this._ch) {
            ...
            } else if ("@" === this._ch) if (this.preserveSingleSpace(i), "{" === this._input.peek()) this.print_string(this._ch + this.eatString("}")); else {
            ...
            } else if (";" === this._ch) y = !1, 0 === p ? (f && (this.outdent(), f = !1), _ = !1, this.print_string(this._ch), this.eatWhitespace(!0), "/" !== this._input.peek() && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0); else if ("(" === this._ch) if (this._input.lookBack("url")) this.print_string(this._ch), this.eatWhitespace(), p++, this.indent(), this._ch = this._input.next(), ")" === this._ch || '"' === this._ch || "'" === this._ch ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), p && (p--, this.outdent())); else {
                var E = !1;
            ...
            } else if (")" === this._ch) p && (p--, this.outdent()), w && ";" === this._input.peek() && this._options.selector_separator_newline && (w = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch); else if ("," === this._ch) this.print_string(this._ch), this.eatWhitespace(!0), !this._options.selector_separator_newline || f && !w || 0 !== p || _ ? this._output.space_before_token = !0 : this._output.add_new_line(); else if (">" !== this._ch && "+" !== this._ch && "~" !== this._ch || f || 0 !== p) if ("]" === this._ch) this.print_string(this._ch); else if ("[" === this._ch) this.preserveSingleSpace(i), this.print_string(this._ch); else if ("=" === this._ch) this.eatWhitespace(), this.print_string("="), c.test(this._ch) && (this._ch = ""); else if ("!" !== this._ch || this._input.lookBack("\\")) {
                var A = '"' === m || "'" === m;
            ...
            } else this._output.space_before_token = !0, this.print_string(this._ch); else this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && c.test(this._ch) && (this._ch = ""));
        ...
        var i = zs[t] = {exports: {}};
        return Is[t](i, i.exports, e), i.exports
    }(15);
    var Hs, Us, Ds = Os;
    ...
    function Ws(e, t, n) {
        ...
        if (t) {
            ...
            for (; s > 0 && Bs(i, s - 1);) s--;
            0 === s || Vs(i, s - 1) ? a = s : s < a && (a = s + 1);
            let l = e.offsetAt(t.end), c = l;
            for (; c < i.length && Bs(i, c);) c++;
            (c === i.length || Vs(i, c)) && (l = c), t = lo.create(e.positionAt(a), e.positionAt(l));
            const h = i.substring(0, a);
            if (new RegExp(/.*[<][^>]*$/).test(h)) return i = i.substring(a, l), [{range: t, newText: i}];
            if (r = l === i.length, i = i.substring(a, l), 0 !== a) {
                const i = e.offsetAt(so.create(t.start.line, 0));
                o = function (e, t, n) {
                    let i = t, r = 0;
                    const o = n.tabSize || 4;
                    for (; i < e.length;) {
        ...
        } else t = lo.create(so.create(0, 0), e.positionAt(i.length));
        const s = {
            indent_size: a,
            indent_char: n.insertSpaces ? " " : "\t",
            indent_empty_lines: Ps(n, "indentEmptyLines", !1),
            wrap_line_length: Ps(n, "wrapLineLength", 120),
            unformatted: qs(n, "unformatted", void 0),
            content_unformatted: qs(n, "contentUnformatted", void 0),
            indent_inner_html: Ps(n, "indentInnerHtml", !1),
            preserve_newlines: Ps(n, "preserveNewLines", !0),
            max_preserve_newlines: Ps(n, "maxPreserveNewLines", 32786),
            indent_handlebars: Ps(n, "indentHandlebars", !1),
            end_with_newline: r && Ps(n, "endWithNewline", !1),
            extra_liners: qs(n, "extraLiners", void 0),
            wrap_attributes: Ps(n, "wrapAttributes", "auto"),
            wrap_attributes_indent_size: Ps(n, "wrapAttributesIndentSize", void 0),
            eol: "\n",
            indent_scripts: Ps(n, "indentScripts", "normal"),
            templating: Fs(n, "all"),
            unformatted_content_delimiter: Ps(n, "unformattedContentDelimiter", "")
        };
        let l = function (e, t) {
            return Hs(e, t, Ns, Ds)
        }(i.replace(/^\s+/, ""), s);
        if (o > 0) {
            const e = n.insertSpaces ? hs(" ", a * o) : hs("\t", o);
    ...
    !function () {
        var e = [, , function (e) {
            ...
            var i = n(8).InputScanner, r = n(3).Token, o = n(10).TokenStream, a = n(11).WhitespacePattern,
            ...
            var i = n(12).Pattern, r = {django: !1, erb: !1, handlebars: !1, php: !1, smarty: !1, angular: !1};
            ...
            m.prototype.get_parser_token = function () {
                ...
                var n = (e = e.replace(l, "\n")).match(/^[\t ]*/)[0], i = {text: "", type: ""}, r = new g,
                    h = new c(this._options, n), d = new o(e, this._options).tokenize();
                this._tag_stack = new m(h);
                for (var u = null, p = d.next(); p.type !== a.EOF;) p.type === a.TAG_OPEN || p.type === a.COMMENT ? r = u = this._handle_tag_open(h, p, r, i, d) : p.type === a.ATTRIBUTE || p.type === a.EQUALS || p.type === a.VALUE || p.type === a.TEXT && !r.tag_complete ? u = this._handle_inside_tag(h, p, r, i) : p.type === a.TAG_CLOSE ? u = this._handle_tag_close(h, p, r) : p.type === a.TEXT ? u = this._handle_text(h, p, r) : p.type === a.CONTROL_FLOW_OPEN ? u = this._handle_control_flow_open(h, p) : p.type === a.CONTROL_FLOW_CLOSE ? u = this._handle_control_flow_close(h, p) : h.add_raw_token(p), i = u, p = d.next();
                ...
                var r = n.has_wrapped_attrs, o = {text: t.text, type: t.type};
            ...
            p.prototype._do_optional_end_element = function (e) {
                ...
                if (!e.is_empty_element && e.is_start_tag && e.parent) {
                    if ("body" === e.tag_name) t = t || this._tag_stack.try_pop("head"); else if ("li" === e.tag_name) t = t || this._tag_stack.try_pop("li", ["ol", "ul", "menu"]); else if ("dd" === e.tag_name || "dt" === e.tag_name) t = (t = t || this._tag_stack.try_pop("dt", ["dl"])) || this._tag_stack.try_pop("dd", ["dl"]); else if ("p" === e.parent.tag_name && -1 !== f.indexOf(e.tag_name)) {
            ...
            var i = n(9).Tokenizer, r = n(9).TOKEN, o = n(13).Directives, a = n(14).TemplatablePattern,
                s = n(12).Pattern, l = {
            ...
            (h.prototype = new i)._is_comment = function (e) {
                ...
                "<" === e && ("!" === this._input.peek(1) && ((n = this.__patterns.comment.read()) ? (i = c.get_directives(n)) && "start" === i.ignore && (n += c.readIgnored(this._input)) : n = this.__patterns.cdata.read()), n && ((t = this._create_token(l.COMMENT, n)).directives = i));
                return t
                ...
                var i = null, r = "";
                if (n && "<" === n.text[0]) if ("=" === e) i = this._create_token(l.EQUALS, this._input.next()); else if ('"' === e || "'" === e) {
                ...
                var i = "";
                if (n && "{" === n.text[0]) i = this.__patterns.handlebars_raw_close.read(); else if (t.type === l.TAG_CLOSE && "<" === t.opened.text[0] && "/" !== t.text[0]) {
            ...
            470: e => {
                ...
                var i = {
                    resolve: function () {
                        ...
                        var m = "";
                        for (d = r + h + 1; d <= o; ++d) d !== o && 47 !== e.charCodeAt(d) || (0 === m.length ? m += ".." : m += "/..");
                        ...
                        for (var n = -1, i = 0, r = -1, o = !0, a = 0, s = e.length - 1; s >= 0; --s) {
                            ...
                            if (47 !== l) -1 === r && (o = !1, r = s + 1), 46 === l ? -1 === n ? n = s : 1 !== a && (a = 1) : -1 !== n && (a = -1); else if (!o) {
                                i = s + 1;
                                break
                            }
                        }
                        ...
                        o ? (n.root = "/", i = 1) : i = 0;
                        for (var a = -1, s = 0, l = -1, c = !0, h = e.length - 1, d = 0; h >= i; --h) if (47 !== (r = e.charCodeAt(h))) -1 === l && (c = !1, l = h + 1), 46 === r ? -1 === a ? a = h : 1 !== d && (d = 1) : -1 !== a && (d = -1); else if (!c) {
                            s = h + 1;
                            break
                        }
                        return -1 === a || -1 === l || 0 === d || 1 === d && a === l - 1 && a === s + 1 ? -1 !== l && (n.base = n.name = 0 === s && o ? e.slice(1, l) : e.slice(s, l)) : (0 === s && o ? (n.name = e.slice(1, a), n.base = e.slice(1, l)) : (n.name = e.slice(s, a), n.base = e.slice(s, l)), n.ext = e.slice(a, l)), s > 0 ? n.dir = e.slice(0, s - 1) : o && (n.dir = "/"), n
                    }, sep: "/", delimiter: ":", win32: null, posix: null
                };
        ...
        (() => {
            ...
            if (n.r(i), n.d(i, {
                URI: () => h,
                Utils: () => S
            }), "object" == typeof process) e = "win32" === process.platform; else if ("object" == typeof navigator) {
    ...
    function $s(e, t, n, i, r, o) {
        const a = Gs(n);
        if (s = a, l = e.languageId, !s.length || "handlebars" === l && /{{|}}/.test(s) || !/\b(w[\w\d+.-]*:\/\/)?[^\s()<>]+(?:\([\w\d]+\)|([^[:punct:]\s]|\/?))/.test(s)) return;
        var s, l;
        ...
        const c = function (e, t, n, i) {
            ...
            if (/^\/\//i.test(t)) return (ls(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "");
        ...
        const h = function (e, t) {
            try {
                let n = Ks.parse(e);
                return "file" === n.scheme && n.query && (n = n.with({query: null}), e = n.toString(!0)), "file" !== n.scheme || !n.fragment || e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === Xs ? e : n.with({fragment: null}).toString(!0)
            } catch (gl) {
                return
            }
        }(c, e);
        return {range: lo.create(e.positionAt(i), e.positionAt(r)), target: h}
    }

    const Xs = "#".charCodeAt(0);
            ...
            for (; s !== Ia.EOS;) {
                switch (s) {
                    ...
                    case Ia.AttributeName:
                        ...
                        break;
                    case Ia.AttributeValue:
                        if (o && r && this.dataManager.isPathAttribute(o, r)) {
                            const o = i.getTokenText();
                            if (!l) {
                                const r = $s(e, t, o, i.getTokenOffset(), i.getTokenEnd(), a);
                                r && n.push(r)
                            }
                            l && void 0 === a && (a = Gs(o), a && t && (a = t.resolveReference(a, e.uri))), l = !1, r = void 0
                        } else if ("id" === r) {
                            c[Gs(i.getTokenText())] = i.getTokenOffset()
                        }
                }
                s = i.scan()
            }
    ...
    function Ys(e, t, n) {
        ...
        if (!r.tag) return [];
        const o = [], a = el(Ia.StartTag, e, r.start),
            s = "number" == typeof r.endTagStart && el(Ia.EndTag, e, r.endTagStart);
        return (a && Zs(a, t) || s && Zs(s, t)) && (a && o.push({kind: Jo.Read, range: a}), s && o.push({
            kind: Jo.Read,
            range: s
        })), o
    }
    ...
    function Zs(e, t) {
        return Qs(e.start, t) && Qs(t, e.end)
    }

    function el(e, t, n) {
        const i = is(t.getText(), n);
        let r = i.scan();
        for (; r !== Ia.EOS && r !== e;) r = i.scan();
        return r !== Ia.EOS ? {start: t.positionAt(i.getTokenOffset()), end: t.positionAt(i.getTokenEnd())} : null
    }
    ...
    function tl(e, t) {
        ...
        function r(t, i) {
            const o = ea.create(t.name, t.kind, t.range, e.uri, i?.name);
    ...
    function il(e, t, n) {
        const i = function (e) {
            ...
            return t || "?"
        }(t), r = lo.create(e.positionAt(t.start), e.positionAt(t.end)), o = na.create(i, void 0, Qo.Field, r, r);
        n.push(o), t.children.forEach(t => {
            o.children ?? (o.children = []), il(e, t, o.children)
        })
    }
    ...
    function rl(e, t, n, i) {
        ...
        const a = [], s = {start: e.positionAt(o.start + 1), end: e.positionAt(o.start + 1 + o.tag.length)};
        if (a.push({range: s, newText: n}), o.endTagStart) {
            const t = {start: e.positionAt(o.endTagStart + 2), end: e.positionAt(o.endTagStart + 2 + o.tag.length)};
            a.push({range: t, newText: n})
        }
    ...
    function al(e, t, n) {
        ...
        return r.endTagStart && (r.start + 1 <= i && i <= r.start + 1 + o || r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + o) ? [lo.create(e.positionAt(r.start + 1), e.positionAt(r.start + 1 + o)), lo.create(e.positionAt(r.endTagStart + 2), e.positionAt(r.endTagStart + 2 + o))] : null
    }
    ...
    class sl {
        ...
        limitRanges(e, t) {
            ...
            for (let h = 0; h < e.length; h++) {
                const t = e[h];
                if (n) {
                    if (t.startLine > n.startLine) if (t.endLine <= n.endLine) i.push(n), n = t, a(h, i.length); else if (t.startLine > n.endLine) {
                        do {
                            n = i.pop()
        ...
        getFoldingRanges(e, t) {
            const n = this.dataManager.getVoidElements(e.languageId), i = is(e.getText());
            let r = i.scan();
            const o = [], a = [];
            let s = null, l = -1;
            ...
            for (; r !== Ia.EOS;) {
                switch (r) {
                    case Ia.StartTag: {
                        ...
                        a.push({startLine: n, tagName: t}), s = t;
                        break
                    }
                    case Ia.EndTag:
                        s = i.getTokenText();
                        break;
                    case Ia.StartTagClose:
                        if (!s || !this.dataManager.isVoidElement(s, n)) break;
                    case Ia.EndTagClose:
                    case Ia.StartTagSelfClose: {
                        let t = a.length - 1;
                        ...
                        if (t >= 0) {
                            ...
                            s > o && l !== o && c({startLine: o, endLine: s})
                        }
                        break
                    }
                    case Ia.Comment: {
                        ...
                        if (n) if (n[1]) a.push({startLine: t, tagName: ""}); else {
                            let e = a.length - 1;
                            ...
                            if (e >= 0) {
                                ...
                                a.length = e;
                                const i = t;
                                t = n.startLine, i > t && l !== t && c({startLine: t, endLine: i, kind: go.Region})
                            }
                        } else {
                            const n = e.positionAt(i.getTokenOffset() + i.getTokenLength()).line;
                            t < n && c({startLine: t, endLine: n, kind: go.Comment})
                        }
                        break
                    }
                }
    ...
    class ll {
        ...
        getSelectionRange(e, t, n) {
            ...
            for (let a = i.length - 1; a >= 0; a--) {
                const e = i[a];
                r && e[0] === r[0] && e[1] === r[1] || (o = ha.create(lo.create(t.positionAt(i[a][0]), t.positionAt(i[a][1])), o)), r = e
            }
            return o || (o = ha.create(lo.create(e, e))), o
        }
        ...
        getApplicableRanges(e, t, n) {
            ...
            if (r.startTagEnd && !r.endTagStart) {
                ...
                const t = lo.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd));
                "/>" === e.getText(t) ? o.unshift([r.start + 1, r.startTagEnd - 2]) : o.unshift([r.start + 1, r.startTagEnd - 1]);
                return o = this.getAttributeLevelRanges(e, r, i).concat(o), o
            }
            ...
            return r.startTagEnd <= i && i <= r.endTagStart ? (o.unshift([r.startTagEnd, r.endTagStart]), o) : (i >= r.endTagStart + 2 && o.unshift([r.endTagStart + 2, r.end - 1]), o)
        }
        ...
        getAttributeLevelRanges(e, t, n) {
            const i = lo.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), o = n - t.start,
                a = is(r);
            let s = a.scan();
            const l = t.start, c = [];
            let h = !1, d = -1;
    ...
    const cl = {
        ...
        tags: [{
            ...
            }, {name: "onpagehide"}, {name: "onpageshow"}, {
                name: "onpopstate",
            ...
            attributes: [{name: "src"}, {name: "crossorigin", valueSet: "xo"}, {name: "poster"}, {
                name: "preload",
                valueSet: "pl"
            }, {
                name: "autoplay",
            ...
            }, {name: "mediagroup"}, {name: "loop", valueSet: "v"}, {name: "muted", valueSet: "v"}, {
                name: "controls",
                valueSet: "v"
            ...
            void: !0,
            attributes: [{name: "alt"}, {name: "coords"}, {
                name: "shape",
                valueSet: "sh"
            }, {name: "href"}, {
                name: "target",
                valueSet: "target"
            }, {name: "download"}, {name: "ping"}, {name: "rel"}, {name: "hreflang"}, {name: "type"}, {
                name: "accesskey",
            ...
            attributes: [{name: "colspan"}, {name: "rowspan"}, {name: "headers"}, {
                name: "abbr",
            ...
            void: !0,
            attributes: [{name: "accept"}, {name: "alt"}, {
                name: "autocomplete",
                ...
                name: "disabled",
                valueSet: "v"
            }, {name: "form"}, {name: "formaction"}, {name: "formenctype", valueSet: "et"}, {
                name: "formmethod",
                valueSet: "fm"
            }, {name: "formnovalidate", valueSet: "v"}, {name: "formtarget"}, {name: "height"}, {
                name: "inputmode",
                valueSet: "im"
            }, {name: "list"}, {name: "max"}, {name: "maxlength"}, {name: "min"}, {name: "minlength"}, {
                name: "multiple",
                valueSet: "v"
            }, {name: "name"}, {name: "pattern"}, {name: "placeholder"}, {
                name: "readonly",
                valueSet: "v"
            }, {name: "required", valueSet: "v"}, {name: "size"}, {name: "src"}, {name: "step"}, {
                name: "type",
                valueSet: "t"
        ...
        }, {name: "onformchange"}, {name: "onforminput"}, {
            name: "oninput",
            description: {
                kind: "markdown",
        ...
        valueSets: [{name: "b", values: [{name: "true"}, {name: "false"}]}, {
            name: "u",
            ...
            name: "t",
            values: [{name: "hidden"}, {name: "text"}, {name: "search"}, {name: "tel"}, {name: "url"}, {name: "email"}, {name: "password"}, {name: "datetime"}, {name: "date"}, {name: "month"}, {name: "week"}, {name: "time"}, {name: "datetime-local"}, {name: "number"}, {name: "range"}, {name: "color"}, {name: "checkbox"}, {name: "radio"}, {name: "file"}, {name: "submit"}, {name: "image"}, {name: "reset"}, {name: "button"}]
        }, {
            name: "im",
            values: [{name: "verbatim"}, {name: "latin"}, {name: "latin-name"}, {name: "latin-prose"}, {name: "full-width-latin"}, {name: "kana"}, {name: "kana-name"}, {name: "katakana"}, {name: "numeric"}, {name: "tel"}, {name: "email"}, {name: "url"}]
            ...
            name: "et",
            values: [{name: "application/x-www-form-urlencoded"}, {name: "multipart/form-data"}, {name: "text/plain"}]
        }, {
            name: "tk",
            values: [{name: "subtitles"}, {name: "captions"}, {name: "descriptions"}, {name: "chapters"}, {name: "metadata"}]
            ...
            name: "sb",
            values: [{name: "allow-forms"}, {name: "allow-modals"}, {name: "allow-pointer-lock"}, {name: "allow-popups"}, {name: "allow-popups-to-escape-sandbox"}, {name: "allow-same-origin"}, {name: "allow-scripts"}, {name: "allow-top-navigation"}]
        }, {name: "tristate", values: [{name: "true"}, {name: "false"}, {name: "mixed"}, {name: "undefined"}]}, {
            name: "inputautocomplete",
            values: [{name: "additional-name"}, {name: "address-level1"}, {name: "address-level2"}, {name: "address-level3"}, {name: "address-level4"}, {name: "address-line1"}, {name: "address-line2"}, {name: "address-line3"}, {name: "bday"}, {name: "bday-year"}, {name: "bday-day"}, {name: "bday-month"}, {name: "billing"}, {name: "cc-additional-name"}, {name: "cc-csc"}, {name: "cc-exp"}, {name: "cc-exp-month"}, {name: "cc-exp-year"}, {name: "cc-family-name"}, {name: "cc-given-name"}, {name: "cc-name"}, {name: "cc-number"}, {name: "cc-type"}, {name: "country"}, {name: "country-name"}, {name: "current-password"}, {name: "email"}, {name: "family-name"}, {name: "fax"}, {name: "given-name"}, {name: "home"}, {name: "honorific-prefix"}, {name: "honorific-suffix"}, {name: "impp"}, {name: "language"}, {name: "mobile"}, {name: "name"}, {name: "new-password"}, {name: "nickname"}, {name: "off"}, {name: "on"}, {name: "organization"}, {name: "organization-title"}, {name: "pager"}, {name: "photo"}, {name: "postal-code"}, {name: "sex"}, {name: "shipping"}, {name: "street-address"}, {name: "tel-area-code"}, {name: "tel"}, {name: "tel-country-code"}, {name: "tel-extension"}, {name: "tel-local"}, {name: "tel-local-prefix"}, {name: "tel-local-suffix"}, {name: "tel-national"}, {name: "transaction-amount"}, {name: "transaction-currency"}, {name: "url"}, {name: "username"}, {name: "work"}]
        }, {
            name: "autocomplete",
            ...
            name: "relevant",
            values: [{name: "additions"}, {name: "removals"}, {name: "text"}, {name: "all"}, {name: "additions text"}]
        }, {name: "sort", values: [{name: "ascending"}, {name: "descending"}, {name: "none"}, {name: "other"}]}, {
            name: "roles",
            values: [{name: "alert"}, {name: "alertdialog"}, {name: "button"}, {name: "checkbox"}, {name: "dialog"}, {name: "gridcell"}, {name: "link"}, {name: "log"}, {name: "marquee"}, {name: "menuitem"}, {name: "menuitemcheckbox"}, {name: "menuitemradio"}, {name: "option"}, {name: "progressbar"}, {name: "radio"}, {name: "scrollbar"}, {name: "searchbox"}, {name: "slider"}, {name: "spinbutton"}, {name: "status"}, {name: "switch"}, {name: "tab"}, {name: "tabpanel"}, {name: "textbox"}, {name: "timer"}, {name: "tooltip"}, {name: "treeitem"}, {name: "combobox"}, {name: "grid"}, {name: "listbox"}, {name: "menu"}, {name: "menubar"}, {name: "radiogroup"}, {name: "tablist"}, {name: "tree"}, {name: "treegrid"}, {name: "application"}, {name: "article"}, {name: "cell"}, {name: "columnheader"}, {name: "definition"}, {name: "directory"}, {name: "document"}, {name: "feed"}, {name: "figure"}, {name: "group"}, {name: "heading"}, {name: "img"}, {name: "list"}, {name: "listitem"}, {name: "math"}, {name: "none"}, {name: "note"}, {name: "presentation"}, {name: "region"}, {name: "row"}, {name: "rowgroup"}, {name: "rowheader"}, {name: "separator"}, {name: "table"}, {name: "term"}, {name: "text"}, {name: "toolbar"}, {name: "banner"}, {name: "complementary"}, {name: "contentinfo"}, {name: "form"}, {name: "main"}, {name: "navigation"}, {name: "region"}, {name: "search"}, {name: "doc-abstract"}, {name: "doc-acknowledgments"}, {name: "doc-afterword"}, {name: "doc-appendix"}, {name: "doc-backlink"}, {name: "doc-biblioentry"}, {name: "doc-bibliography"}, {name: "doc-biblioref"}, {name: "doc-chapter"}, {name: "doc-colophon"}, {name: "doc-conclusion"}, {name: "doc-cover"}, {name: "doc-credit"}, {name: "doc-credits"}, {name: "doc-dedication"}, {name: "doc-endnote"}, {name: "doc-endnotes"}, {name: "doc-epigraph"}, {name: "doc-epilogue"}, {name: "doc-errata"}, {name: "doc-example"}, {name: "doc-footnote"}, {name: "doc-foreword"}, {name: "doc-glossary"}, {name: "doc-glossref"}, {name: "doc-index"}, {name: "doc-introduction"}, {name: "doc-noteref"}, {name: "doc-notice"}, {name: "doc-pagebreak"}, {name: "doc-pagelist"}, {name: "doc-part"}, {name: "doc-preface"}, {name: "doc-prologue"}, {name: "doc-pullquote"}, {name: "doc-qna"}, {name: "doc-subtitle"}, {name: "doc-tip"}, {name: "doc-toc"}]
        }, {
            name: "metanames",
            values: [{name: "application-name"}, {name: "author"}, {name: "description"}, {name: "format-detection"}, {name: "generator"}, {name: "keywords"}, {name: "publisher"}, {name: "referrer"}, {name: "robots"}, {name: "theme-color"}, {name: "viewport"}]
        }, {
            name: "haspopup",
            values: [{
                name: "false",
            ...
            name: "referrerpolicy",
            values: [{name: "no-referrer"}, {name: "no-referrer-when-downgrade"}, {name: "origin"}, {name: "origin-when-cross-origin"}, {name: "same-origin"}, {name: "strict-origin"}, {name: "strict-origin-when-cross-origin"}, {name: "unsafe-url"}]
        }]
    };
    ...
    class hl {
        ...
        setDataProviders(e, t) {
            this.dataProviders = [], e && this.dataProviders.push(new ws("html5", cl)), this.dataProviders.push(...t)
        }
    ...
    class pl {
        constructor(e, t) {
            ...
            if (n?.dataProviders) for (const o in n.dataProviders) r.push(ml(o, n.dataProviders[o]));
            this._languageService = function (e = ul) {
                const t = new hl(e), n = new Ms(e, t), i = new Es(e, t), r = new as(t), o = new ll(r), a = new sl(t),
                    s = new Js(t);
                return {
                    ...
                    format: Ws,
                    findDocumentHighlights: Ys,
                    findDocumentLinks: s.findDocumentLinks.bind(s),
                    findDocumentSymbols: tl,
                    findDocumentSymbols2: nl,
                    ...
                    doRename: rl,
                    findMatchingTagPosition: ol,
                    findOnTypeRenameRanges: al,
                    findLinkedEditingRanges: al
                }
        ...
        async format(e, t, n) {
            ...
            if (!i) return [];
            let r = {...this._languageSettings.format, ...n}, o = this._languageService.format(i, t, r);
    ...
    self.onmessage = () => {
        var e;
        e = (e, t) => new pl(e, t), self.onmessage = t => {
            to(n => e(n, t.data))
        }
    }
}();
